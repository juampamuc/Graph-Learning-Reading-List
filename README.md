...
We also create the reading list of each year as follows for convenience.
- [2025](/Graph-Learning-2025.md) [2024](/Graph-Learning-2024.md) [2023](/Graph-Learning-2023.md) [2022](/Graph-Learning-2022.md)

## [Contents](#contents)
  - [AAAI-2026](#aaai-2026) [WWW-2026](#www-2026) 
  - [IJCAI-2025](#ijcai-2025) [ICML-2025](#icml-2025) [KDD-2025](#kdd-2025) [SIGIR-2025](#sigir-2025) [CIKM-2025](#cikm-2025) [AAAI-2025](#aaai-2025) [ICLR-2025](#iclr-2025) [WSDM-2025](#wsdm-2025) [WWW-2025](#www-2025) [ICDE-2025](#icde-2025) [SIGMOD-2025](#sigmod-2025)
...
### [AAAI-2026](#contents)
1. **ViG-RAG: Video-aware Graph Retrieval-Augmented Generation via Temporal and Semantic Hybrid Reasoning.**

    *Zongsheng Cao, Anran Liu, Yangfan He, Jing Li, Bo Zhang, Zigan Wang*

1. **TRACE: Transformation-Aware Graph Refinement for Reaction Condition Prediction.**

    *Yujie Chen, Tengfei Ma, Yuansheng Liu, Leyi Wei, Shu Wu, Dongsheng Cao, Yiping Liu, Xiangxiang Zeng*

1. **DyC-STG: Dynamic Causal Spatio-Temporal Graph Network for Real-time Data Credibility Analysis in IoT.**

    *Guanjie Cheng, Boyi Li, Peihan Wu, Feiyi Chen, Xinkui Zhao, Mengying Zhu, Shuiguang Deng*

1. **Transferable Hypergraph Attack via Injecting Nodes into Pivotal Hyperedges.**

    *Meixia He, Peican Zhu, Le Cheng, Yangming Guo, Manman Yuan, Keke Tang*

1. **Magnitude-Modulated Equivariant Adapter for Parameter-Efficient Fine-Tuning of Equivariant Graph Neural Networks.**

    *Dian Jin, Yancheng Yuan, Xiaoming Tao*

1. **Targeted Pathway Inference for Biological Knowledge Bases via Graph Learning and Explanation.**
...
1. **BDD2Seq: Enabling Scalable Reversible-Circuit Synthesis via Graph-to-Sequence Learning.**

    *Mingkai Miao, Jianheng Tang, Guangyu Hu, Hongce Zhang*

1. **The GATTACA Framework: Graph Neural Network-Based Reinforcement Learning for Controlling Biological Networks.**

    *Andrzej Mizera, Jakub Zarzycki*

1. **Interpretable and Robust Behavior Abstraction via Environment-Disentangled Heterogeneous Graph.**

    *Zhibin Ni, Hai Wan, Xibin Zhao*

1. **Physically-Informed Flow Matching with Graph Neural Networks for Complex Fluid Dynamics.**
...
1. **MMPG: MoE-based Adaptive Multi-Perspective Graph Fusion for Protein Representation Learning.**

    *Yusong Wang, Jialun Shen, Zhihao Wu, Yicheng Xu, Shiyin Tan, Mingkun Xu, Changshuo Wang, Zixing Song, Prayag Tiwari*

1. **Reasoning About the Unsaid: Misinformation Detection with Omission-Aware Graph Inference.**

    *Zhengjia Wang, Danding Wang, Qiang Sheng, Jiaying Wu, Juan Cao*

1. **GROVER: Graph-guided Representation of Omics and Vision with Expert Regulation for Adaptive Spatial Multi-omics Fusion.**

    *Yongjun Xiao, Dian Meng, Xinlei Huang, Yanran Liu, Shiwei Ruan, Ziyue Qiao, Xubin Zheng*

1. **Informative Subgraph Extraction with Deep Reinforcement Learning for Drug-Drug Interaction Prediction.**

    *Jiancong Xie, Wentao Wei, Chi Zhang, Jiahua Rao, Yuedong Yang*

1. **KCLNet: Electrically Equivalence-Oriented Graph Representation Learning for Analog Circuits.**

    *Peng Xu, Yapeng Li, Tinghuan Chen, Tsung-Yi Ho, Bei Yu*

1. **Towards Provably Secure and Highly Robust Generative Image Steganography Leveraging Latent Diffusion Model.**
...
1. **HGATSolver: A Heterogeneous Graph Attention Solver for Fluid-Structure Interaction.**

    *Qin-Yi Zhang, Hong Wang, Siyao Liu, Haichuan Lin, Linying Cao, Xiao-Hu Zhou, Chen Chen, Shuang-Yi Wang, Zeng-Guang Hou*

1. **Personality-guided Public-Private Domain Disentangled Hypergraph-Former Network for Multimodal Depression Detection.**

    *Changzeng Fu, Shiwen Zhao, Yunze Zhang, Zhongquan Jian, Shiqi Zhao, Chaoran Liu*

1. **TDSNNs: Competitive Topographic Deep Spiking Neural Networks for Visual Cortex Modeling.**

    *Deming Zhou, Yuetong Fang, Zhaorui Wang, Renjing Xu*

1. **Automatic Translational Correction of Multi-View Coronary Angiography Based on Auto-Annotation Data Generation.**

    *Yue Cao, Zhuo Zhang, Shuai Xiao, Jialin Li, Guipeng Lan, Jiabao Wen, Jiachen Yang*

1. **UniABG: Unified Adversarial View Bridging and Graph Correspondence for Unsupervised Cross-View Geo-Localization.**

    *Cuiqun Chen, Qi Chen, Bin Yang, Xingyi Zhang*

1. **StegaVAR: Privacy-Preserving Video Action Recognition via Steganographic Domain Analysis.**

    *Lixin Chen, Chaomeng Chen, Jiale Zhou, Zhijian Wu, Xun Lin*

1. **Unsupervised Multi-View Visual Anomaly Detection via Progressive Homography-Guided Alignment.**

    *Xintao Chen, Xiaohao Xu, Bozhong Zheng, Yun Liu, Yingna Wu*

1. **RFNNS: Robust Fixed Neural Network Steganography with Universal Text-to-Image Models.**
...
1. **Open-World 3D Scene Graph Generation for Retrieval-Augmented Reasoning.**

    *Fei Yu, Quan Deng, Shengeng Tang, Yuehua Li, Lechao Cheng*

1. **Sparse3DPR: Training-Free 3D Hierarchical Scene Parsing and Task-Adaptive Subgraph Reasoning from Sparse RGB Views.**

    *Haida Feng, Hao Wei, Zewen Xu, Haolin Wang, Chade Li, Yihong Wu*

1. **HyperSign: Hierarchical Hypergraph-based Co-occurrence Modeling for Sign Language Recognition and Translation.**

    *Qianren Guo, Yuehang Wang, Yongji Zhang, Qi Chu, Sen Liu, Yu Jiang*

1. **Splats in Splats: Robust and Effective 3D Steganography Towards Gaussian Splatting.**

    *Yijia Guo, Wenkai Huang, Yang Li, Gaolei Li, Hang Zhang, Liwen Hu, Jianhua Li, Tiejun Huang, Lei Ma*

1. **Dual-Geometry Graph Network: Unifying Local and Global Priors for Few-Shot Learning.**

    *Zheng Han, Xiaobin Zhu, Chun Yang, Jingyan Qin, Xu-Cheng Yin*

1. **GLoMOT: Efficient Online GNN-based Low-Frame-Rate Multi-Object Tracker.**

    *Yaxuan Hu, Jie Hua, Gang Wu, Yuhong Yang, Atsushi Suzuki, Zhongyuan Wang*

1. **Multi-view Invariance Learning for 3D Scene Graph Pre-training via Collaborative Cross-Modal Regularization.**
...
1. **MotivDance: Fine-Grained Text-Guided Motivation Choreography with Music Synchronization.**

    *Chenguang Li, Yu-Hui Wen, Liping Jing*

1. **RiemanLine: Riemannian Manifold Representation of 3D Lines for Factor Graph Optimization.**

    *Yan Li, Ze Yang, Keisuke Tateno, Federico Tombari, Liang Zhao, Gim Hee Lee*

1. **DW-DGAT: Dynamically Weighted Dual Graph Attention Network for Neurodegenerative Disease Diagnosis.**

    *Chengjia Liang, Zhenjiong Wang, Chao Chen, Ruizhi Zhang, Songxi Liang, Hai Xie, Haijun Lei, Zhongwei Huang*

1. **Commonality in Few: Few-Shot Multimodal Anomaly Detection via Hypergraph-Enhanced Memory.**

    *Yuxuan Lin, Hanjing Yan, Xuan Tong, Yang Chang, Huanzhen Wang, Ziheng Zhou, Shuyong Gao, Yan Wang, Wenqiang Zhang*

1. **Pb4U-GNet: Resolution-Adaptive Garment Simulation via Propagation-before-Update Graph Network.**

    *Aoran Liu, Kun Hu, Clinton Ansun Mo, Qiuxia Wu, Wenxiong Kang, Zhiyong Wang*

1. **PosterVerse: A Full-Workflow Framework for Commercial-Grade Poster Generation with HTML-Based Scalable Typography.**

    *Junle Liu, Peirong Zhang, Yuyi Zhang, Pengyu Yan, Hui Zhou, Xinyue Zhou, Fengjun Guo, Lianwen Jin*

1. **DGKAN: Dual-branch Graph Kolmogorov-Arnold Network for Unsupervised Multimodal Change Detection.**

    *Tongfei Liu, Jianjian Xu, Tao Lei, Yingbo Wang, Xiaogang Du, Zhiyong Lv*

1. **View-on-Graph: Zero-Shot 3D Visual Grounding via Vision-Language Reasoning on Scene Graphs.**

    *Yuanyuan Liu, Haiyang Mei, Dongyang Zhan, Jiayue Zhao, Dongsheng Zhou, Bo Dong, Xin Yang*

1. **Few-Shot Precise Event Spotting via Unified Multi-Entity Graph and Distillation.**

    *Zhaoyu Liu, Kan Jiang, Murong Ma, Zhe Hou, Yun Lin, Jin Song Dong*

1. **Edge-Centric Relational Reasoning for 3D Scene Graph Prediction.**

    *Yanni Ma, Hao Liu, Yulan Guo, Theo Gevers, Martin R. Oswald*

1. **HyperDiag: Temporal-Regional Hypergraph Learning via Topology-Enhanced State Propagation for Brain Disease Diagnosis.**

    *Yulan Ma, Fangkun Li, Wenchao Yang, Qian Si, Chenglong Yu, Yang Li*
...
1. **LORETTA: A Low Resource Framework to Poison Continuous Time Dynamic Graphs.**

    *Himanshu Pal, Venkata Sai Pranav Bachina, Ankit Gangwal, Charu Sharma*

1. **MAPI-GNN: Multi-Activation Plane Interaction Graph Neural Network for Multimodal Medical Diagnosis.**

    *Ziwei Qin, Xuhui Song, Deqing Huang, Na Qin, Jun Li*

1. **Graph-Semantic Guided Learning for Virtual Immunohistochemistry Staining on Consecutive Histology Sections.**

    *Fanhao Qiu, Yangyang Zhang, Zhengxia Wang*

1. **GIIM: Graph-based Learning of Inter- and Intra-view Dependencies for Multi-view Medical Image Diagnosis.**

    *Tran Bao Sam, Hung Vu, Trung Kien Dao, Tran Dat Dang, Van Ha Tang, Steven Q. H. Truong*
...
1. **Disentangled Hypergraph-Guided Mamba Scanning for Fine-Grained Visual Recognition.**

    *Zhongwei Xiong, Hao Wang, Xiaoyan Yu, Lingling Li, Xuezhuan Zhao, Taisong Jin*

1. **STMI: Segmentation-Guided Token Modulation with Cross-Modal Hypergraph Interaction for Multi-Modal Object Re-Identification.**

    *Xingguo Xu, Zhanyu Liu, Weixiang Zhou, Yuansheng Gao, Junjie Cao, Yuhao Wang, Jixiang Luo, Dell Zhang*

1. **LongT2IBench: A Benchmark for Evaluating Long Text-to-Image Generation with Graph-structured Annotations.**

    *Zhichao Yang, Tianjiao Gu, Jianjie Wang, Feiyu Lin, Xiangfei Sheng, Pengfei Chen, Leida Li*

1. **HyperSign: Saliency-Aware Spatial Graphs and Temporal Hypergraphs for Continuous Sign Language Recognition.**

    *Weiyi Ye, Xu-Hua Yang, Dong Wei, Gang-Feng Ma, Yujiao Huang, Xiao-Xin Li*

1. **DGSAN: Dual-Graph Spatiotemporal Attention Network for Pulmonary Nodule Malignancy Prediction.**

    *Xiao Yu, Zhaojie Fang, Guanyu Zhou, Yin Shen, Huoling Luo, Ye Li, Ahmed Elazab, Xiang Wan, Ruiquan Ge, Changmiao Wang*

1. **Graph Smoothing for Enhanced Local Geometry Learning in Point Cloud Analysis.**

    *Shangbo Yuan, Jie Xu, Ping Hu, Xiaofeng Zhu, Na Zhao*

1. **High-Speed FHD Full-Color Video Computer-Generated Holography.**

    *Haomiao Zhang, Miao Cao, Xuan Yu, Hui Luo, Yanling Piao, Mengjie Qin, Zhangyuan Li, Ping Wang, Xin Yuan*

1. **Gaussian Uncertainty-Driven Multi-Model Fitting with Graph Neural Network.**

    *Ligang Zhang, Jun Li, Qiming Li*

1. **PET2Rep: Towards Vision-Language Model-Drived Automated Radiology Report Generation for Positron Emission Tomography.**
...
1. **SGAT: Learning Feature Matching with Singularity-enhanced Graph Attention Network.**

    *Yizhuo Zhang, Kun Sun, Chang Tang, Yuanyuan Liu, Xin Li*

1. **E³SAM2: Entropy-Aware and Edge-Guided Adaptation of SAM2 for Echocardiography Video Segmentation.**

    *Long Zheng, Zhi Li, Weidong Wang, Zhenyu Dai, Shuyun Li*

1. **TG-Field: Geometry-Aware Radiative Gaussian Fields for Tomographic Reconstruction.**

    *Yuxiang Zhong, Jun Wei, Chaoqi Chen, Senyou An, Hui Huang*

1. **Seeing and Knowing in the Wild: Open-domain Visual Entity Recognition with Large-scale Knowledge Graphs via Contrastive Learning.**

    *Hongkuan Zhou, Lavdim Halilaj, Sebastian Monka, Stefan Schmid, Yuqicheng Zhu, Jingcheng Wu, Nadeem Nazer, Steffen Staab*

1. **Graph-Driven Domain Co-Adaptation for Cross-Domain Image Quality Assessment.**

    *Shun Zhu, Xichen Yang, Yan Zhang, Tianshu Wang, Zhongyuan Mao, Tianyin Li, Zhuoyan Sun, Xiaobo Shen*

1. **Learning with Structure: Computing Consistent Subsets on Structurally-Regular Graphs.**

    *Aritra Banik, Mano Prakash Parthasarathi, Venkatesh Raman, Diya Roy, Abhishek Sahu*

1. **Graph Choosability via SAT: Beyond the Nullstellensatz.**
...
1. **Dual-Kernel Graph Community Contrastive Learning.**

    *Xiang Chen, Kun Yue, Wenjie Liu, Zhenyu Zhang, Liang Duan*

1. **ARDiff: Anisotropic Residual Diffusion for Heterogeneous Graph Learning.**

    *Yong Chen, Li Li, Nannan Zong, Zhihui Liu, Song-Zhi Su*

1. **TOPOGRAPH: Topology-Preserving Graph Reduction with Adaptive Structure for Persistent Homology.**

    *Zonghao Chen, Yuncheng Jiang, Gang Li*

1. **GraphRAG-Induced Dual Knowledge Structure Graphs for Personalized Learning Path Recommendation.**
...
1. **ARNS: Adaptive Relation-Aware Negative Sampling with Curriculum Learning for Inductive Knowledge Graph Completion.**
    ...
    *Ling Ding, Zhizhi Yu, Di Jin, Lei Huang*

1. **Scalable Semi-supervised Community Search via Graph Transformer on Attributed Heterogeneous Information Networks.**

    *Linlin Ding, Zhaosong Zhao, Mo Li, Yishan Pan, Xin Wang, Renata Borovica-Gajic*

1. **Transferable Graph Condensation from the Causal Perspective.**
...
1. **Subgraph Encoding with Bicentric Sphere Node Labeling and Pooling for Link Prediction.**

    *Zhihong Fang, Shaolin Tan, Qiu Fang, Zhe Li, Qing Gao*

1. **LLMTM: Benchmarking and Optimizing LLMs for Temporal Motif Analysis in Dynamic Graphs.**

    *Bing Hao, Minglai Shao, Zengyi Wo, Yunlong Chu, Yuhang Liu, Ruijie Wang*

1. **Multimodal Graph Representation Learning with Dynamic Information Pathways.**

    *Xiaobin Hong, Mingkai Lin, Xiaoli Wang, Chaoqun Wang, Wenzhong Li*

1. **NTSFormer: A Self-Teaching Graph Transformer for Multimodal Isolated Cold-Start Node Classification.**

    *Jun Hu, Yufei He, Yuan Li, Bryan Hooi, Bingsheng He*

1. **Echoless Label-Based Pre-computation for Memory-Efficient Heterogeneous Graph Learning.**
...
1. **Context-aware Graph Meta-learning.**

    *Ningbo Huang, Gang Zhou, Meng Zhang, Shunhang Li, Ling Wang, Shiyu Wang, Yi Xia*

1. **DuoKD: Dual Knowledge Distillation from Large Language Models for Robust Graph Neural Networks.**

    *Cuiying Huo, Xiaotong Huang, Dongxiao He, Yixuan Du, Wenhuan Lu, Di Jin*

1. **LLM-Aligned Geographic Item Tokenization for Local-Life Recommendation.**

    *Hao Jiang, Guoquan Wang, Donglin Zhou, Sheng Yu, Yang Zeng, Wencong Zeng, Kun Gai, Guorui Zhou*

1. **Mitigating Noise and Imbalance in Social Governance Graphs for Multi-Type Risk Assessment.**

    *Di Jin, Haotian Zhao, Xiaobao Wang, Fengyu Yan, Dongxiao He*

1. **Revisiting Contrastive Learning in Collaborative Filtering via Parallel Graph Filters.**
...
1. **Knowledge-Enhanced Image Captioning with Adaptive Graph-based Multimodal Alignment and LLM.**

    *Guoyi Li, Die Hu, Haozhe Li, Zhongjiang Yao, Wei Mi, Zongzhen Liu, Xiaodan Zhang, Honglei Lyu*

1. **Subspace-Aware Graph Construction and Contrastive Alignment for Multimodal Recommendation with Large Language Models.**
...
1. **Multiplex Heterogeneous Graph Neural Networks with Euclidean-Riemannian Mutual Space Synergy.**
...
1. **Sign-Aware Multimodal Graph Recommendation.**

    *Yahong Lian, Haotian Tian, Chunyao Song, Tingjian Ge*

1. **Stepwise Contrastive Reasoning for Retrieval-Augmented Generation over Knowledge Graphs.**

    *Chenxiao Lin, Ye Luo, Kunhong Liu, Qingqiang Wu*

1. **Multifaceted Scenario-Aware Hypergraph Learning for Next POI Recommendation.**

    *Yuxi Lin, Yongkang Li, Jie Xing, Zipei Fan*

1. **Graph2Video: Leveraging Video Models to Model Dynamic Graph Evolution.**

    *Hua Liu, Yanbin Wei, Fei Xing, Tyler Derr, Haoyu Han, Yu Zhang*

1. **Debate over Mixed-knowledge: A Robust Multi-Agent Reasoning Framework for Incomplete Knowledge Graph Question Answering.**

    *Jilong Liu, Pengyang Shao, Wei Qin, Fei Liu, Yonghui Yang, Richang Hong*

1. **A Scalable and Exact Relaxation for Densest k-Subgraph via Error Bounds.**

    *Ya Liu, Junbin Liu, Wing-Kin Ma, Aritra Konar*

1. **MIGDiff: Multi-attributes Imputations for Attribute-missing Graphs via Graph Denoising Diffusion Model.**
...
1. **S²HyRec: Self-Supervised Hypergraph Sequential Recommendation.**
...
1. **UniHR: Hierarchical Representation Learning for Unified Knowledge Graph Link Prediction.**

    *Zhiqiang Liu, Yin Hua, Mingyang Chen, Yichi Zhang, Zhuo Chen, Lei Liang, Wen Zhang*

1. **SciMKG: A Multimodal Knowledge Graph for Science Education with Text, Image, Video and Audio.**

    *Tong Lu, Zhichun Wang, Yaoyu Zhou, Yiming Guan, Zhiyong Bai, Junsheng Du*

1. **Privacy Auditing of Multi-Domain Graph Pre-Trained Model Under Membership Inference Attacks.**

    *Jiayi Luo, Qingyun Sun, Yuecen Wei, Haonan Yuan, Xingcheng Fu, Jianxin Li*

1. **LMGL-WD: LLM-Guided Multi-Task Graph Learning for Category-Level Warehouse Demand Prediction in E-Commerce.**

    *Wenjun Lyu, Fangyu Li, Yudong Zhang, Shuai Wang, Yunhuai Liu, Tian He, Desheng Zhang*

1. **Hierarchical Frequency-Decomposition Graph Neural Networks for Road Network Representation Learning.**

    *Jingtian Ma, Jingyuan Wang, Leong Hou U*

1. **Multi-graph Fusion Cross-model Contrastive Learning for Recommendation.**
...
1. **ContextGraph: Lifelog Intelligence Framework for Contextual Subgraph Evolution.**
...
1. **Information-Theoretic Minimal Sufficient Representation for Multi-Domain Knowledge Graph Completion.**

    *Jiawei Sheng, Taoyu Su, Weiyi Yang, Linghui Wang, Yongxiu Xu, Tingwen Liu*

1. **SA²GFM: Enhancing Robust Graph Foundation Models with Structure-Aware Semantic Augmentation.**

    *Junhua Shi, Qingyun Sun, Haonan Yuan, Xingcheng Fu*

1. **HiLoMix: Robust High- and Low-Frequency Graph Learning Framework for Mixing Address Association.**

    *Xiaofan Tu, Tiantian Duan, Shuyi Miao, Hanwen Zhang, Yi Sun*

1. **TGCA-LLM: Time-Aware Graph-Text Contrastive Alignment for Enhancing LLMs in Temporal Knowledge Graph Completion.**

    *Zexuan Wan, Bo Wang, Kuofei Fang, Bin Wu*

1. **HFR-MKGC: Hierarchical Fusion Reasoning with MLLMs for Multi-modal Knowledge Graph Completion.**

    *Di Wang, Junping Du, Zhe Xue, Meiyu Liang, Guanhua Ye, Yingxia Shao, Haisheng Li*

1. **Task-Aware Meta-Learning on Heterogeneous Knowledge Graph for POI Recommendation.**
...
1. **Knowledge Graph Guided Heterogeneity-Informed Diffusion Model for Spatio-Temporal Generation.**

    *Zi'ang Wang, Lei Chen, Yuanchang Jin, Pan Deng, Shuangshuang Pang, Junting Liu, Yu Zhao*

1. **T-Retriever: Tree-based Hierarchical Retrieval Augmented Generation for Textual Graphs.**

    *Chunyu Wei, Huaiyu Qin, Siyuan He, Yunhai Wang, Yueguo Chen*

1. **DARLING: Dual Hypergraph-Enhanced Curriculum-Guided Graph Structure Learning for Node Classification.**

    *Guangkai Wu, Gen Liu, Chao Li, Qingtian Zeng, Hui Zhou, Zhongying Zhao*

1. **Beyond Graph Priors: A Co-Evolving Framework Under Uncertainty for Enterprise Resilience Assessment.**

    *Yanzhe Xie, Li Huang, Qiang Gao, Xueqin Chen, Fan Zhou, Kunpeng Zhang*

1. **GIER: Addressing Class Imbalance in GNNs Through Experience Replay.**

    *Liu Yang, Chuyao Liu, Zidong Wang, Tingxuan Chen, Mengni Chen, Hongyu Zhang*

1. **FairGSE: Fairness-Aware Graph Neural Network Without High False Positive Rates.**

    *Zhenqiang Ye, Jinjie Lu, Tianlong Gu, Fengrui Hao, Xuemin Wang*

1. **NumCoKE: Ordinal-Aware Numerical Reasoning over Knowledge Graphs with Mixture-of-Experts and Contrastive Learning.**

    *Ming Yin, Zongsheng Cao, Qiqing Xia, Chenyang Tu, Neng Gao*

1. **Neural Graph Navigation for Intelligent Subgraph Matching.**

    *Yuchen Ying, Yiyang Dai, Wenda Li, Wenjie Huang, Rui Wang, Tongya Zheng, Yu Wang, Hanyang Yuan, Mingli Song*

1. **Noise-Aware Graph-Based Cognitive Diagnostic Framework Through Low-Rank Alignment.**

    *Guixian Zhang, Yanmei Zhang, Guan Yuan, Shang Liu, Xiaojing Du, Debo Cheng*

1. **GT-SNT: A Linear-Time Transformer for Large-Scale Graphs via Spiking Node Tokenization.**
...
1. **Towards OOD Generalization in Dynamic Graphs via Causal Invariant Learning.**

    *Xinxun Zhang, Pengfei Jiao, Mengzhou Gao, Tianpeng Li, Xuan Guo*

1. **Knowledge-Enhanced Explainable Hypergraph Convolution Network for Medication Recommendation.**

    *Zihan Zhang, Hongzhi Liu, Xiaoshuang Guo, Tianqi Sun, Zhonghai Wu*

1. **TriFusion-IDS: A Multimodal Graph-Tabular-Text Contrastive Framework for Cross-Dataset Intrusion Detection.**

    *Qinxin Zhao, Sheng Zhong*

1. **From Semantics to Spectrum: A New Lens on Graph Augmentation Strategy.**

    *Xiangping Zheng, Xiuxin Hao, Bo Wu, Wei Li, Bin Ren, Bin Tang, Yuhui Guo, Xun Liang, Zhiwen Yu*

1. **Stage-Aware Graph Contrastive Learning with Node-oriented Mixture of Experts.**

    *Xiangkai Zhu, Yeyu Yan, Saiqin Long, Chao Li, Guanwen Chen, Longsheng Su*

1. **Meta Dynamic Graph for Traffic Flow Prediction.**
...
1. **Non-Monotonicity in Fair Division of Graphs.**
...
1. **Graph Neural Field with Spatial-Correlation Augmentation for HRTF Personalization.**

    *De Hu, Junsheng Hu, Cuicui Jiang*

1. **ViTE: Virtual Graph Trajectory Expert Router for Pedestrian Trajectory Prediction.**

    *Ruochen Li, Zhanxing Zhu, Tanqiu Qiao, Hubert P. H. Shum*

1. **BrainHGT: A Hierarchical Graph Transformer for Interpretable Brain Network Analysis.**

    *Jiajun Ma, Yongchao Zhang, Chao Zhang, Zhao Lv, Shengbing Pei*

1. **ELSPR: Evaluator LLM Training Data Self-Purification on Non-Transitive Preferences via Tournament Graph Reconstruction.**
...
1. **SAMGTD: Spatial-Aware Masked Graph Transformer-Diffusion Model for Enhanced Cell Type Deconvolution in Spatial Transcriptomics.**

    *Shilin Zhang, Suixue Wang, Qingchen Zhang, Xiulong Liu*

1. **GraphCoT-VLA: A 3D Spatial-Aware Reasoning Vision-Language-Action Model for Robotic Manipulation with Ambiguous Instructions.**

    *Helong Huang, Min Cen, Kai Tan, Xingyue Quan, Guowei Huang, Hong Zhang*

1. **GraphGrasp: Lightweight and Efficient Graph-Guided 6-DoF Robotic Grasp Pose Estimation Network.**

    *Sheng Yu, Di-Hua Zhai, Yuanqing Xia*

1. **GraphOracle: Efficient Fully-Inductive Knowledge Graph Reasoning via Relation-Dependency Graphs.**

    *Enjun Du, Siyi Liu, Yongqi Zhang*

1. **Heterogeneous Graph Neural Networks for Assumption-Based Argumentation.**

    *Preesha Gehlot, Anna Rapberger, Fabrizio Russo, Francesca Toni*

1. **The Correspondence Between Bounded Graph Neural Networks and Fragments of First-Order Logic.**

    *Bernardo Cuenca Grau, Eva Feng, Przemyslaw Andrzej Walega*

1. **Discovering Latent Facts from Context to Construct Richer Open Knowledge Graphs.**

    *Jinpeng Li, Hang Yu, Ziqi Ma, Peng Qi*

1. **From Dialogue to Destination: Geography-Aware Large Language Models with Multimodal Fusion for Conversational Recommendation.**

    *Yeming Li, Chenxi Liu, Jie Zou, Cheng Long, Chaoning Zhang, Peng Wang, Yang Yang*

1. **MyGram: Modality-aware Graph Transformer with Global Distribution for Multi-modal Entity Alignment.**

    *Zhifei Li, Ziyue Qin, Xiangyu Luo, Xiaoju Hou, Yue Zhao, Miao Zhang, Zhifang Huang, Kui Xiao, Bing Yang*

1. **Encode Geometric Diagram as Geo-Graph in Geometry Problem Solving.**

    *Wenjun Wu, Lingling Zhang, Bo Zhao, Bo Li, Xinyu Zhang, Yaqiang Wu*

1. **Expressive Power of Graph Transformers via Logic.**

    *Veeti Ahvonen, Maurice Funk, Damian Heiman, Antti Kuusisto, Carsten Lutz*

1. **PAGE: A Unified Approach for Federated Graph Unlearning.**

    *Yuming Ai, Xunkai Li, Jiaqi Chao, Bowen Fan, Zhengyu Wu, Yinlin Zhu, Rong-Hua Li, Guoren Wang*

1. **Spectral Basis Learning for Expressive Graph Neural Networks in Link Prediction.**

    *Niloofar Azizi, Nils M. Kriege, Nicholas J. A. Harvey, Horst Bischof*

1. **HyperGOOD: Towards Out-of-Distribution Detection in Hypergraphs.**

    *Tingyi Cai, Yunliang Jiang, Ming Li, Changqin Huang, Yujie Fang, Chengling Gao, Zhonglong Zheng*

1. **Spiking Heterogeneous Graph Attention Networks.**

    *Buqing Cao, Qian Peng, Xiang Xie, Liang Chen, Min Shi, Jianxun Liu*

1. **Edge Self-Adversarial Augmentation Enhances Graph Contrastive Learning Against Neighborhood Inconsistency.**
...
1. **Generating In-Distribution Counterfactual Explanation for Graph Neural Networks.**

    *Linmao Chen, Chaobo He, Junwei Cheng, Chunying Li, Quanlong Guan*

1. **Connectivity-Guided Sparsification of 2-FWL GNNs: Preserving Full Expressivity with Improved Efficiency.**

    *Rongqin Chen, Fan Mo, Pak Lon Ip, Shenghui Zhang, Dan Wu, Ye Li, Leong Hou U*

1. **Gated Variational Graph Autoencoders as Experts with Competition and Consensus for Multi-view Clustering.**

    *Zhaoliang Chen, William K. Cheung, Hong-Ning Dai, Byron Choi, Jiming Liu*

1. **Combining LLM Semantic Reasoning with GNN Structural Modeling for Multi-View Multi-Label Feature Selection.**

    *Zhiqi Chen, Yuzhou Liu, Jiarui Liu, Wanfu Gao*

1. **Explanation-Preserving Augmentation for Semi-Supervised Graph Representation Learning.**

    *Zhuomin Chen, Jingchao Ni, Hojat Allah Salehi, Xu Zheng, Esteban Schafir, Farhad Shirani, Dongsheng Luo*

1. **Are Graph Transformers Necessary? Efficient Long-Range Message Passing with Fractal Nodes in MPNNs.**

    *Jeongwhan Choi, Seungjun Park, Sumin Park, Sung-Bae Cho, Noseong Park*

1. **Sheaf Graph Neural Networks via PAC-Bayes Spectral Optimization.**

    *Yoonhyuk Choi, Jiho Choi, Taewook Ko, JongWook Kim, Chong-Kwon Kim*

1. **FedSkeleton: Secure Multi-Party Graph Skeleton Construction for Privacy-Preserving Federated Time-Series Forecasting.**

    *Henggang Deng, Yuchao Tang, Wenjie Fu, Huandong Wang, Kun Chen, Tao Jiang*

1. **GCIB: Causal Intervention Guided Graph Information Bottleneck Framework.**

    *Hangyuan Du, Rong Wang, Lixin Cui, Gaoxia Jiang, Liang Bai, Wenjian Wang*

1. **LGAN: An Efficient High-Order Graph Neural Network via the Line Graph Aggregation.**

    *Lin Du, Lu Bai, Jincheng Li, Lixin Cui, Hangyuan Du, Lichi Zhang, Yuting Chen, Zhao Li*

1. **FlorE: Integrating Full Lorentz Group and Directional Offsets for Effective Knowledge Graph Embedding.**

    *Zehua Duo, Jiang Li, Xiangdong Su, Guanglai Gao*

1. **Graph Domain Adaptation via Homophily-Agnostic Reconstructing Structure.**

    *Ruiyi Fang, Shuo Wang, Ruizhi Pu, Qiuhao Zeng, Hao Zheng, Ziyan Wang, Jiale Cai, Zhimin Mei, Song Tang, Charles Ling, Boyu Wang*

1. **TLAGC: Taylor Linear Attention-Guided Graph Convolutions for Revealing Spatial Domains in Spatial Multi-Omics Data.**

    *Aoyun Geng, Chunyan Cui, Yunyun Su, Zhenjie Luo, Feifei Cui, Zilong Zhang*

1. **Graph Masked Autoencoder for Multi-view Remote Sensing Data Clustering.**

    *Renxiang Guan, Junhong Li, Siwei Wang, Tianrui Li, Dayu Hu, Miaomiao Li, Xinwang Liu*

1. **Deformable Polygonal Flow Matching with Informed Priors and Hierarchical Graph Constraints.**

    *Arnaud Gueze, Matthieu Ospici, Damien Rohmer, Marie-Paule Cani*

1. **Federated Graph-level Clustering Network with Attribute Inference.**

    *Renda Han, Junlong Wu, Wenxuan Tu, Jingxin Liu, Haotian Wang, Jieren Cheng*

1. **Aggregate-Combine-Readout GNNs Can Express Logical Classifiers Beyond the Logic C2.**

    *Stan P. Hauke, Przemyslaw Andrzej Walega*

1. **Towards Federated Clustering: A Client-wise Private Graph Aggregation Framework.**

    *Guanxiong He, Zheng Wang, Jie Wang, Liaoyuan Tang, Rong Wang, Feiping Nie*

1. **Beyond Fixed Depth: Adaptive Graph Neural Networks for Node Classification Under Varying Homophily.**

    *Asela Hevapathige, Asiri Wijesinghe, Ahad N. Zehmakan*

1. **HINPool: A Unified Heterogeneous Graph Pooling Framework for Accurate Molecular and Protein Property Prediction.**

    *Ming-Yi Hong, You-Chen Teng, Shao-En Lin, Chih-Yu Wang, Che Lin*

1. **Graph Out-of-Distribution Detection via Test-Time Calibration with Dual Dynamic Dictionaries.**

    *Yue Hou, Ruomei Liu, Yingke Su, Junran Wu, Ke Xu*

1. **BayesAgent: Bayesian Agentic Reasoning Under Uncertainty via Verbalized Probabilistic Graphical Modeling.**

    *Hengguan Huang, Xing Shen, Guang-Yuan Hao, Songtao Wang, Lingfa Meng, Dianbo Liu, David A. Duchêne, Hao Wang, Samir Bhatt*

1. **Self-Interpretable Subgraph Neural Network with Deep Reinforcement Walk Exploration.**

    *Jianming Huang, Hiroyuki Kasai*

1. **Trimming the Fat: Redundancy-Aware Acceleration Framework for DGNNs.**

    *Renhong Huang, Yuxuan Cao, Yi Li, Junwei Hu, Zihua Xiong, Shuai Fang, Sheng Guo, Bo Zheng, Yang Yang*

1. **Multi-View Differential Mixing and Graph-Guided Structural Region Selection for Cross-Modal Alignment.**

    *Linlin Ji, Li Liu*

1. **HTG-GCL: Leveraging Hierarchical Topological Granularity from Cellular Complexes for Graph Contrastive Learning.**

    *Qirui Ji, Bin Qin, Yifan Jin, Yunze Zhao, Chuxiong Sun, Changwen Zheng, Jianwen Cao, Jiangmeng Li*

1. **PAGPL: Privacy-Aware Graph Prompt Learning Scheme via Adaptive Perturbation-Estimated Topology Recovery.**

    *Ju Jia, Jiansen Song, Jingxuan Yu, Jiabao Guo, Xiaoshuang Jia, Di Wu, Yali Yuan, Guang Cheng*

1. **DAPrompt: Dual Alignment Prompt of Structure and Semantics for Few-shot Graph Learning.**

    *Lifan Jiang, Mengying Zhu, Yangyang Wu, Xuan Liu, Xiaolin Zheng, Shenglin Ben*

1. **Cooperative Graph Transformer with Structural Consensus for Multi-View Learning.**

    *Zhiyuan Lai, Jiacheng Li, Jiayuan Wang, Shiping Wang*

1. **Tab-PET: Graph-Based Positional Encodings for Tabular Transformers.**

    *Yunze Leng, Rohan Ghosh, Mehul Motani*

1. **DeloopSGNN: Revisiting Spectral GNNs Through the Lens of Spatial Aggregation.**

    *Duanyu Li, Huijun Wu, Min Xie, Kai Lu, Wenzhe Zhang, Zhenwei Wu, Yong Dong, Ruibo Wang*

1. **DANS-KGC: Diffusion Based Adaptive Negative Sampling for Knowledge Graph Completion.**

    *Haoning Li, Qinghua Huang*

1. **C-GNN-PRUNE: A Unified Graph-Based Framework for Structure-Aware Pruning of Mixture-of-Experts Models.**

    *Lin Li, Yan Wang, Zhuopeng Wang*

1. **Multi-Granular Graph Learning with Fine-Grained Behavioral Pattern Awareness for Session-Based Recommendation.**

    *Ming Li, Zihao Yan, Yuting Chen, Lixin Cui, Lu Bai, Feilong Cao, Ke Lv, Zhao Li*

1. **High-Pass Matters: Theoretical Insights and Sheaflet-Based Design for Hypergraph Neural Networks.**

    *Ming Li, Yujie Fang, Dongrui Shen, Han Feng, Xiaosheng Zhuang, Kelin Xia, Pietro Lio*

1. **HyperNoRA: Hyperedge Prediction via Node-Level Relation-Aware Self-Supervised Hypergraph Learning.**

    *Ming Li, Zhanle Zhu, Xinyi Li, Lu Bai, Lixin Cui, Feilong Cao, Ke Lv*

1. **Self-Supervised Hypergraph Learning with Substructure Awareness for Hyperedge Prediction.**

    *Ming Li, Huiting Wang, Yuting Chen, Lu Bai, Lixin Cui, Feilong Cao, Ke Lv*

1. **HyperAim: Hypergraph Contrastive Learning with Adaptive Multi-frequency Filters.**

    *Ming Li, Ruiting Zhao, Zihao Yan, Lu Bai, Lixin Cui, Feilong Cao*

1. **Heterophily-aware Contrastive Learning for Heterophilic Hypergraphs.**

    *Ming Li, Yongqi Li, Yuting Chen, Feilong Cao, Ke Lv*

1. **Permutation Equivariant Framelet-based Hypergraph Neural Networks.**

    *Ming Li, Yi Wang, Chengling Gao, Lu Bai, Yujie Fang, Xiaosheng Zhuang, Pietro Lio*

1. **Prototype-Guided Supervision for Graph Learning with Noisy and Sparse Labels.**

    *Qiyu Li, Xianxian Li, De Li, Jinyan Wang*

1. **Assemble Your Crew: Automatic Multi-agent Communication Topology Design via Autoregressive Graph Generation.**

    *Shiyuan Li, Yixin Liu, Qingsong Wen, Chengqi Zhang, Shirui Pan*

1. **MoE-Guided Graph Diffusion for Oriented Molecule Design.**

    *Shuochen Li, Xiangqi Guo, Huobin Tan, Lei Shi*

1. **CCAHCL: Multi-Level Hypergraph Contrastive Learning for Connected Component Awareness.**

    *Zhuo Li, Gengyu Lyu, Yuena Lin, Ziang Chen, Zhiyuan Ma, Zhen Yang, Zun Li*

1. **Attribute-guided Dynamic Prompt Learning for Graph Neural Networks.**

    *Zhuomin Liang, Liang Bai, Xian Yang*

1. **DarkFarseer: Robust Spatio-Temporal Kriging Under Graph Sparsity and Noise.**

    *Zhuoxuan Liang, Wei Li, Dalin Zhang, Ziyu Jia, Yidan Chen, Zhihong Wang, Xiangping Zheng, Moustafa Youssef*

1. **From Static to Active: Knowledge-Aware Node State Selection in Multi-view Graph Learning.**

    *Weiran Liao, Jielong Lu, Yuhong Chen, Shide Du, Hongrong Chen, Shiping Wang*

1. **Graph Meets Deep Unfolding: An Interpretable Mutual-benefit Multi-view Learning Network.**

    *Renjie Lin, Hongzhi He, Yilin Wu, Shide Du, Le Zhang*

1. **IGT4ETH: An Isotropic Pre-trained Graph Transformer for Ethereum Account Classification.**

    *Ao Liu, Yanmei Zhang, Youwei Wang, Qiang Duan*

1. **Cross-View Progressive Feature Filtering for Multi-View Graph Clustering in Remote Sensing.**
...
1. **Learning Fair Graph Representations via Probability of Necessity and Sufficiency.**
    ...
    *Chuxun Liu, Qingfeng Chen, Debo Cheng, Jiangzhang Gan, Jiuyong Li, Lin Liu*

1. **Reinforcement Learning with Fuzzy Human Attention-Guided Graph for Heterogeneous Multiagent Systems.**

    *Dingbang Liu, Fenghui Ren, Jun Yan, Guoxin Su, Shohei Kato, Wen Gu*

1. **Can Pseudo-Label Be More Reliable? A Simple yet Effective Topology-Aware Graph Self-Training Method.**

    *Gen Liu, Zhongying Zhao, Hui Zhou, Chao Li, Qingtian Zeng*

1. **Personalized Federated Graph-Level Clustering Network.**

    *Jingxin Liu, Wenxuan Tu, Renda Han, Junlong Wu, Haotian Wang, Guohui Liu, Xiangyan Tang, Yue Yang*

1. **Causally-Aware Attribute Completion for Incomplete Federated Graph Clustering.**

    *Jingxin Liu, Wenxuan Tu, Haotian Wang, Renda Han, Haoyi Li, Junlong Wu, Xiangyan Tang*

1. **MORGAN: To Bridge Mixture of Experts and Spectral Graph Neural Network.**

    *Lihui Liu, Yuchen Yan*

1. **SVGL: Scale-Variable Graph Learning in Model Space for Multivariate Time Series Classification.**
...
1. **DA-DFGAS: Differentiable Federated Graph Neural Architecture Search with Distribution-Aware Attentive Aggregation.**

    *Zhaowei Liu, Yihao Jiang, Rufei Gao, Jinglei Liu, Dong Yang*

1. **Sample Weighted Incomplete Multimodal Clustering Based on Graph Coarsening Label Extraction.**
...
1. **Towards Effective, Stealthy, and Persistent Backdoor Attacks Targeting Graph Foundation Models.**

    *Jiayi Luo, Qingyun Sun, Lingjuan Lyu, Ziwei Zhang, Haonan Yuan, Xingcheng Fu, Jianxin Li*

1. **GraphTextack: A Realistic Black-Box Node Injection Attack on LLM-Enhanced GNNs.**

    *Jiaji Ma, Puja Trivedi, Danai Koutra*

1. **LLM-Enhanced Energy Contrastive Learning for Out-of-Distribution Detection in Text-Attributed Graphs.**

    *Xiaoxu Ma, Dong Li, Minglai Shao, Xintao Wu, Chen Zhao*

1. **Breaking the Dyadic Barrier: Rethinking Fairness in Link Prediction Beyond Demographic Parity.**

    *João Mattos, Debolina Halder Lina, Arlei Silva*

1. **Self-Adaptive Graph Mixture of Models.**

    *Mohit Meena, Yash Punjabi, Abhishek A, Vishal Sharma, Mahesh Chandran*

1. **Make Model Transparent: Brain Network Analysis via Causal and Knowledge Graph Learning.**

    *Lingyuan Meng, Ke Liang, Hao Yu, Haotian Wang, Miaomiao Li, Xinwang Liu*

1. **Explaining Temporal Graph Neural Network via Quantum-Inspired Evolutionary Algorithm.**
...
1. **Learn from Global Correlations: Enhancing Evolutionary Algorithm via Spectral GNN.**
...
1. **Surrogate as Teacher: Distillation-Guided Graph Poisoning Attack.**

    *Xingyu Peng, Ke Xu*

1. **On Stealing Graph Neural Network Models.**

    *Marcin Podhajski, Jan Dubinski, Franziska Boenisch, Adam Dziedzic, Agnieszka Pregowska, Tomasz Pawel Michalak*

1. **Graph Contrastive Learning with Balanced Hard Negatives and Fine-grained Semantic-aware Positives.**
...
1. **Discrete Structure Augmentation for Graph Convolutional Networks.**

    *Jianxin Ren, Weining Wu*

1. **GCL-OT: Graph Contrastive Learning with Optimal Transport for Heterophilic Text-Attributed Graphs.**

    *Yating Ren, Yikun Ban, Huobin Tan*

1. **Repetition Makes Perfect: Recurrent Graph Neural Networks Match Message Passing Limit.**

    *Eran Rosenbluth, Martin Grohe*

1. **Graph-Conditional Flow Matching for Relational Data Generation.**

    *Davide Scassola, Sebastiano Saccani, Luca Bortolussi*

1. **Logical Characterizations of GNNs with Mean Aggregation.**
...
1. **Hypergraph-Based Multi-View Multi-Label Classification via Adaptive High-Order Semantic Fusion.**

    *Yi Shan, Liyang Gao, Yuena Lin, Zhen Yang, Gengyu Lyu, Honggui Han*

1. **TSGDiff: Rethinking Synthetic Time Series Generation from a Pure Graph Perspective.**

    *Lifeng Shen, Xuyang Li, Lele Long*

1. **Towards Robust Text-Attributed Federated Graph Learning: Multimodal Threats and Defense.**

    *Zitong Shi, Guancheng Wan, Wenke Huang, Yuxin Wu, Quan Zhang, Mang Ye*

1. **Adaptive Initial Residual Connections for GNNs with Theoretical Guarantees.**

    *Mohammad Shirzadi, Ali Safarpoor-Dehkordi, Ahad N. Zehmakan*

1. **Learning to Rank: How GNNs Solve Max-Clique and Sparse PCA.**

    *Elad Shoham, Omri Haber, Havana Rika, Dan Vilenchik*

1. **Graph Flow Matching: Enhancing Image Generation with Neighbor-Aware Flow Fields.**

    *Md Shahriar Rahim Siddiqui, Moshe Eliasof, Eldad Haber*

1. **Leap of FAITH from GNN-to-MLP: Fairness Aware Inference via DisTillation of GrapH Knowledge.**

    *Vipul Kumar Singh, Jyotismita Barman, Sandeep Kumar, Tapan K. Gandhi, Jayadeva*

1. **Breaking One-Size-Fits-All: Revisiting Out-of-Distribution Detection on Graphs Under Diverse Distribution Shifts.**

    *Chuancheng Song, Hanyang Shen, Yan Dong, Xixun Lin, Yanmin Shang, Yanan Cao*

1. **Learning the Latent Structure: A Feature-Centric Approach to Graph Data Augmentation.**

    *Yu Song, Zhigang Hua, Yan Xie, Bingheng Li, Jingzhe Liu, Bo Long, Jiliang Tang, Hui Liu*

1. **Counterfactual Fairness with Imperfect Causal Graphs.**

    *Cong Su, Qiaoyu Tan, Carlotta Domeniconi, Lizhen Cui, Jun Wang, Guoxian Yu*

1. **Structures Meet Semantics: Multimodal Fusion via Graph Contrastive Learning.**

    *Jiangfeng Sun, Sihao He, Zhonghong Ou, Meina Song*

1. **Learning to Explore: Policy-Guided Outlier Synthesis for Graph Out-of-Distribution Detection.**
...
1. **Adaptive and Context-rich Generative Self-supervised Learning on Graphs.**

    *Yijun Tian, Chuxu Zhang, Ziyi Kou, Zheyuan Liu, Xiangliang Zhang, Nitesh V. Chawla*

1. **Decomposing Direct and Indirect Biases in Linear Models Under Demographic Parity Constraint.**
...
1. **Kernelized Edge Attention: Addressing Semantic Attention Blurring in Temporal Graph Neural Networks.**

    *Govind Waghmare, Srini Rohan Gujulla Leel, Nikhil Tumbde, Sumedh B. G, Sonia Gupta, Srikanta Bedathur*

1. **U2B: Scale-unbiased Representation Converter for Graph Classification with Imbalanced and Balanced Scale Distributions.**

    *Guanjun Wang, Jianhao Zhang, Jiaming Ma, Sheng Huang, Pengkun Wang, Zhengyang Zhou, Binwu Wang, Yang Wang*

1. **Anchor-Driven Nyström for Deep Graph-Level Clustering.**

    *Jiaxin Wang, Wenxuan Tu, Lingren Wang, Jieren Cheng, Yue Yang*

1. **Self-Supervised Contrastive Re-Learning for Multi-Graph Multi-Label Classification.**

    *Meixia Wang, Yuhai Zhao, Zhengkui Wang, Yejiang Wang, Miaomiao Huang, Fenglong Ma, Fazal Wahab, Wen Shan, Xingwei Wang*

1. **Discriminative Graph Embedding Framework via Label-Free Marginal Fisher Analysis.**

    *Qianqian Wang, Mengping Jiang, Wei Feng, Haixi Zhang, Bin Liu*

1. **Experimentation on Endogenous Graphs.**

    *Wenshuo Wang, Edvard Bakhitov, Dominic Coey*

1. **Cross-view Anchor Graph Learning and Factorization for Incomplete Multi-view Clustering.**

    *Xinxin Wang, Yongshan Zhang, Xiaochen Yuan, Yicong Zhou*

1. **SGoT-R1: Social Graph of Thought Reasoning-Enhanced Multimodal Large Language Model for Harmful Meme Detection.**

    *Xiuxian Wang, Yuting Su, Wenhui Li, Xiaowen Wang, Zhuojun Li, Anan Liu*

1. **Adaptive Riemannian Graph Neural Networks.**

    *Xudong Wang, Chris Ding, Tongxin Li, Jicong Fan*

1. **Nested Graph Pseudo-Label Refinement for Noisy Label Domain Adaptation Learning.**
...
1. **Khan-GCL: Kolmogorov-Arnold Network Based Graph Contrastive Learning with Hard Negatives.**

    *Zihu Wang, Boxun Xu, Hejia Geng, Peng Li*

1. **Clustering with Self-Learned Graph Regression.**

    *Lai Wei, Jin Liu*

1. **Unifying Multi-View Knowledge for Graph Learning via Model Collaboration.**

    *Zhihao Wu, Jielong Lu, Zihan Fang, Jinyu Cai, Guangyong Chen, Jiajun Bu, Haishuai Wang*

1. **Vision-Language Models Guided Graph Concept Reasoning for Interpretable Diabetic Retinopathy Diagnosis.**
...
1. **SSHPool: The Separated Subgraph-based Hierarchical Pooling.**

    *Zhuo Xu, Lu Bai, Lixin Cui, Ming Li, Hangyuan Du, Ziyu Lyu, Yue Wang, Edwin R. Hancock*

1. **Beyond the Lower Bound: Bridging Regret Minimization and Best Arm Identification in Lexicographic Bandits.**

    *Bo Xue, Yuanyu Wan, Zhichao Lu, Qingfu Zhang*

1. **Role Hypergraph Contrastive Learning for Multivariate Time-Series Analysis.**

    *Rundong Xue, Hao Hu, Zhitao Zeng, Xiangmin Han, Zhiqiang Tian, Shaoyi Du, Yue Gao*

1. **Structure-Enhanced Adapter for Self-Supervised Heterogeneous Graph Learning.**

    *Fengyu Yan, Di Jin, Xiaobao Wang, Qianhua Tang, Dongxiao He*

1. **PEGNet: A Physics-Embedded Graph Network for Long-Term Stable Multiphysics Simulation.**

    *Can Yang, Zhenzhong Wang, Junyuan Liu, Yunpeng Gong, Min Jiang*

1. **Source-Free Graph Foundation Model Adaptation via Pseudo-Source Reconstruction.**

    *Liang Yang, Hui Ning, Jiaming Zhuo, Ziyi Ma, Chuan Wang, Wenning Wu, Zhen Wang*

1. **Know Your Neighbors: Subgraph Importance Sampling for Heterophilic Graph Active Learning.**

    *Wenjie Yang, Shengzhong Zhang, Chen Ye, Jiaxing Guo, Tongshan Xu, Zengfeng Huang*

1. **How Wide and How Deep? Mitigating Over-squashing of GNNs via Channel Capacity Constrained Estimation.**

    *Zinuo You, Jin Zheng, John Cartlidge*

1. **CastX: Cohort-Level Causal Inference Meets Statistical Testing for Faithful and Reliable GNN Explanations.**

    *Guanyuan Yu, Yijun Chen, Liang Xu, Gang Kou*

1. **Enhancing Logical Expressiveness in Graph Neural Networks via Path-Neighbor Aggregation.**

    *Han Yu, Xiaojuan Zhao, Aiping Li, Kai Chen, Ziniu Liu, Zhichao Peng*

1. **Demystifying GNN-to-MLP Knowledge Transfer: Theoretical Grounding and Dual-Stream Distillation Method.**

    *Zhiyuan Yu, Mingkai Lin, Wenzhong Li, Zhangyue Yin, Shijian Xiao, Sanglu Lu*

1. **Hybrid-DMKG: A Hybrid Reasoning Framework over Dynamic Multimodal Knowledge Graphs for Multimodal Multihop QA with Knowledge Editing.**
...
1. **FairGC: Fostering Individual and Group Fairness for Deep Graph Clustering.**

    *Haodong Zhang, Xinyue Wang, Tao Ren, Yifan Wang, Siyu Yi, Fanchun Meng, Zeyu Ma, Qingqing Long, Wei Ju*

1. **Imprint of the Forgotten: Stealthy Membership Inference in Unlearned Graph Neural Networks.**

    *He Zhang, Bang Wu, Xiaoning Liu, Karin Verspoor, Xun Yi*

1. **MultiKD: Backdoor Defense in Federated Graph Learning via Attention-Guided Multi-Teacher Distillation.**

    *Jiale Zhang, Yanan Wang, Bosen Rao, Chengcheng Zhu, Xiaobing Sun, Yu Li*

1. **Adaptive Graph Attention Based Discrete Hashing for Incomplete Cross-modal Retrieval.**

    *Shuang Zhang, Yue Wu, Lei Shi, Huilong Jin, Feifei Kou, Pengfei Zhang, Mingying Xu, Pengtao Lv*

1. **CauVQ: Causal Vector Quantization for Graph OOD Generalization.**

    *Weihong Zhang, Liang Bai, Hangyuan Du, Xian Yang*

1. **Enhancing Exploration and Exploitation in Hierarchical Reinforcement Learning with Subgoal Graph Learning.**

    *Yibo Zhang, Dengpeng Xing*

1. **Efficient Tensorized Multi-View Anchor Graph Clustering with Affinity Propagation for Remote Sensing Data.**

    *Yongshan Zhang, Kangyue Zheng, Shuaikang Yan, Xinxin Wang, Zhihua Cai*

1. **Rethinking Multi-Instance Learning Through Graph-Driven Fusion: A Dual-Path Approach to Adaptive Representation.**

    *Yu-Xuan Zhang, Zhengchun Zhou, Weisha Liu, Mingxing Zhang*

1. **Dynamic Deep Graph Learning for Incomplete Multi-View Clustering with Masked Graph Reconstruction Loss.**
...
1. **Multi-knowledge Enhanced Graph Neural Network for Multi-trait Essay Scoring.**

    *Shiman Zhao, Siyuan Liu, Zhiqi Shen*

1. **Pareto-Based Heterogeneous Knowledge Distillation for MLPs on Graphs.**

    *Wenrui Zhao, Yijun Tian, Zhichao Xu, Yawei Wang, Chuxu Zhang*

1. **Graph VQ-Transformer (GVT): Fast and Accurate Molecular Generation via High-Fidelity Discrete Latents.**

    *Haozhuo Zheng, Cheng Wang, Yang Liu*

1. **DGTF: Cross-Domain Decentralized Graph Learning with Topology-Aware Knowledge Fusion.**

    *Ruisheng Zheng, Mingyi Li, Xiao Zhang, Hongjian Shi, Yanjie Fu, Yuan Yuan, Dongxiao Yu*

1. **Sarcopenia Assessment Model Based on Dual-Source Modal Graph.**

    *Wenxian Zheng, Zhi Chen, Qiaoqin Li, Rongyao Hu, Yongguo Liu*

1. **THGB: A Comprehensive Benchmark for Text-attributed Heterogeneous Graphs.**

    *Lixin Zhou, Zemin Liu, Yuan Fang, Dan Niu, Jing Ying*

1. **Dual Graph Disambiguation for Multi-Instance Partial-Label Learning.**

    *Zhen Zhu, Kai Tang, Songhe Feng, Yixuan Tang, Haobo Wang, Gengyu Lyu, Cheng Peng, Yining Sun*

1. **Prior Refinement Is Better: Diffusion-Driven Graph Harmonization for Federated Graph Learning.**

    *Shuman Zhuang, Zhihao Wu, Wei Huang, Luojun Lin, Jiali Yin, Lele Fu, Hong-Ning Dai*
...
1. **S-DAG: A Subject-Based Directed Acyclic Graph for Multi-Agent Heterogeneous Reasoning.**

    *Jiangwen Dong, Zehui Lin, Wanyu Lin, Mingjin Zhang*

1. **GRDC: A Unified Graph-Driven Framework for Role Discovery and Communication in Multi-Agent Reinforcement Learning.**

    *Zihong Gao, Hongjian Liang, Yuanhui Hao, Lei Hao, Liangjun Ke*

1. **GRIP: Latent Field-Guided Graph Policy for Budget-Constrained Multi-Agent Routing.**

    *Yujiao Hu, Zuyu Chen, Mengjie Lee, Jinchao Chen, Meng Shen, Hailun Zhang, Wei Li, Yan Pan*

1. **Graph Attention-Guided Search for Dense Multi-Agent Pathfinding.**

    *Rishabh Jain, Keisuke Okumura, Michael Amir, Amanda Prorok*

1. **A Graph-Theoretical Perspective on Law Design for Multiagent Systems.**

    *Qi Shi, Pavel Naumov*

1. **BTPG-max: Achieving Local Maximal Bidirectional Pairs for Bidirectional Temporal Plan Graphs.**

    *Yifan Su, Rishi Veerapaneni, Jiaoyang Li*

1. **DCTR: Dual-Constraint Subgraph Optimization for Knowledge Graph-based Retrieval-Augmented Generation.**

    *Yukun Cao, Zirui Xu, Dongyang Li, Zhihao Guo, Luobin Huang, Lisheng Wang*

1. **PathRAG: Pruning Graph-based Retrieval Augmented Generation with Relational Paths.**

    *Boyu Chen, Zirui Guo, Zidan Yang, Yuluo Chen, Junze Chen, Zhenghao Liu, Chuan Shi, Cheng Yang*

1. **Skill Path: Unveiling Language Skills from Circuit Graphs.**

    *Hang Chen, Xinyu Yang, Jiaying Zhu, Wenya Wang*

1. **You Don't Need Pre-Built Graphs for RAG: Retrieval Augmented Generation with Adaptive Reasoning Structures.**

    *Shengyuan Chen, Chuang Zhou, Zheng Yuan, Qinggang Zhang, Zeyang Cui, Hao Chen, Yilin Xiao, Jiannong Cao, Xiao Huang*

1. **Schema-Guided Scene-Graph Reasoning Based on Multi-Agent Large Language Model System.**

    *Yiye Chen, Harpreet S. Sawhney, Nicholas Gyde, Yanan Jian, Jack Saunders, Patricio A. Vela, Benjamin E. Lundell*

1. **Human Cognition Inspired RAG with Knowledge Graph for Complex Problem Solving.**

    *Yao Cheng, Yibo Zhao, Jiapeng Zhu, Yao Liu, Xing Sun, Xiang Li*

1. **HC2-GNN: Hierarchical Graph Representation Learning for Efficient Text Classification.**

    *Jiejie Fan, Xiaojuan Ban, Zhiyan Zhang, Xi Sun*

1. **Graph of Verification: Structured Verification of LLM Reasoning with Directed Acyclic Graphs.**

    *Jiwei Fang, Bin Zhang, Changwei Wang, Jin Wan, Zhiwei Xu*

1. **Graph-of-Mark: Promote Spatial Reasoning in Multimodal Language Models with Graph-Based Visual Prompting.**
...
1. **SAR: A Structure-Aligned Reasoning Framework for Temporal Knowledge Graph Question Answering.**

    *Qianyi Hu, Jiaxue Liu, Xinhui Tu, Shoujin Wang*

1. **Iterative Multi-Granular RAG with Contextual Hierarchical Graph.**

    *Yanli Hu, Teng Liu, Zhuangyi Zhou, Weixin Zeng, Zhen Tan, Xiang Zhao*

1. **Relink: Constructing Query-Driven Evidence Graph On-the-Fly for GraphRAG.**

    *Manzong Huang, Chenyang Bu, Yi He, Xingrui Zhuo, Xindong Wu*

1. **From Chaos to Clarity: A Knowledge Graph-Driven Audit Dataset Generation Framework for LLM Unlearning.**

    *Weipeng Jiang, Juan Zhai, Shiqing Ma, Ziyan Lei, Xiaofei Xie, Yige Wang, Chao Shen*

1. **Template-Theorems Graph Construction to Enhance Mathematical Reasoning Capabilities of LLM.**

    *Yarong Lan, Yajing Xu, Huajun Chen*

1. **Automatic Paper Reviewing with Heterogeneous Graph Reasoning over LLM-Simulated Reviewer-Author Debates.**

    *Shuaimin Li, Liyang Fan, Yufang Lin, Zeyang Li, Xian Wei, Shiwen Ni, Hamid Alinejad-Rokny, Min Yang*

1. **GraphIF: Enhancing Multi-Turn Instruction Following for Large Language Models with Relation Graph Prompt.**

    *Zhenhe Li, Can Lin, Ling Zheng, Wen-Da Wei, Junli Liang, Qi Song*

1. **TruthfulRAG: Resolving Factual-level Conflicts in Retrieval-Augmented Generation with Knowledge Graphs.**

    *Shuyi Liu, Yu-Ming Shang, Xi Zhang*

1. **A Boundary Token Graph for Zero-Shot Relation Triplet Extraction Involving Discontinuous Entities.**

    *Kailun Lyu, Zehan Li, Fu Zhang, Jingwei Cheng*

1. **Privacy-protected Retrieval-Augmented Generation for Knowledge Graph Question Answering.**

    *Yunfeng Ning, Mayi Xu, Jintao Wen, Qiankun Pi, Yuanyuan Zhu, Ming Zhong, Jiawei Jiang, Tieyun Qian*

1. **WALKSAFE: Risk-aware Graph Random Walk with Bi-GRPO for LLM Safety.**

    *Shilong Pan, Zhiliang Tian, Wanlong Yu, Zhen Huang, Qingyu Qiu, Zihan Chen, Zhonghao Sun, Minlie Huang, Dongsheng Li*

1. **ProgRAG: Hallucination-Resistant Progressive Retrieval and Reasoning over Knowledge Graphs.**

    *Minbae Park, Hyemin Yang, Jeonghyun Kim, Kunsoo Park, Hyunjoon Kim*

1. **CGMIS: Concept-Graph Based Multi-Hop Instructions Synthesis for Enhancing Long-Context Reasoning.**

    *Zechen Sun, Zecheng Tang, Juntao Li, Wenpeng Hu, Wenliang Chen, Zhunchen Luo, Qiaoming Zhu*

1. **Cross-Granularity Hypergraph Retrieval-Augmented Generation for Multi-hop Question Answering.**

    *Changjian Wang, Weihong Deng, Weili Guan, Quan Lu, Ning Jiang*

1. **MIRAGE: Scaling Test-Time Inference with Parallel Graph-Retrieval-Augmented Reasoning Chains.**

    *Kaiwen Wei, Rui Shan, Dongsheng Zou, Jianzhong Yang, Bi Zhao, Junnan Zhu, Jiang Zhong*

1. **MovieGraph-ToM: Evaluating Long-Range Theory of Mind in Large Language Models via Implicit Social-Causal Graphs.**

    *Tingjiang Wei, Qin Ni, Rong Gao, Yingying Wang, Liang He*

1. **TAdaRAG: Task Adaptive Retrieval-Augmented Generation via On-the-Fly Knowledge Graph Construction.**
...
1. **Graph-augmented and Over-smoothing-resistant Contrastive Clustering for Short Text.**

    *Zijian Zheng, Tao Ai, Yonghe Lu*

1. **HyperGLLM: An Efficient Framework for Endpoint Threat Detection via Hypergraph-Enhanced Large Language Models.**

    *Hongyi Zhou, Jianfeng Pan, Min Peng, Shaomang Huang, Hanzhong Zheng*

1. **LLM Collaborative Filtering: User-Item Graph as New Language.**

    *Huachi Zhou, Yujing Zhang, Hao Chen, Qinggang Zhang, Qijie Shen, Feiran Huang, Xiao Huang*

1. **SubGCache: Accelerating Graph-based RAG with Subgraph-level KV Cache.**

    *Qiuyu Zhu, Liang Zhang, Qianxiong Xu, Cheng Long, Jie Zhang*

1. **Generic Adversarial Attack Framework Against Graph-based Vertical Federated Learning.**
...
1. **A Content-Preserving Secure Linguistic Steganography.**

    *Lingyun Xiang, Chengfu Ou, Xu He, Zhongliang Yang, Yuling Liu*

1. **Learning Heuristic Functions with Graph Neural Networks for Numeric Planning.**

    *Valerio Borelli, Alfonso Gerevini, Enrico Scala, Ivan Serina*

1. **GHOST: Solving the Traveling Salesman Problem on Graphs of Convex Sets.**

    *Jingtao Tang, Hang Ma*

1. **Coarse-to-Fine Open-Set Graph Node Classification with Large Language Models.**

    *Xueqi Ma, Xingjun Ma, Sarah Monazam Erfani, Danilo P. Mandic, James Bailey*

1. **Parallelizable Riemannian Alternating Direction Method of Multipliers for Non-convex Pose Graph Optimization.**

    *Xin Chen, Chunfeng Cui, Deren Han, Liqun Qi*

1. **Priority-Based Graph-Enhanced Reinforcement Learning for Robust Analog Circuit Optimization.**

    *Jintao Li, Zhenxin Chen, Sicheng He, Aojin Li, Shui Yu*

1. **Exact Combinatorial Multi-Class Graph Cuts for Semi-Supervised Learning.**

    *Mohammad Mahdi Omati, Yasin Salajeghe, Mahshad Moradi, Arash Amini*

1. **FPT Approximation Algorithms for TSP on Non-Metric Graphs.**

    *Jingyang Zhao, Zimo Sheng, Mingyu Xiao*

1. **Urban Incident Prediction with Graph Neural Networks: Integrating Government Ratings and Crowdsourced Reports.**

    *Sidhika Balachandar, Shuvom Sadhuka, Bonnie Berger, Emma Pierson, Nikhil Garg*

1. **GraphVSSM: Graph Variational State-Space Model for Probabilistic Spatiotemporal Inference of Dynamic Exposure and Vulnerability for Regional Disaster Resilience Assessment.**

    *Joshua Dimasaka, Christian Geiß, Emily So*

1. **NutriScreener: Retrieval Augmented Multi-Pose Graph Attention Network for Malnourishment Screening.**
...
1. **EdGCL: Disentangling Social and Cognitive Homophily in Graph-Based Educational Recommender Systems.**

    *Qingqing Liang, Chunyang Wang, Peiwei Xia, Yanan Zeng, Xin Liu, Xuesong Lu, Aoying Zhou*

1. **Role Perceptual Augmented Temporal Graph Network for Related-party Transaction Detection.**

    *Xin Liu, Yuanhang Yu, Peng Zhu, Dawei Cheng, Changjun Jiang*

1. **Resilience Inference for Supply Chains with Hypergraph Neural Network.**

    *Zetian Shen, Hongjun Wang, Jiyuan Chen, Xuan Song*

1. **Achieving Fairness Without Harm via Selective Demographic Experts.**

    *Xuwei Tan, Yuanlong Wang, Thai-Hoang Pham, Ping Zhang, Xueru Zhang*

1. **Fair Graph Learning with Limited Sensitive Attribute Information.**

    *Zichong Wang, Jie Yang, Jun Zhuang, Puqing Jiang, Mingzhe Chen, Ye Hu, Wenbin Zhang*

1. **Explainable Oracle Bone Script Recognition via Multimodal Pictographic Reasoning.**

    *Yin Wu, Zhengxuan Zhang, Jiayu Chen, Chang Xu, Yuyu Luo, Nan Tang, Hui Xiong*

1. **Assessing Automated Fact-Checking for Medical LLM Responses with Knowledge Graphs.**

    *Shasha Zhou, Mingyu Huang, Jack Cole, Charles Britton, Ming Yin, Jan Wolber, Ke Li*

1. **Graph-based Label-Efficient Learning: When Graph-Structured Data Meets Limited Labels.**

    *Zixing Song*

1. **Analysing Satellite Imagery Classification Under Spatial Domain Shift Across Geographic Regions (Abstract Reprint).**
...
1. **Generative Graphical Inverse Kinematics (Abstract Reprint).**

    *Oliver Limoyo, Filip Maric, Matthew Giamou, Petra Alexson, Ivan Petrovic, Jonathan Kelly*

1. **Linguistic Steganography via Self-Adjusting Asymmetric Number System (Abstract Reprint).**

    *Yiting Liu, Chungen Xu, Fei Yang, Pan Zhang, Linlong Wang*

1. **Approximating Problems in Abstract Argumentation with Graph Convolutional Networks (Abstract Reprint).**

    *Lars Malmqvist, Tangming Yuan, Peter Nightingale*

1. **CineMPC: A Fully Autonomous Drone Cinematography System Incorporating Zoom, Focus, Pose, and Scene Composition (Abstract Reprint).**

    *Pablo Pueyo, Juan Dendarieta, Eduardo Montijano, Ana Cristina Murillo, Mac Schwager*

1. **Spatial Graph Attention Network Modeling for Neighborhood-Scale Lead Contamination Risk Prediction Using Publicly Available Data.**

    *Raphael Anaadumba, Nazim A. Belabbaci, Connor Sullivan, Anton Kovalev, Yidong Zhu, Pradeep Kurup, Mohammad Arif Ul Alam*

1. **Lightweight Additive Blend Maps for Texture-Preserving Face Retouching: A Neural Approach to Traditional Photographic Techniques.**

    *Abinash Pegu*

1. **Graph RAG for Automated Short Answer Grading with Feedback: Bridging Pedagogical Needs and Technical Capabilities.**

    *Guoliang Xu, James E. Corter*

1. **Time-Series Anomaly Detection with Graph-Based Self-Supervised Learning and Foundation Models: Towards Real-World Applications.**

    *Thi Kieu Khanh Ho*

1. **Exploiting Graph-Based Structural Priors for Visual Recognition.**

    *Depanshu Sani*

1. **Zero-Shot Vision Language Reasoning via Dual-layer Scene Graph Chain of Thoughts (Student Abstract).**

    *Yash Bansal, Parshiv Kapoor, Agam Pandey*

1. **AEFGL: Reverse Auction and Value Evaluation-Based Federated Graph Learning Incentive Mechanism (Student Abstract).**

    *Xin Chang, Lixin Liu, Jingyu Wang, Jinling Yu, Xiaolin Zhang*

1. **DDIN: Reinforcement Learning with Asymmetric GNNs for Dismantling Directed Interdependent Networks (Student Abstract).**

    *Soumyajit Dev, Malay Bhattacharyya*

1. **Topo-GraT: Learning to Grow with Causal Graph Transformers (Student Abstract).**

    *Ashim Dhor, Smily Bharadwaj*

1. **Graph Neural ODEs with Stability and Conservation Guarantees for Tumor Microenvironment Dynamics (Student Abstract).**

    *Luong Doan, Tien Nguyen, Nhung Duong, Lap Nguyen, Tuan Do*

1. **Knowledge Graph for Efficient Multi-hop Question Generation (Student Abstract).**

    *Al Hasib Mahamud, Yllias Chali*

1. **Behavioral-Similarity and Clustering-Based Methods for Static Graph Estimation in Hybrid GNNs (Student Abstract).**

    *Ryusei Otani, Keiichi Namikoshi, Yuko Sakurai, Mingyu Guo, Satoshi Oyama*

1. **Graph-Theoretic Consistency for Robust and Topology-Aware Semi-Supervised Histopathology Segmentation (Student Abstract).**

    *Ha-Hieu Pham, Minh Le, Han Huynh, Nguyen Quoc Khanh Le, Huy-Hieu Pham*

1. **Decomposing Direct and Indirect Biases in Linear Models Under Demographic Parity Constraint (Student Abstract).**

    *Bertille Tierny, Arthur Charpentier, François Hu*

1. **Atom-level Adaptive Receptive Fields: A Pruning-Based Encoder for 2D Molecular Graphs (Student Abstract).**

    *Yuhao Zhang, Ningkang Peng, Yafei Liu, Lin Li, Masaru Kitsuregawa, Yanhui Gu*

1. **Wikontic: A Tool for Building Knowledge Graphs from Text Aligned with the Wikidata Ontology.**

    *Alla Chepurova, Aydar Bulatov, Mikhail Burtsev, Yuri Kuratov*

1. **Framework GNN-AID: Graph Neural Network Analysis, Interpretation and Defense.**

    *Kirill Lukianov, Mikhail Drobyshevskiy, Georgii V. Sazonov, Mikhail Soloviov, Ilya Makarov*

1. **AI for Memory Preservation: Automated Restoration of Photographs Damaged by Floods.**

    *Jose Daniel Galvan Suazo, Hugo Albert Bonet, Carlos Monserrat Aranda, Cèsar Ferri*

1. **AgentGraph: Trace-to-Graph Platform for Interactive Analysis and Robustness Testing in Agentic AI Systems.**
...
### [WWW-2026](#contents)
1. **Efficient and Fair Allocation on Graphs: From Orientation to Position-Aware Valuations.**

    *Bo Li, Ankang Sun, Shiji Xing*

1. **Difference-based Sample Selection for Federated Graph Rationalization.**

    *Linan Yue, Weibo Gao*

1. **Toward Graph-Tokenizing Large Language Models with Reconstructive Graph Instruction Tuning.**

    *Zhongjian Zhang, Xiao Wang, Mengmei Zhang, Jiarui Tan, Chuan Shi*

1. **Multi-Source Unsupervised Graph Domain Adaptation via Concise Propagation-Transformation Pipeline.**

    *Jiayi Wang, Yi Li, Xin Zheng, Junyang Chen, Yanqing Guo, Alan Wee-Chung Liew, Shirui Pan*

1. **Class-Domain Incremental Learning on Graphs via Disentangled Knowledge Distillation.**
...
1. **Topology-Aware Feature Sorting Enables Universal Modeling on Homophilic and Heterophilic Graphs.**

    *Yi Wang, Jitao Zhao, Dongxiao He, Jia Li, Yuxiao Huang, Zhiyong Feng*

1. **Exploring Sequential Dynamics on Temporal Graphs via Composite Filtering.**

    *Yuanyuan Xu, Danni Wu, Xuemin Lin, Dong Wen, Wenjie Zhang, Lei Chen, Ying Zhang*

1. **Diffusion-based Kriging Model with Graph-enhanced Attention.**

    *Mingtao Zhang, Guoli Yang, Zhanxing Zhu, Guangyin Jin, Mengzhu Wang, Xiaoying Bai*

1. **Graph Retention Networks for Dynamic Graphs.**
...
1. **Beyond Single-Granularity Prompts: A Multi-Scale Chain-of-Thought Prompt Learning for Graph.**

    *Ziyu Zheng, Yaming Yang, Ziyu Guan, Wei Zhao, Xinyan Huang, Weigang Lu*

1. **Graph Diffusion Evolution Model for Multi-Conditional Molecular Generation.**

    *Xingcheng Fu, Lingyun Liu, Yisen Gao, Tianyu Chen, Qingyun Sun, Jianxin Li, Xianxian Li*

1. **Multi-Source Information Driven Spatio-Temporal Hypergraph Learning for Traffic Forecasting.**

    *Ping Zhang, Jiayu Leng, Liang Yang, Anchen Li, Xiaochun Cao, Riting Xia*

1. **Riemannian Graph Tokenizer for Structural Knowledge Transfer.**
...
1. **LEDA: Latent Semantic Distribution Alignment for Multi-domain Graph Pre-training.**

    *Lianze Shan, Jitao Zhao, Dongxiao He, Siqi Liu, Jiaxu Cui, Weixiong Zhang*

1. **RAG-GFM: Overcoming In-Memory Bottlenecks in Graph Foundation Models via Retrieval-Augmented Generation.**

    *Haonan Yuan, Qingyun Sun, Jiacheng Tao, Xingcheng Fu, Jianxin Li*

1. **SGExplainer: Balanced Path-based Signed Graph Neural Network Explanation for Link Sign Prediction.**

    *Jie Gao, Jia Hu, Geyong Min, Fei Hao*

1. **HomeRun: Performing Curveball Trades quasi in Streaming for Fast Null Modeling of Graphs, Hypergraphs, and Binary Matrices.**

    *Michelle Contreras-Catalan, Matteo Riondato*

1. **Dir-GD: Directed Graph Distillation.**

    *Ce Yang, Fei Hao, Jie Gao, Jianrui Chen, Jia Hu, Geyong Min*

1. **TAWRMAC: A Novel Dynamic Graph Representation Learning Method.**

    *Soheila Farokhi, Xiaojun Qi, Hamid Karimi*

1. **Graph Neural Network Model Transferability Estimation via Decomposition-Augmented Discriminant Analysis.**

    *Huanchang Ma, Xin Zheng, Jianyu Li, Alan Wee-Chung Liew, Wei Lan, Jian Gao*

1. **UTAG: Leveraging LLM as a Unified Embedding Generator for Text-Attributed Graphs.**
...
1. **Text-attributed Graph Condensation via Text Selection and Attribute Matching.**
...
1. **GraphTARIF: Linear Graph Transformer with Augmented Rank and Improved Focus.**

    *Zhaolin Hu, Kun Li, Hehe Fan, Yi Yang*

1. **VSAL: A Vision Solver with Adaptive Layouts for Graph Property Detection.**

    *Jiahao Xie, Guangmo Tong*

1. **Towards Graph Foundation Model: Node Feature Transfer Invariant Modeling on General Graphs.**

    *Jitao Zhao, Yi Wang, Yawen Li, Dongxiao He, Di Jin, Zhiyong Feng, Weixiong Zhang*

1. **Sustained Vertex Cover on Temporal Graphs.**

    *Junqiang Peng, Tian Bai, Jingyang Zhao, Mingyu Xiao*

1. **Dual-level Reweighting for Positive-Unlabeled Graph Classification.**

    *Junghun Kim, Shihyung Park, U Kang*

1. **A Unified Graph Clustering Network.**
...
1. **E2SGNN: Reconciling Expression and Efficiency in Spiking Graph Neural Network.**
...
1. **Graph-to-Tree: Topological Decomposition for Self-Supervised Learning.**
...
1. **FedCND: Federated Graph-Level Clustering under Inter-Client Cluster Number Discrepancy.**

    *Junlong Wu, Renda Han, Wenxuan Tu, Jingxin Liu, Haotian Wang, Jieren Cheng*

1. **Breaking the Scalability Barrier in Constrained Graph-Based Networked Control via Decision-Focused Learning.**
...
1. **Invariant Learning on Heterogeneous Graphs via Subgraph Environment Inference.**

    *Yanghui Fu, Yunfei Wang, Hao Zou, Yue He, Haotian Wang, Qing Cheng, Guangquan Cheng, Shixuan Liu*

1. **ScaleGNN: Towards Scalable Graph Neural Networks via Adaptive High-order Neighboring Feature Fusion.**

    *Xiang Li, Jianpeng Qi, Haobing Liu, Yuan Cao, Guoqing Chao, Zhongying Zhao, Junyu Dong, Xinwang Liu, Yanwei Yu*

1. **PIGCN: Physics-Inspired Graph Convolution Networks for Heterogeneous Social Event Detection.**

    *Yongsheng Yu, Congbo Ma, Zitai Qiu, Shan Xue, Jian Yang, Jia Wu*

1. **Weighted Graph Clustering via Scale Contraction and Graph Structure Learning.**
...
1. **Graph Cross-Domain Continual Fine-Tuning via Orthogonal LoRA Routing with Contrastive Expert Specialization.**

    *Qianyi Cai, Ziyue Qiao, Minghao Yang, Xiao Luo, Hui Xiong*

1. **Unveiling Backdoor Propagation in Graphs: Neuron-Centric Defense Mechanisms.**

    *Di Jin, Bingdao Feng, Xiaobao Wang, Yuxiang Zhang, Zechuan Zhang, Liang Yang, Dongxiao He, Zhen Wang*

1. **Hierarchical Graph-Bag-Network for Self-Supervised Multi-Graph Learning.**

    *Meixia Wang, Yuhai Zhao, Zhengkui Wang, Fenglong Ma, Yejiang Wang, Miaomiao Huang, Fazal Wahab, Wen Shan, Xingwei Wang*

1. **MessageShift: Fine-Grained Data Augmentation for Graph Neural Networks.**
...
1. **Heterophily-Agnostic Hypergraph Neural Networks with Riemannian Local Exchanger.**

    *Li Sun, Ming Zhang, Wenxin Jin, Zhongtian Sun, Zhenhao Huang, Hao Peng, Sen Su, Philip S. Yu*

1. **VecFormer: Towards Efficient and Generalizable Graph Transformer with Graph Token Attention.**
...
1. **IVQ-GNN: Mitigating Performance Gap from Graph Connection Pattern Inconsistency via Vector Quantization.**

    *Di Jin, Yixuan Du, Cuiying Huo, Xiaotong Huang, Ruqiong Zhang, Xiaobao Wang, Yawen Li*

1. **Disentangled Graph LLM for Molecule Graph Editing under Distribution Shifts.**

    *Yang Yao, Xin Wang, Yuan Meng, Zeyang Zhang, Hong Mei, Wenwu Zhu*

1. **KEGOD: Kernel-enhanced Latent Substructure Learning for Graph Out-Of-Distribution Detection.**

    *Yifan Wang, Haodong Zhang, Zhiping Xiao, Yusheng Zhao, Siyu Yi, Nan Yin, Xinwang Liu, Ming Zhang, Wei Ju*

1. **Identification of Influential Node Group in Attributed Graph through Explaining Graph Neural Network.**
...
1. **Can LLMs Fool Graph Learning? Exploring Universal Adversarial Attacks on Text-Attributed Graphs.**

    *Zihui Chen, Yuling Wang, Pengfei Jiao, Kai Wu, Xiao Wang, Xiang Ao, Dalin Zhang*

1. **A2GBD: Attack-Agnostic Graph Backdoor Defense.**

    *Chenxu Du, Yang Liu, Xingtong Yu, Zhuoer Xu, Yang Liu, Tianrui Li*

1. **Multi-view Hierarchical Graph Contrastive Learning based on Asynchronous Asymmetric Structure.**
...
1. **Towards Robust Heterogeneous Graph Explanations under Structural Perturbations.**

    *Yifan Lu, Pengfei Jiao, Xuan Guo, Ziyun Zou, Yiwei Wang, Mengzhou Gao, Huaming Wu, Imran Razzak*

1. **Discrete Diffusion-Based Model-Level Explanation of Heterogeneous GNNs with Node Features.**

    *Pallabee Das, Stefan Heindorf*

1. **Long-Tailed Recognition of Evidential Experts for Graph-level Classification.**

    *Wei Ju, Siyu Yi, Zhengyang Mao, Yifang Qin, Yifan Wang, Zhiping Xiao, Yiwei Fu, Ziyue Qiao, Ming Zhang*

1. **SPGCL: Subgraph Pattern-Aware Graph Contrastive Learning for High-Order Structural Representation.**
...
1. **Collaborative Subgraph Learning based Spectrum Sensing under Partial Observations.**

    *Zhaowei Liu, Chang Liu, Dong Yang, Weiqing Yan, Yongchao Song, Anzuo Jiang*

1. **OFA-MAS: One-for-All Multi-Agent System Topology Design based on Mixture-of-Experts Graph Generative Models.**

    *Shiyuan Li, Yixin Liu, Yu Zheng, Mei Li, Quoc Viet Hung Nguyen, Shirui Pan*

1. **LLM-enhanced Federated Graph Learning with Geometry-aware Graph Projection and Shared Subspace Aggregation.**

    *Pengyang Zhou, Zhihao Huang, Jiahe Xu, Wu Wen, Xiaolin Zheng, Chaochao Chen, Jianwei Yin*

1. **Contextual Structure-Enhanced Selective Graph Convolutional Network.**

    *Shifei Ding, Fangchen Li, Lili Guo, Jian Zhang*

1. **Structure-Semantic Synergized Deep Contrastive Graph Clustering.**

    *Shifei Ding, Zhe Li, Xiao Xu, Chao Li*

1. **Unifying Graph Out-of-Distribution Generalization and Detection through Spectral Contrastive Invariant learning.**

    *Tianyin Liao, Ge Lan, Rui Chen, Ran Zhang, Zhiming Chen, Xiao Wang, Ziwei Zhang*

1. **GraphRAG-R1: Graph Retrieval-Augmented Generation with Process-Constrained Reinforcement Learning.**
...
1. **WPIS: From In-the-Wild Web Images to Physics-Aware 3D Scene Graphs for Physical Reasoning.**

    *Ke Ma, Cong Fu, Jianing Wang, Yifei Wang, Wenyuan Li, Xinggang Wang, Meng Wang, Tian Xia*

1. **Revisiting and Enhancing Graph Neural Networks through the Lens of Amortized Flows.**

    *Minjie Cheng, Bokai Yan, Dixin Luo, Hongteng Xu*

1. **STELA: Spatiotemporal Forecasting via Graph Learning and Entropy-Guided LLM Adaptation.**

    *Tiantian Huang, Yue Li, Wei Shao, Ziqi Xu, Qipeng Song, Hui Li*

1. **Towards Geometry-Consistent Federated Graph Learning.**

    *Yuecen Wei, Zhiyu Zhuang, Yisen Gao, Xingcheng Fu, Qingyun Sun, Ziwei Zhang, Tianyu Wo, Chunming Hu*

1. **Towards A Universal Graph Structural Encoder.**

    *Jialin Chen, Haolan Zuo, Haoyu Wang, Siqi Miao, Pan Li, Rex Ying*

1. **Stuart-Landau Oscillatory Graph Neural Network.**

    *Kaicheng Zhang, David N. Reynolds, Piero Deidda, Francesco Tudisco*

1. **SliceGX: Layer-wise GNN Explanation with Model-slicing.**
...
1. **CLGNN: A Contrastive Learning-based GNN for Temporal Betweenness Prediction under Extreme Value Imbalance.**

    *Tianming Zhang, Renbo Zhang, Zhengyi Yang, Yunjun Gao, Bin Cao, Jing Fan*

1. **RARD: Rationale-First Blockwise Autoregressive Diffusion in Rationale?Dominated Graph Generation.**

    *Fan Xu, Yijun Zhang, Sibo Zhang, Jiaxin Ding, Luoyi Fu, Xinbing Wang*

1. **Space-based Parameter Evolving with Lightweight Optimization for Graph Adaptation to Evolving Shifts.**

    *Junyu Luo, Zixuan Ouyang, Xiao Luo, Hourun Li, Zhiping Xiao, Yifan Wang, Ming Zhang*

1. **MultiFPT: Towards Multi-Attribute Fairness in Pre-Trained Graph Neural Networks via Prompt Tuning.**

    *Meng Cao, Mingcai Chen, Shuangjie Li, Hualei Yu, Shuai Feng, Demin Gao*

1. **Towards Open-World Retrieval-Augmented Generation on Knowledge Graph: A Multi-Agent Collaboration Framework.**

    *Jiasheng Xu, Mingda Li, Yongqiang Tang, Peijie Wang, Wensheng Zhang*

1. **BANCO: Drift-Aware Batched Bandits for Adaptive Proximity Graph Pruning.**

    *Jin Cheng, Xiangxiang Dai, Ningning Ding, John C. S. Lui, Jianwei Huang*

1. **HL-CMR: Hypergraph Learning for Cross-Modal Retrieval.**

    *Guohui Ding, Jing Li, Yimin Xu, Rui Zhou*

1. **Diversifying Differentiable Graph Retrieval with Topic-Adaptive Multi-Intent Learning.**

    *Dongcheon Lee, Ji-Yeon Park, Hye-Yoon Baek, Jimyeung Seo, Seyeong Kim, Byungkook Oh*

1. **KEPo: Knowledge Evolution Poison on Graph-based Retrieval-Augmented Generation.**

    *Qizhi Chen, Chao Qi, Yihong Huang, Muquan Li, Rongzheng Wang, Dongyang Zhang, Ke Qin, Shuang Liang*

1. **Reasoning by Exploration: A Unified Approach to Retrieval and Generation over Graphs.**

    *Haoyu Han, Kai Guo, Harry Shomer, Yu Wang, Yucheng Chu, Hang Li, Li Ma, Jiliang Tang*

1. **HyperRAG: Reasoning N-ary Facts over Hypergraphs for Retrieval Augmented Generation.**
...
1. **RPO-RAG: Aligning Small LLMs with Relation-aware Preference Optimization for Knowledge Graph Question Answering.**

    *Kaehyun Um, Kyuhwan Yeom, Haerim Yang, Minyoung Choi, Hyeongjun Yang, Kyong-Ho Lee*

1. **Unveiling and Mitigating Untargeted Poisoning Attacks on Federated Knowledge Graph Embedding.**

    *Wenzheng Jiang, Ke Liang, Wenke Huang, Xiongtao Zhang, Zhenxing Xu, Guancheng Wan, Cheston Tan, Flint Xiaofeng Fan, Ji Wang*

1. **TGNN: Enhancing Pixel Tracking Detection via LLM-driven Annotation and GAT-powered Structural Representation.**

    *Shenping Xiong, Xutong Wang, Ze Jin, Xinyu Liu, Haoqiang Wang, Zhen Chen, Ru Tan, Qixu Liu*

1. **DiSCoQR: Diffusion-Driven Semantic Compression for Robust Image Steganography in Standard QR Codes.**

    *Lijing Ren, Denghui Zhang*

1. **FraudShield: Knowledge Graph Empowered Defense for LLMs against Fraud Attacks.**

    *Naen Xu, Jinghuai Zhang, Ping He, Chunyi Zhou, Jun Wang, Zhihui Fu, Tianyu Du, Zhaoxiang Wang, Shouling Ji*

1. **HyperDetector: Advanced Persistent Threat Detection via Hypergraph Neural Networks with Enhanced Global Perception.**

    *Ziyue Wu, Nan Wang, Jiqiang Liu, Hairong Dong, Xibin Zhao*

1. **SaGD: A Node-Level Differentially Private Graph Learning Framework with Sensitivity-Aware Gradient Descent.**
...
1. **TGweaver: Synthesizing Transaction Graphs for De-anonymization Analysis.**

    *Fajie Wu, Jiajing Wu, Zhiying Wu, Jun Chen, Tao Wang, Longjian He, Bowen Song, Weiqiang Wang*

1. **PWAVEP: Purifying Imperceptible Adversarial Perturbations in 3D Point Clouds via Spectral Graph Wavelets.**

    *Haoran Li, Renyang Liu, Hongjia Liu, Chen Wang, Long Yin, Jian Xu*

1. **Re-understanding Graph Unlearning through Memorization.**

    *Pengfei Ding, Yan Wang, Guanfeng Liu*

1. **Towards Robust Detection of Chinese Toxic Variants via Dynamic Knowledge Graph-LLM Reasoning.**

    *Shaochen Yang, Kefei Zhou, Wei Xu*

1. **DRGW: Learning Disentangled Representations for Robust Graph Watermarking.**

    *Jiasen Li, Yanwei Liu, Zhuoyi Shang, Xiaoyan Gu, Weiping Wang*

1. **PrivSniffer: Graph-based Contextual Privacy Leakage Detection for User-Generated Texts.**

    *Hangyu Ye, Liyao Xiang, Naixuan Huang, Dongyue Yu, Lijun Zhang, Gang Wang*

1. **GIANT: Structure-Agnostic Practical Adversarial Attacks for Graph-based Network Intrusion Detection Systems.**
...
1. **Inferring Users' Demographics and Sensitive Interests Using the Topics API.**

    *Athicha Srivirote, Muhammad Abu Bakar Aziz, Jeffrey L. Gleason, Desheng Hu, Christo Wilson*

1. **Multimodal Graph Conditioned Diffusion Model for Video Captioning.**

    *Benhui Zhang, Junyu Gao, Yuan Yuan*

1. **Aligning Multiple Knowledge Graphs in A Single Pass.**

    *Yaming Yang, Zhe Wang, Ziyu Guan, Wei Zhao, Weigang Lu, Xinyan Huang, Jiangtao Cui, Xiaofei He*

1. **Unifying Deductive and Abductive Reasoning in Knowledge Graphs with Masked Diffusion Model.**

    *Yisen Gao, Jiaxin Bai, Yi Huang, Xingcheng Fu, Qingyun Sun, Yangqiu Song*

1. **LHG: LLM-enhanced and Heterogeneous Graph-induced for Unsupervised Social Event Detection.**

    *Zitai Qiu, Rongwei Xu, Congbo Ma, Shan Xue, Jian Yang, Guanfeng Liu, Quan Z. Sheng, Amin Beheshti, Jia Wu*

1. **DSTAG: A Semantic Tag-Enhanced Dual-Graph Convolutional Network for Temporal Knowledge Graph Completion.**
...
1. **Multi-Granularity Multi-Modal Knowledge Graph Representation Learning via Subgraph-Aware Adaptive Fusion and Hierarchical Relation Modeling.**

    *Peining Li, Meiyu Liang, Wei Huang, Junping Du, Zhe Xue, Guanhua Ye, Wu Liu, Lei Shi*

1. **Grasp: Refining Semantic Graphs into Purified Knowledge for Cross-Modal Communication.**

    *Liang Chen, Xiaoding Wang, Limei Lin, Dajin Wang, Zhiquan Liu, Jie Wu*

1. **CausalSKyHop: Knowledge-Aware Causal Explanation of Dynamic GNNs via Higher-Order Semantic Reasoning.**
...
1. **DyLogNet: A Dynamic Multi-Relational Graph Framework for Log Anomaly Detection.**

    *Xudong Zhao, Xiaolong Xu, Haolong Xiang, Tong Gao, Lianyong Qi, Amin Beheshti, Xuyun Zhang, Wanchun Dou*

1. **Dual History Enhancement with Hybrid Hypergraph-Graph Networks for Temporal Knowledge Graph Reasoning.**
...
1. **When to Trust: A Causality-Aware Calibration Framework for Accurate Knowledge Graph Retrieval-Augmented Generation.**

    *Jing Ren, Bowen Li, Ziqi Xu, Xikun Zhang, Haytham Fayek, Xiaodong Li*

1. **MARCH: Multi-Teacher Contrastive Hypergraph Distillation.**

    *Rongwei Xu, Zitai Qiu, Pengfei Ding, Jia Wu, Yan Wang, Amin Beheshti, Guanfeng Liu*

1. **STARK: Structure-Aware and Adaptive Representation Learning for Continual Knowledge Graph Embedding.**
...
1. **Missingness-aware Federated Contrastive Learning on Semantic Graphs.**

    *Shuo Yu, Zhuoyang Han, Guoqing Han, Tao Tang, Feng Ding, Qiang Zhang*

1. **ReaLM: Residual Quantization Bridges Knowledge Graph Embeddings and Large Language Models.**

    *Wenbin Guo, Xin Wang, Jiaoyan Chen, Lingbing Guo, Zhao Li, Zirui Chen*

1. **Adaptive Multi-Interaction Web Semantic Graph Representation.**

    *Feng Ding, Tingting Wang, Ruolin Li, Ying Jin, Junxiang Zhang, Shan Jin, Yicong Li, Xin Ye*

1. **Conditional Information Extraction with Diffusion Model on Fact-Condition Star Graph.**
...
1. **A Simplex Approach to Synthetic Knowledge Graph Generation.**

    *Ana Alexandra Morim da Silva, Atul Bhopalsing Pundir, Michael Röder, Axel-Cyrille Ngonga Ngomo*

1. **Detecting Miscitation on the Scholarly Web through LLM-Augmented Text-Rich Graph Learning.**
...
1. **DyMRL: Dynamic Multispace Representation Learning for Multimodal Event Forecasting in Knowledge Graph.**

    *Feng Zhao, Kangzheng Liu, Teng Peng, Yu Yang, Guandong Xu*

1. **PRoH: Dynamic Planning and Reasoning over Knowledge Hypergraphs for Retrieval-Augmented Generation.**

    *Xiangjun Zai, Xingyu Tan, Xiaoyang Wang, Qing Liu, Xiwei Xu, Wenjie Zhang*

1. **KG-BiLM: Knowledge Graph Embedding via Bidirectional Language Models.**

    *Zirui Chen, Xin Wang, Zhao Li, Wenbin Guo, Dongxiao He, Yanbing Li, Wushour Silamu*

1. **A Unified Framework for Rule Learning: Integrating Commonsense Knowledge from LLMs with Structured Knowledge from Knowledge Graphs.**

    *Qirui Hao, Kewei Cheng, Tongze Zhang, Hongyuan Liu, Junming Shao, Carl Yang*

1. **MixRAG : Mixture-of-Experts Retrieval-Augmented Generation for Textual Graph Understanding and Question Answering.**

    *Lihui Liu, Jiayuan Ding, Subhabrata Mukherjee, Carl Yang*

1. **Learning to Evolve: Bayesian-Guided Continual Knowledge Graph Embedding.**

    *LinYu Li, Zhi Jin, Yuanpeng He, Dongming Jin, Yichi Zhang, Haoran Duan, Xuan Zhang, Zhengwei Tao, Tashi Nyima*

1. **Counterfactual Meta-task Augmentation for Few-shot Graph Node Classification.**

    *Zhiqiang Wang, Jiaxin Zhang, Chenchao Zhang, Shiying Cheng, Jianqing Liang, Peng Song*

1. **Node Role-Guided LLMs for Dynamic Graph Clustering.**

    *Dongyuan Li, Ying Zhang, Yaozu Wu, Renhe Jiang*

1. **The Devil Within, The Cure Without: Securing Locally Private Graph Learning under Poisoning.**
...
1. **Graph Adversarial Defense via Hilbert-Schmidt Independence Criterion against Influence Maximization Attacks.**

    *Yuxing Guo, Jianqing Liang, Kaixuan Yao, Zhihao Guo, Jiye Liang*

1. **Social Event Prediction via Fourier Graph Learning.**

    *Mingjie Qiu, Zhiyi Tan, Bing-Kun Bao*

1. **Rhythm of Opinion: Interpretable Hawkes-Graph Networks for Hierarchical Opinion Propagation.**
...
1. **FS_GPlib: Breaking the Web-Scale Barrier - A Unified Acceleration Framework for Graph Propagation Models.**
...
1. **Unicoon: Hypergraph-based Multi-Agent Simulation of Information Cocoons.**

    *Chunyu Wei, Yongsiqi Tu, Yunhai Wang*

1. **Securing Your Place in the Review Network: A Dynamic Embeddedness-aware Graph Neural Network for Restaurant Survival Prediction.**

    *Yilong Zang, Hengyun Li, Bruce X. B. Yu, Liangfei Qiu*

1. **Relational Database Distillation: From Structured Tables to Condensed Graph Data.**

    *Xinyi Gao, Jingxi Zhang, Lijian Chen, Tong Chen, Lizhen Cui, Hongzhi Yin*

1. **Beyond Single view Decoding: Dual-view Map Inference from Trajectories via Primal-Dual Graphs Co-generation.**

    *Wenyu Wu, Jiafan Liu, Jiali Mao*

1. **FedRGL: Federated Riemannian Graph Learning in Mixed-Curvature Spaces with Ricci-Gated Convolution.**

    *Haizhou Du, Haolin Wu, Zijie Zhu, Zicheng Shi*

1. **Adaptive Graph Reweighting for Collaborative Filtering.**

    *Yijun Sheng, Ximing Chen, Pui Ieng Lei, Yanyan Liu, Zhiguo Gong*

1. **IACLR: Intention Alignment via Contrastive Learning for Bipartite Graph Recommendation.**

    *Huiying Hu, Tuo Wang, Yixiao Zhou, Xiaoqing Lyu*

1. **PULSE: Socially-Aware User Representation Modeling Toward Parameter-Efficient Graph Collaborative Filtering.**

    *Doyun Choi, Cheonwoo Lee, Biniyam Aschalew Tolera, Taewook Ham, Chanyoung Park, Jaemin Yoo*

1. **Learning on Adaptive Manifolds for Graph Collaborative Filtering.**

    *Guangzhi Qi, GuoJun Liu, Qi Zhou*

1. **Line Graphs Are Here! Unlock a Simple Solution for Data Sparsity and Class Imbalance in Recommender System.**

    *Junming Zhou, Hao Zhong, Shupeng Li, Zhengyang Wu, Yong Tang, Ronghua Lin*

1. **AlphaFree: Recommendation Free from Users, IDs, and GNNs.**

    *Minseo Jeon, Junwoo Jung, Daewon Gwak, Jinhong Jung*

1. **Same Last-Item Confusion Unveiled: A Unified Mitigation Framework for Graph Learning in Session-Based Recommendation.**

    *Jinpeng Chen, Jianxiang He, Yuan Cao, Huan Li, Zhenye Yang, Kaimin Wei, Xiongnan Jin, Senzhang Wang, Weiping Tu*

1. **From Criteria to Ranking: Targeting-Aware Tripartite Graph Learning for Multi-Criteria Recommendation.**

    *Zhenhua Meng, Fanshen Meng*

1. **RaDAR: Relation-aware Diffusion-Asymmetric Graph Contrastive Learning for Recommendation.**

    *Yixuan Huang, Jiawei Chen, Shengfan Zhang, Zongsheng Cao*

1. **C-HyPOD: Causal Hyperbolic Representation Learning with Prototype Orthogonal Disentanglement for Graph Out-of-Distribution Recommendation.**

    *Jiahao Liang, Yutian Xiao, Haoran Yang, Zhiwen Yu, Jia-Nan Liu, Kaixiang Yang*

1. **Post-hoc Popularity Bias Correction in GNN-based Collaborative Filtering.**

    *Md Aminul Islam, Elena Zheleva, Ren Wang*

1. **Multi-modal Bipartite Graph Structure Learning with Information Bottleneck for Micro-video Recommendation.**
...
1. **Interpretable Dynamic Network Modeling of Tensor Time Series via Kronecker Time-Varying Graphical Lasso.**

    *Shingo Higashiguchi, Koki Kawabata, Yasuko Matsubara, Yasushi Sakurai*

1. **VL-KGE: Vision-Language Models Meet Knowledge Graph Embeddings.**

    *Athanasios Efthymiou, Stevan Rudinac, Monika Kackovic, Nachoem Wijnberg, Marcel Worring*

1. **GPU-accelerated Multi-relational Parallel Graph Retrieval for Web-scale Recommendations.**

    *Zhuoning Guo, Guangxing Chen, Qian Gao, Xiaochao Liao, Jianjia Zheng, Lu Shen, Hao Liu*

1. **URLBank: Data-Driven URL Discovery via Temporal Link Graphs.**
...
1. **Delay-Aware Graph Neural Stochastic Differential Equations for Financial Time Series Modeling and Forecasting.**

    *Mingjie You, Dawei Cheng, Meilin Zhang, Peng Zhu, Yuqi Liang*
...
1. **Graph Discrete Prompt Optimization for Knowledge Graph Question Answering.**

    *Wooyoung Kim, HaeMin Jung, Byeongjin Kim, Suhyeon Kwon, Wooju Kim*

1. **Fedivertex: a Graph Dataset based on Decentralized Social Media.**

    *Marc Damie, Edwige Cyffers*

1. **An Improved Combinatorial Algorithm for Edge-Colored Clustering in Hypergraphs.**

    *Seongjune Han, Nate Veldt*

1. **Beyond Isolated Clients: Integrating Graph-Based Embeddings into Event Sequence Models.**

    *Harry Proshian, Nikita Severin, Sergey I. Nikolenko, Ivan Kireev, Andrey V. Savchenko, Ivan Sergeev, Maria Postnova, Ilya Makarov*

1. **Graph Poisoning for Node Rank Manipulation.**

    *Seyed Mohammad Hosseini, Radin Hamidi Rad, Morteza Zihayat, Ebrahim Bagheri*

1. **SIT-KGED: Simply Inject Topology into LLM for Knowledge Graph Error Detection.**

    *Ting Li, Xingyi Mao, Yipeng Yu, Liang Yao*

1. **Explainable Graph Sparsification with Shapley Values.**

    *Selahattin Akkas, Ariful Azad*

1. **Multi-Behavior Sequential Modeling with Transition-Aware Graph Attention Network for E-Commerce Recommendation.**

    *Hanqi Jin, Gaoming Yang, Zhangming Chan, Yapeng Yuan, Longbin Li, Fei Sun, Yeqiu Yang, Jian Wu, Yuning Jiang, Bo Zheng*

1. **MiniAMIE: Quick and Dirty Rule Mining on Knowledge Graphs.**

    *Luis Galárraga, Julianne Guerbette, Isseïnie Sinouvassane, Paul Viallard*

1. **How Graphs Can Help You Stay Informed in an Evolving World.**
...
1. **Agent-Enhanced Heterogeneous Graph RAG for Academic Question Answering.**
...
1. **Credit and Power Co-evolution Modeling with Dynamic Graph Learning.**
...
1. **Toward Green Computing: General Carbon Intensity Forecasting via Dual Graph Empowered Time Series Foundation Model.**

    *Xiaoyang Zhang, Taiqi Zhou, Fang He, Yang Deng, Dan Wang*

1. **Genomic-Informed Heterogeneous Graph Learning for Spatiotemporal Avian Influenza Outbreak Forecasting.**

    *Jing Du, Haley Stone, Yang Yang, Ashna Desai, Hao Xue, Andreas Züfle, C. Raina MacIntyre, Flora D. Salim*

1. **Spiking Graph Predictive Coding for Reliable OOD Generalization.**

    *Jing Ren, Jiapeng Du, Bowen Li, Ziqi Xu, Xin Zheng, Hong Jia, Suyu Ma, Xiwei Xu, Feng Xia*

1. **GORAG: Graph-based Online Retrieval Augmented Generation for Dynamic Few-shot Social Media Text Classification.**

    *Yubo Wang, Haoyang Li, Fei Teng, Lei Chen*

1. **CompTox Ontology: Leveraging Knowledge Graphs for PFAS Monitoring and Decision-Making.**
...
1. **FairGU: Fairness-aware Graph Unlearning in Social Networks.**
...
1. **EmeraldMind: A Knowledge Graph-Augmented Framework for Greenwashing Detection.**
...
1. **AriGraph: Learning Knowledge Graph World Models with Episodic Memory for LLM Agents.**
    ...
    *Petr Anokhin, Nikita Semenov, Artyom Y. Sorokin, Dmitry Evseev, Andrey Kravchenko, Mikhail Burtsev, Evgeny Burnaev*

1. **Multi-Agent Communication with Information Preserving Graph Contrastive Learning.**

    *Wei Du, Shifei Ding, Wei Guo, Yuqing Sun, Guoxian Yu, Lizhen Cui*

1. **fairGNN-WOD: Fair Graph Learning Without Complete Demographics.**

    *Zichong Wang, Fang Liu, Shimei Pan, Jun Liu, Fahad Saeed, Meikang Qiu, Wenbin Zhang*

1. **Towards Fairness with Limited Demographics via Disentangled Learning.**

    *Zichong Wang, Anqi Wu, Nuno Moniz, Shu Hu, Bart P. Knijnenburg, Xingquan Zhu, Wenbin Zhang*

1. **Explainable Graph Neural Networks via Structural Externalities.**

    *Lijun Wu, Dong Hao, Zhiyi Fan*

1. **GraphProt: Certified Black-Box Shielding Against Backdoored Graph Models.**

    *Xiao Yang, Yuni Lai, Kai Zhou, Gaolei Li, Jianhua Li, Hang Zhang*

1. **Causality-Inspired Disentanglement for Fair Graph Neural Networks.**

    *Guixian Zhang, Debo Cheng, Guan Yuan, Shang Liu, Yanmei Zhang*

1. **Modality-Guided Dynamic Graph Fusion and Temporal Diffusion for Self-Supervised RGB-T Tracking.**

    *Shenglan Li, Rui Yao, Yong Zhou, Hancheng Zhu, Kunyang Sun, Bing Liu, Zhiwen Shao, Jiaqi Zhao*

1. **Graph Prompts: Adapting Video Graph for Video Question Answering.**

    *Yiming Li, Xiaoshan Yang, Bing-Kun Bao, Changsheng Xu*

1. **MGCA-Net: Multi-Graph Contextual Attention Network for Two-View Correspondence Learning.**

    *Shuyuan Lin, Mengtin Lo, Haosheng Chen, Yanjie Liang, Qiangqiang Wu*

1. **GLDiTalker: Speech-Driven 3D Facial Animation with Graph Latent Diffusion Transformer.**

    *Yihong Lin, Zhaoxin Fan, Xianjia Wu, Lingyu Xiong, Xiandong Li, Wenxiong Kang, Liang Peng, Songju Lei, Huang Xu*

1. **Multimodal Cancer Survival Analysis via Hypergraph Learning with Cross-Modality Rebalance.**

    *Mingcheng Qu, Guang Yang, Donglin Di, Tonghua Su, Yue Gao, Yang Song, Lei Fan*

1. **Gaussian Mixture Model for Graph Domain Adaptation.**
...
1. **AKBR: Learning Adaptive Kernel-based Representations for Graph Classification.**

    *Lu Bai, Feifei Qian, Lixin Cui, Ming Li, Hangyuan Du, Yue Wang, Edwin R. Hancock*

1. **GPL4SRec: Graph Multi-Level Aware Prompt Learning for Streaming Recommendation.**

    *Hao Cang, Huanhuan Yuan, Jiaqing Fan, Lei Zhao, Guanfeng Liu, Pengpeng Zhao*

1. **Antibody Design and Optimization with Multi-scale Equivariant Graph Diffusion Models for Accurate Complex Antigen Binding.**
...
1. **HyperDet: Source Detection in Hypergraphs via Interactive Relationship Construction and Feature-rich Attention Fusion.**

    *Le Cheng, Peican Zhu, Yangming Guo, Keke Tang, Chao Gao, Zhen Wang*

1. **Adaptive Graph Unlearning.**

    *Pengfei Ding, Yan Wang, Guanfeng Liu, Jiajie Zhu*

1. **Suit the Node Pair to the Case: A Multi-Scale Node Pair Grouping Strategy for Graph-MLP Distillation.**

    *Rui Dong, Jiaxing Li, Weihuang Zheng, Youyong Kong*

1. **Exploiting Self-Refining Normal Graph Structures for Robust Defense against Unsupervised Adversarial Attacks.**

    *Bingdao Feng, Di Jin, Xiaobao Wang, Dongxiao He, Jingyi Cao, Zhen Wang*

1. **Efficient Dynamic Graphs Learning with Refined Batch Parallel Training.**

    *ZhengZhao Feng, Rui Wang, Longjiao Zhang, Tongya Zheng, Ziqi Huang, Mingli Song*

1. **Hierarchy Knowledge Graph for Parameter-Efficient Entity Embedding.**

    *Hepeng Gao, Funing Yang, Yongjian Yang, Ying Wang*

1. **NeuBM: Mitigating Model Bias in Graph Neural Networks Through Neutral Input Calibration.**
...
1. **MaskDGNN: Self-Supervised Dynamic Graph Neural Networks with Activeness-aware Temporal Masking.**

    *Yiming He, Xiang Li, Zhongying Zhao, Haobing Liu, Peilan He, Yanwei Yu*

1. **Aggregation Mechanism Based Graph Heterogeneous Networks Distillation.**
...
1. **Soft Reasoning Paths for Knowledge Graph Completion.**

    *Yanning Hou, Sihang Zhou, Ke Liang, Lingyuan Meng, Xiaoshu Chen, Ke Xu, Siwei Wang, Xinwang Liu, Jian Huang*

1. **OS-GCL: A One-Shot Learner in Graph Contrastive Learning.**

    *Cheng Ji, Chenrui He, Qian Li, Qingyun Sun, Xingcheng Fu, Jianxin Li*

1. **Hybrid Relational Graphs with Sentiment-laden Semantic Alignment for Multimodal Emotion Recognition in Conversation.**

    *Hongru Ji, Xianghua Li, Mingxin Li, Meng Zhao, Chao Gao*

1. **HGMP: Heterogeneous Graph Multi-Task Prompt Learning.**

    *Pengfei Jiao, Jialong Ni, Di Jin, Xuan Guo, Huan Liu, Hongjiang Chen, Yanxian Bi*

1. **FedCCH: Automatic Personalized Graph Federated Learning for Inter-Client and Intra-Client Heterogeneity.**
...
1. **TOTF: Missing-Aware Encoders for Clustering on Multi-View Incomplete Attributed Graphs.**

    *Mengyao Li, Xu Zhou, Jiapeng Zhang, Zhibang Yang, Cen Chen, Kenli Li*

1. **Single-Node Trigger Backdoor Attacks in Graph-Based Recommendation Systems.**

    *Runze Li, Di Jin, Xiaobao Wang, Dongxiao He, Bingdao Feng, Zhen Wang*

1. **Beyond Individual and Point: Next POI Recommendation via Region-aware Dynamic Hypergraph with Dual-level Modeling.**

    *Xixi Li, Zhuo Gu, Rui Yao, Yong Zhou, Hancheng Zhu, Jiaqi Zhao, Wenliang Du*

1. **Query-Based and Unnoticeable Graph Injection Attack from Neighborhood Perspective.**

    *Chang Liu, Hai Huang, Xingquan Zuo*

1. **Heterogeneous Temporal Hypergraph Neural Network.**

    *Huan Liu, Pengfei Jiao, Mengzhou Gao, Chaochao Chen, Di Jin*

1. **Sharpness-aware Zeroth-order Optimization for Graph Transformers.**

    *Yang Liu, Chuan Zhou, Yuhan Lin, Shuai Zhang, Yang Gao, Zhao Li, Shirui Pan*

1. **DGExplainer: Explaining Dynamic Graph Neural Networks via Relevance Back-propagation.**

    *Yezi Liu, Jiaxuan Xie, Yanning Shen*

1. **Variational Graph Auto-Encoder Driven Graph Enhancement for Sequential Recommendation.**

    *Yuwen Liu, Lianyong Qi, Xingyuan Mao, Weiming Liu, Shichao Pei, Fan Wang, Xuyun Zhang, Amin Beheshti, Xiaokang Zhou*

1. **Dynamic Seed-GrowthCM: A Dynamic Benefit-Oriented Algorithm for Core Maximization on Large Graphs.**

    *Dongyuan Ma, Dongxiao He, Xin Huang*

1. **PALA: Class-imbalanced Graph Domain Adaptation via Prototype-anchored Learning and Alignment.**

    *Xin Ma, Yifan Wang, Siyu Yi, Wei Ju, Bei Wu, Ziyue Qiao, Chenwei Tang, Jiancheng Lv*

1. **Rethinking Graph Contrastive Learning Through Relative Similarity Preservation.**
...
1. **Exploring the Over-smoothing Problem of Graph Neural Networks for Graph Classification: An Entropy-based Viewpoint.**

    *Feifei Qian, Lu Bai, Lixin Cui, Ming Li, Hangyuan Du, Yue Wang, Edwin R. Hancock*

1. **HA-SCN: Learning Hierarchical Aligned Subtree Convolutional Networks for Graph Classification.**

    *Xinya Qin, Lu Bai, Lixin Cui, Ming Li, Hangyuan Du, Yue Wang, Edwin R. Hancock*

1. **DHTAGK: Deep Hierarchical Transitive-Aligned Graph Kernels for Graph Classification.**

    *Xinya Qin, Lu Bai, Lixin Cui, Ming Li, Ziyu Lyu, Hangyuan Du, Edwin R. Hancock*
...
1. **Riding the Wave: Multi-Scale Spatial-Temporal Graph Learning for Highway Traffic Flow Prediction Under Overload Scenarios.**

    *Xigang Sun, Jiahui Jin, Hancheng Wang, Xiangguo Sun, Xiaoliang Wang, Jun Zhu*

1. **An Out-Of-Distribution Membership Inference Attack Approach for Cross-Domain Graph Attacks.**

    *Jinyan Wang, Liu Yang, Yuecen Wei, Jiaxuan Si, Chenhao Guo, Qingyun Sun, Xianxian Li, Xingcheng Fu*

1. **Explainable Graph Representation Learning via Graph Pattern Analysis.**

    *Xudong Wang, Ziheng Sun, Chris Ding, Jicong Fan*

1. **Learning Neural Jump Stochastic Differential Equations with Latent Graph for Multivariate Temporal Point Processes.**

    *Yuchen Wang, Dongpeng Hou, Chao Gao, Xianghua Li*

1. **HeTa: Relation-wise Heterogeneous Graph Foundation Attack Model.**
...
1. **Let's Group: A Plug-and-Play SubGraph Learning Method for Memory-Efficient Spatio-Temporal Graph Modeling.**
...
1. **DGraFormer: Dynamic Graph Learning Guided Multi-Scale Transformer for Multivariate Time Series Forecasting.**

    *Han Yan, Dongliang Chen, Guiyuan Jiang, Bin Wang, Lei Cao, Junyu Dong, Yanwei Yu*

1. **Revealing Concept Shift in Spatio-Temporal Graphs via State Learning.**

    *Kuo Yang, Yunhe Guo, Qihe Huang, Zhengyang Zhou, Yang Wang*

1. **Universal Graph Self-Contrastive Learning.**

    *Liang Yang, Yukun Cai, Hui Ning, Jiaming Zhuo, Di Jin, Ziyi Ma, Yuanfang Guo, Chuan Wang, Zhen Wang*

1. **Coupling Category Alignment for Graph Domain Adaptation.**

    *Nan Yin, Xiao Teng, Zhiguang Cao, Mengzhu Wang*

1. **A Prior-based Discrete Diffusion Model for Social Graph Generation.**

    *Shu Yin, Dongpeng Hou, Lianwei Wu, Xianghua Li, Chao Gao*

1. **A Centrality-based Graph Learning Framework.**
...
1. **MEGAD: A Memory-Efficient Framework for Large-Scale Attributed Graph Anomaly Detection.**

    *Yifan Zhang, Haolong Xiang, Xiaolong Xu, Zishun Rui, Xiaoyong Li, Lianyong Qi, Fei Dai*

1. **An End-to-End Simple Clustering Hierarchical Pooling Operation for Graph Learning Based on Top-K Node Selection.**

    *Zhehan Zhao, Lu Bai, Ming Li, Lixin Cui, Hangyuan Du, Yue Wang, Edwin R. Hancock*

1. **Generate or Re-Weight? A Mutual-Guidance Method for Class-Imbalanced Graphs.**

    *Zhongying Zhao, Gen Liu, Qi Meng, Chao Li, Qingtian Zeng*

1. **CoLA-Former: Graph Transformer Using Communal Linear Attention for Lightweight Sequential Recommendation.**

    *Zhongying Zhao, Jinyu Zhang, Chuanxu Jia, Chao Li, Yanwei Yu, Qingtian Zeng*

1. **Progressive Prefix-Memory Tuning for Complex Logical Query Answering on Knowledge Graphs.**

    *Xingrui Zhuo, Shirui Pan, Jiapu Wang, Gongqing Wu, Zan Zhang, Rui Li, Zizhong Wei, Xindong Wu*

1. **Variety-Seeking Jump Games on Graphs.**

    *Lata Narayanan, Jaroslav Opatrny, Shanmukha Tummala, Alexandros A. Voudouris*

1. **Community-Aware Graph Transformer for Brain Disorder Identification.**

    *Shengbing Pei, Jiajun Ma, Zhao Lv, Chao Zhang, Jihong Guan*

1. **kgMBQA: Quality Knowledge Graph-driven Multimodal Blind Image Assessment.**

    *Wuyuan Xie, Tingcheng Bian, Miaohui Wang*

1. **Test-Time Adaptation on Recommender System with Data-Centric Graph Transformation.**

    *Yating Liu, Xin Zheng, Yi Li, Yanqing Guo*

1. **FS-KEN: Few-shot Knowledge Graph Reasoning by Adversarial Negative Enhancing.**

    *Lingyuan Meng, Ke Liang, Zeyu Zhu, Xinwang Liu, Wenpeng Lu*

1. **Rewarding Explainability in Drug Repurposing with Knowledge Graphs.**

    *Susana Nunes, Samy Badreddine, Catia Pesquita*

1. **Verifying Quantized Graph Neural Networks is PSPACE-complete.**

    *Marco Sälzer, François Schwarzentruber, Nicolas Troquard*

1. **LLM4VKG: Leveraging Large Language Models for Virtual Knowledge Graph Construction.**
...
1. **Adversarial Training for Graph Convolutional Networks: Stability and Generalization Analysis.**

    *Chang Cao, Han Li, Yulong Wang, Rui Wu, Hong Chen*

1. **GRAPE: Heterogeneous Graph Representation Learning for Genetic Perturbation with Coding and Non-Coding Biotype.**

    *Changxi Chi, Jun Xia, Jingbo Zhou, Jiabei Cheng, Chang Yu, Stan Z. Li*

1. **HiTuner: Hierarchical Semantic Fusion Model Fine-Tuning on Text-Attributed Graphs.**

    *Zihan Fang, Zhiling Cai, Yuxuan Zheng, Shide Du, Yanchao Tan, Shiping Wang*

1. **Federated Multi-view Graph Clustering with Incomplete Attribute Imputation.**

    *Wei Feng, Zeyu Bi, Qianqian Wang, Bo Dong*

1. **Tensorial Multi-view Clustering with Deep Anchor Graph Projection.**

    *Wei Feng, Dongyuvan Wei, Qianqian Wang, Bo Dong*

1. **Learn from Global Rather Than Local: Consistent Context-Aware Representation Learning for Multi-View Graph Clustering.**

    *Lele Fu, Bowen Deng, Sheng Huang, Tianchi Liao, Chuanfu Zhang, Chuan Chen*

1. **Structure-Aware Handwritten Text Recognition via Graph-Enhanced Cross-Modal Mutual Learning.**

    *Ji Gan, Yupeng Zhou, Yanming Zhang, Jiaxu Leng, Xinbo Gao*

1. **Graph Random Walk with Feature-Label Space Alignment: A Multi-Label Feature Selection Method.**
...
1. **ADPFedGNN: Adaptive Decoupling Personalized Federated Graph Neural Network.**

    *Zeli Guan, Yawen Li, Junping Du, Runqing Tang, Xiaolong Meng*

1. **Graph Embedded Contrastive Learning for Multi-View Clustering.**
...
1. **FedBG: Proactively Mitigating Bias in Cross-Domain Graph Federated Learning Using Background Data.**

    *Sheng Huang, Lele Fu, Tianchi Liao, Bowen Deng, Chuanfu Zhang, Chuan Chen*

1. **Going Beyond Consistency: Target-oriented Multi-view Graph Neural Network.**

    *Sujia Huang, Lele Fu, Shuman Zhuang, Yide Qiu, Bo Huang, Zhen Cui, Tong Zhang*

1. **Leveraging Peer-Informed Label Consistency for Robust Graph Neural Networks with Noisy Labels.**

    *Kailai Li, Jiawei Sun, Jiong Lou, Zhanbo Feng, Hefeng Zhou, Chentao Wu, Guangtao Xue, Wei Zhao, Jie Li*

1. **Uncertainty-guided Graph Contrastive Learning from a Unified Perspective.**

    *Zhiqiang Li, Jie Wang, Jianqing Liang, Junbiao Cui, Xingwang Zhao, Jiye Liang*

1. **Critical Node-aware Augmentation for Hypergraph Contrastive Learning.**

    *Zhuo Li, Yuena Lin, Yipeng Wang, Wenmao Liu, Mingliang Yu, Zhen Yang, Gengyu Lyu*
...
1. **Capturing Individuality and Commonality Between Anchor Graphs for Multi-View Clustering.**

    *Zhoumin Lu, Yongbo Yu, Linru Ma, Feiping Nie, Rong Wang*

1. **Mitigating Over-Smoothing in Graph Neural Networks via Separation Coefficient-Guided Adaptive Graph Structure Adjustment.**

    *Hanyang Meng, Jielong Yang, Li Peng*

1. **SALE-MLP: Structure Aware Latent Embeddings for GNN to Graph-free MLP Distillation.**

    *Harsh Pal, Sarthak Malik, Rajat Patel, Aakarsh Malhotra*

1. **What Can We Learn From MIMO Graph Convolutions?**

    *Andreas Roth, Thomas Liebig*

1. **HGEN: Heterogeneous Graph Ensemble Networks.**

    *Jiajun Shen, Yufei Jin, Kaibu Feng, Yi He, Xingquan Zhu*

1. **MATCH: Modality-Calibrated Hypergraph Fusion Network for Conversational Emotion Recognition.**

    *Jiandong Shi, Ming Li, Lu Bai, Feilong Cao, Ke Lu, Jiye Liang*

1. **GSDNet: Revisiting Incomplete Multimodality-Diffusion Emotion Recognition from the Perspective of Graph Spectrum.**

    *Yuntao Shou, Jun Yao, Tao Meng, Wei Ai, Cen Chen, Keqin Li*

1. **Metapath and Hypergraph Structure-based Multi-Channel Graph Contrastive Learning for Student Performance Prediction.**

    *Lingyun Song, Xiaofan Sun, Xinbiao Gan, Yudai Pan, Xiaolin Han, Jie Ma, Jun Liu, Xuequn Shang*

1. **A Simple yet Effective Hypergraph Clustering Network.**

    *Qianqian Wang, Bowen Zhao, Zhengming Ding, Xiangdong Zhang, Quanxue Gao*

1. **All Roads Lead to Rome: Exploring Edge Distribution Shifts for Heterophilic Graph Learning.**

    *Yi Wang, Changqin Huang, Ming Li, Tingyi Cai, Zhonglong Zheng, Xiaodi Huang*

1. **Leveraging Personalized PageRank and Higher-Order Topological Structures for Heterophily Mitigation in Graph Neural Networks.**

    *Yumeng Wang, Zengyi Wo, Wenjun Wang, Xingcheng Fu, Minglai Shao*

1. **Wave-driven Graph Neural Networks with Energy Dynamics for Over-smoothing Mitigation.**

    *Peihan Wu, Hongda Qi, Sirong Huang, Dongdong An, Jie Lian, Qin Zhao*

1. **Divide and Conquer: Coordinating Multiplex Mixture of Graph Learners to Handle Multi-Omics Analysis.**

    *Zhihao Wu, Jielong Lu, Jiajun Yu, Sheng Zhou, Yueyang Pi, Haishuai Wang*

1. **Dynamic Anchor-based Ensemble Clustering via Hypergraph Reconstruction.**

    *Jiaxuan Xu, Lei Duan, Xinye Wang, Liang Du*

1. **Problem-dependent Regret for Lexicographic Multi-Armed Bandits with Adversarial Corruptions.**

    *Bo Xue, Xi Lin, Yuanyu Wan, Qingfu Zhang*

1. **Multi-Task Curriculum Graph Contrastive Learning with Clustering Entropy Guidance.**

    *Chusheng Zeng, Bocheng Wang, Jinghui Yuan, Mulin Chen, Xuelong Li*

1. **Rethinking Federated Graph Learning: A Data Condensation Perspective.**

    *Hao Zhang, Xunkai Li, Yinlin Zhu, Lianglin Hu*

1. **Graph OOD Detection via Plug-and-Play Energy-based Evaluation and Propagation.**

    *Yunxia Zhang, Mingchen Sun, Yutong Zhang, Funing Yang, Ying Wang*

1. **High-Confident Local Structure Guided Consensus Graph Learning For Incomplete Multi-view Clustering.**

    *Shuping Zhao, Lunke Fei, Qi Lai, Jie Wen, Jinrong Cui, Tingting Chai*

1. **Negative Metric Learning for Graphs.**

    *Yiyang Zhao, Chengpei Wu, Lilin Zhang, Ning Yang*

1. **A Dynamic Stiefel Graph Neural Network for Efficient Spatio-Temporal Time Series Forecasting.**

    *Jiankai Zheng, Liang Xie*

1. **Robust Graph Contrastive Learning for Incomplete Multi-view Clustering.**

    *Deyin Zhuang, Jian Dai, Xingfeng Li, Xi Wu, Yuan Sun, Zhenwen Ren*

1. **Strategy-Architecture Synergy: A Multi-View Graph Contrastive Paradigm for Consistent Representations.**

    *Shuman Zhuang, Zhihao Wu, Yuhong Chen, Zihan Fang, Jiali Yin, Ximeng Liu*

1. **Enhanced Graph Similarity Learning via Adaptive Multi-scale Feature Fusion.**

    *Cuifang Zou, Guangquan Lu, Wenzhen Zhang, Xuxia Zeng, Shilong Lin, Longqing Du, Shichao Zhang*

1. **State Feedback Enhanced Graph Differential Equations for Multivariate Time Series Forecasting.**

    *Jiaxu Cui, Qipeng Wang, Yiming Zhao, Bingyi Sun, Pengfei Wang, Bo Yang*

1. **Advancing Community Detection with Graph Convolutional Neural Networks: Bridging Topological and Attributive Cohesion.**

    *Anjali de Silva, Gang Chen, Hui Ma, Seyed Mohammad Nekooei, Xingquan Zuo*

1. **Contrastive Cross-Course Knowledge Tracing via Concept Graph Guided Knowledge Transfer.**

    *Wenkang Han, Wang Lin, Liya Hu, Zhenlong Dai, Yiyun Zhou, Mengze Li, Zemin Liu, Chang Yao, Jingyuan Chen*

1. **APIMig: A Project-Level Cross-Multi-Version API Migration Framework Based on Evolution Knowledge Graph.**

    *Li Kuang, Qi Xie, Haiyang Yang, Yang Yang, Xiang Wei, HaoYue Kang, Yingjie Xia*

1. **MTGIB-UNet: A Multi-Task Graph Information Bottleneck and Uncertainty Weighted Network for ADMET Prediction.**

    *Xuqiang Li, Wenjie Du, Jun Xia, Jianmin Wang, Xiaoqi Wang, Yang Yang, Yang Wang*

1. **COGRASP: Co-Occurrence Graph Based Stock Price Forecasting.**

    *Zhengze Li, Zilin Song, Tingting Yuan, Xiaoming Fu*

1. **PAMol: Pocket-Aware Drug Design Method with Hypergraph Representation of Protein Pocket Structure and Feature Fusion.**

    *Xiaoli Lin, Xiongwei Liao, Jun Pang, Bo Li, Xiaolong Zhang*

1. **Can We Translate Code Better with LLMs and Call Graph Analysis?**

    *Yang Luo*

1. **PDDFormer: Pairwise Distance Distribution Graph Transformer for Crystal Material Property Prediction.**
...
1. **Backdoor Attack on Vertical Federated Graph Neural Network Learning.**
    ...
    *Jirui Yang, Peng Chen, Zhihui Lu, Jianping Zeng, Qiang Duan, Xin Du, Ruijun Deng*

1. **Subgraph Information Bottleneck with Causal Dependency for Stable Molecular Relational Learning.**

    *Peiliang Zhang, Jingling Yuan, Chao Che, Yongjun Zhu, Lin Li*

1. **Sanitizing Backdoored Graph Neural Networks: A Multidimensional Approach.**

    *Rong Zhao, Jilian Zhang, Yu Wang, Yinyan Zhang, Jian Weng*

1. **SecV: LLM-based Secure Verilog Generation with Clue-Guided Exploration on Hardware-CWE Knowledge Graph.**

    *Fanghao Fan, Yingjie Xia, Li Kuang*

1. **Learn to Think: Bootstrapping LLM Logic Through Graph Representation Learning.**

    *Hang Gao, Chenhao Zhang, Tie Wang, Junsuo Zhao, Fengge Wu, Changwen Zheng, Huaping Liu*

1. **How to Mitigate Information Loss in Knowledge Graphs for GraphRAG: Leveraging Triple Context Restoration and Query-Driven Feedback.**

    *Manzong Huang, Chenyang Bu, Yi He, Xindong Wu*

1. **Variational Multi-Modal Hypergraph Attention Network for Multi-Modal Relation Extraction.**

    *Qian Li, Cheng Ji, Shu Guo, Kun Peng, Qianren Mao, Shangguang Wang*

1. **DGCPL: Dual Graph Distillation for Concept Prerequisite Relation Learning.**

    *Miao Zhang, Jiawei Wang, Jinying Han, Kui Xiao, Zhifei Li, Yan Zhang, Hao Chen, Shihui Wang*

1. **Sentiment-enhanced Multi-hop Connected Graph Attention Network for Multimodal Aspect-Based Sentiment Analysis.**
...
1. **GCNT: Graph-Based Transformer Policies for Morphology-Agnostic Reinforcement Learning.**

    *Yingbo Luo, Meibao Yao, Xueming Xiao*

1. **InfVC: An Inference-Enhanced Local Search Algorithm for the Minimum Vertex Cover Problem in Massive Graphs.**

    *Rui Sun, Peiyan Liu, Yiyuan Wang, Zhaohui Liu, Liping Du, Jian Gao*

1. **Efficient Constraint-based Window Causal Graph Discovery in Time Series with Multiple Time Lags.**

    *Yewei Xia, Yixin Ren, Hong Cheng, Hao Zhang, Jihong Guan, Minchuan Xu, Shuigeng Zhou*

1. **SpeechHGT: A Multimodal Hypergraph Transformer for Speech-Based Early Alzheimer's Disease Detection.**

    *Shagufta Abid, Dongyu Zhang, Ahsan Shehzad, Jing Ren, Shuo Yu, Hongfei Lin, Feng Xia*

1. **Empowering Quantum Serverless Circuit Deployment Optimization via Graph Contrastive Learning and Learning-to-Rank Co-designed Approaches.**

    *Tingting Li, Ziming Zhao, Jianwei Yin*

1. **The Graph's Apprentice: Teaching an LLM Low-Level Knowledge for Circuit Quality Estimation.**
...
1. **MolHFCNet: Enhancing Molecular Graph Representations with Hierarchical Feature Combining and Hybrid Pretraining.**

    *Duy-Long Nguyen, Duc-Luong Ho-Viet, Anh-Thu Ngo-Tran, Quang H. Nguyen, Binh P. Nguyen*

1. **KGCL: Knowledge-Enhanced Graph Contrastive Learning for Retrosynthesis Prediction Based on Molecular Graph Editing.**

    *Fengqin Yang, Dekui Zhao, Haoxuan Qiu, Yifei Li, Zhiguo Fu*

1. **HygMap: Representing All Types of Map Entities via Heterogeneous Hypergraph.**
...
1. **Enhancing Portfolio Optimization via Heuristic-Guided Inverse Reinforcement Learning with Multi-Objective Reward and Graph-based Policy Learning.**

    *Wenyi Zhang, Renjun Jia, Yanhao Wang, Dawei Cheng, Minghao Zhao, Cen Chen*

1. **MutationGuard: A Graph and Temporal-Spatial Neural Method for Detecting Mutation Telecommunication Fraud.**
...
1. **Detection and Geographic Localization of Natural Objects in the Wild: A Case Study on Palms.**

    *Kangning Cui, Rongkun Zhu, Manqi Wang, Wei Tang, Gregory D. Larsen, Victor Paúl Pauca, Sarra M. Alqahtani, Fan Yang, David Segurado, David A. Lutz, Jean-Michel Morel, Miles R. Silman*

1. **Detecting Illicit Massage Businesses by Leveraging Graph Machine Learning.**

    *Vasuki Garg, Osman Y. Özaltin, Maria E. Mayorga, Sherrie Bosisto*

1. **Direct Estimation of Attenuation Information from Sinograms for Positron Emission Tomography Reconstruction.**

    *Prabath Hetti Mudiyanselage, Ruwan B. Tennakoon, John Thangarajah, Robert Ware, Jason H. Callahan*

1. **IGraSS: Learning to Identify Infrastructure Networks from Satellite Imagery by Iterative Graph-constrained Semantic Segmentation.**
...
1. **Towards the 30 by 30 Kunming-Montreal Global Biodiversity Framework Target: Optimising Graph Connectivity in Constraint-Based Spatial Planning.**
...
1. **BGM: Demand Prediction for Expanding Bike-Sharing Systems with Dynamic Graph Modeling.**

    *Yixuan Zhao, Hongkai Wen, Xingchen Zhang, Man Luo*

1. **A Survey on Temporal Interaction Graph Representation Learning: Progress, Challenges, and Opportunities.**
...
1. **A Survey on Multi-View Knowledge Graph: Generation, Fusion, Applications and Future Directions.**

    *Zihan Yang, Xiaohui Tao, Taotao Cai, Yifu Tang, Haoran Xie, Lin Li, Jianxin Li, Qing Li*

1. **Scalable Graph Classification via Random Walk Fingerprints (Extended Abstract).**

    *Peiyan Li, Honglian Wang, Christian Böhm*

1. **Scalable Primal Heuristics Using Graph Neural Networks for Combinatorial Optimization (Abstract Reprint).**

    *Furkan Cantürk, Taha Varol, Reyhan Aydogan, Okan Örsan Özener*

1. **On Measuring Inconsistency in Graph Databases with Regular Path Constraints (Abstract Reprint).**

    *John Grant, Francesco Parisi*

1. **CureGraph: Contrastive Multi-Modal Graph Representation Learning for Urban Living Circle Health Profiling and Prediction (Abstract Reprint).**

    *Jinlin Li, Xiao Zhou*

1. **GE-Chat: A Graph Enhanced RAG Framework for Evidential Response Generation of LLMs.**

    *Longchao Da, Parth Mitesh Shah, Kuanru Liou, Jiaxing Zhang, Hua Wei*
...
1. **Going Deeper into Locally Differentially Private Graph Neural Networks.**

    *Longzhu He, Chaozhuo Li, Peng Tang, Sen Su*

1. **Equivalence is All: A Unified View for Self-supervised Graph Learning.**

    *Yejiang Wang, Yuhai Zhao, Zhengkui Wang, Ling Li, Jiapu Wang, Fangting Li, Miaomiao Huang, Shirui Pan, Xingwei Wang*

1. **AutoGFM: Automated Graph Foundation Model with Adaptive Architecture Customization.**

    *Haibo Chen, Xin Wang, Zeyang Zhang, Haoyang Li, Ling Feng, Wenwu Zhu*

1. **G-Adaptivity: optimised graph-based mesh relocation for finite element methods.**

    *James Rowbottom, Georg Maierhofer, Teo Deveney, Eike Hermann Müller, Alberto Paganini, Katharina Schratz, Pietro Lio, Carola-Bibiane Schönlieb, Chris J. Budd*

1. **Signed Laplacians for Constrained Graph Clustering.**

    *John Stewart Fabila-Carrasco, He Sun*

1. **Self-supervised Masked Graph Autoencoder via Structure-aware Curriculum.**

    *Haoyang Li, Xin Wang, Zeyang Zhang, Zongyuan Wu, Linxin Xiao, Wenwu Zhu*

1. **Rethink GraphODE Generalization within Coupled Dynamical System.**

    *Guancheng Wan, Zijie Huang, Wanjia Zhao, Xiao Luo, Yizhou Sun, Wei Wang*

1. **Counterfactual Graphical Models: Constraints and Inference.**

    *Juan D. Correa, Elias Bareinboim*

1. **Efficient and Separate Authentication Image Steganography Network.**

    *Junchao Zhou, Yao Lu, Jie Wen, Guangming Lu*

1. **Visual and Domain Knowledge for Professional-level Graph-of-Thought Medical Reasoning.**

    *Rina Bao, Shilong Dong, Zhenfang Chen, Sheng He, Ellen Grant, Yangming Ou*

1. **Graph Adaptive Autoregressive Moving Average Models.**

    *Moshe Eliasof, Alessio Gravina, Andrea Ceni, Claudio Gallicchio, Davide Bacciu, Carola-Bibiane Schönlieb*

1. **Nonparametric Teaching for Graph Property Learners.**
...
1. **Graph Diffusion for Robust Multi-Agent Coordination.**
...
1. **Instance Correlation Graph-based Naive Bayes.**

    *Chengyuan Li, Liangxiao Jiang, Wenjun Zhang, Liangjun Yu, Huan Zhang*

1. **Covered Forest: Fine-grained generalization analysis of graph neural networks.**
...
1. **GPEN: Global Position Encoding Network for Enhanced Subgraph Representation Learning.**

    *Nannan Wu, Yuming Huang, Yiming Zhao, Jie Chen, Wenjun Wang*

1. **Uncertainty Estimation for Heterophilic Graphs Through the Lens of Information Theory.**

    *Dominik Fuchsgruber, Tom Wollschläger, Johannes Bordne, Stephan Günnemann*

1. **Hyperbolic-PDE GNN: Spectral Graph Neural Networks in the Perspective of A System of Hyperbolic Partial Differential Equations.**

    *Juwei Yue, Haikuo Li, Jiawei Sheng, Xiaodong Li, Taoyu Su, Tingwen Liu, Li Guo*

1. **Fine-Grained Captioning of Long Videos through Scene Graph Consolidation.**

    *Sanghyeok Chu, Seonguk Seo, Bohyung Han*

1. **Learning Initial Basis Selection for Linear Programming via Duality-Inspired Tripartite Graph Representation and Comprehensive Supervision.**

    *Anqi Lu, Junchi Yan*

1. **HYGMA: Hypergraph Coordination Networks with Dynamic Grouping for Multi-Agent Reinforcement Learning.**

    *Chiqiang Liu, Dazi Li*

1. **Unifying Knowledge from Diverse Datasets to Enhance Spatial-Temporal Modeling: A Granularity-Adaptive Geographical Embedding Approach.**

    *Zhigaoyuan Wang, Ying Sun, Hengshu Zhu*

1. **Learning Condensed Graph via Differentiable Atom Mapping for Reaction Yield Prediction.**
...
1. **ELoRA: Low-Rank Adaptation for Equivariant GNNs.**

    *Chen Wang, Siyu Hu, Guangming Tan, Weile Jia*

1. **Delay-DSGN: A Dynamic Spiking Graph Neural Network with Delay Mechanisms for Evolving Graph.**

    *Zhiqiang Wang, Jianghao Wen, Jianqing Liang*

1. **Pretraining Generative Flow Networks with Inexpensive Rewards for Molecular Graph Generation.**

    *Mohit Pandey, Gopeshh Subbaraj, Artem Cherkasov, Martin Ester, Emmanuel Bengio*

1. **Generalization Principles for Inference over Text-Attributed Graphs with Large Language Models.**

    *Haoyu Peter Wang, Shikun Liu, Rongzhe Wei, Pan Li*

1. **Implicit Subgraph Neural Network.**

    *Yongjian Zhong, Liao Zhu, Hieu Vu, Bijaya Adhikari*

1. **CSG-ODE: ControlSynth Graph ODE For Modeling Complex Evolution of Dynamic Graphs.**
...
1. **Graph-Based Algorithms for Diverse Similarity Search.**

    *Piyush Anand, Piotr Indyk, Ravishankar Krishnaswamy, Sepideh Mahabadi, Vikas C. Raykar, Kirankumar Shiragur, Haike Xu*

1. **Test-Time Graph Neural Dataset Search With Generative Projection.**

    *Xin Zheng, Wei Huang, Chuan Zhou, Ming Li, Shirui Pan*

1. **Boosting Protein Graph Representations through Static-Dynamic Fusion.**

    *Pengkang Guo, Bruno E. Correia, Pierre Vandergheynst, Daniel Probst*

1. **Zero-Shot Generalization of GNNs over Distinct Attribute Domains.**

    *Yangyi Shen, Jincheng Zhou, Beatrice Bevilacqua, Joshua Robinson, Charilaos I. Kanatsoulis, Jure Leskovec, Bruno Ribeiro*
...
1. **On Explaining Equivariant Graph Networks via Improved Relevance Propagation.**

    *Hongyi Ling, Haiyang Yu, Zhimeng Jiang, Na Zou, Shuiwang Ji*

1. **Hierarchical Planning for Complex Tasks with Knowledge Graph-RAG and Symbolic Verification.**

    *Flavio Petruzzellis, Cristina Cornelio, Pietro Lio*

1. **Simple Path Structural Encoding for Graph Transformers.**
...
1. **Visual Graph Arena: Evaluating Visual Conceptualization of Vision and Multimodal Large Language Models.**

    *Zahra Babaiee, Peyman M. Kiasari, Daniela Rus, Radu Grosu*

1. **Learning-Order Autoregressive Models with Application to Molecular Graph Generation.**
...
1. **Propagate and Inject: Revisiting Propagation-Based Feature Imputation for Graphs with Partially Observed Features.**

    *Daeho Um, Sunoh Kim, Jiwoong Park, Jongin Lim, Seong-Jin Ahn, Seulki Park*

1. **Graph Neural Network Generalization With Gaussian Mixture Model Based Augmentation.**
...
1. **What Makes a Good Feedforward Computational Graph?**
    ...
    *Alex Vitvitskyi, João Guilherme Madeira Araújo, Marc Lackenby, Petar Velickovic*
...
1. **Online Sparsification of Bipartite-Like Clusters in Graphs.**
...
1. **Redundancy Undermines the Trustworthiness of Self-Interpretable GNNs.**

    *Wenxin Tai, Ting Zhong, Goce Trajcevski, Fan Zhou*

1. **ML2-GCL: Manifold Learning Inspired Lightweight Graph Contrastive Learning.**

    *Jianqing Liang, Zhiqiang Li, Xinkai Wei, Yuan Liu, Zhiqiang Wang*

1. **Stability and Generalization Capability of Subgraph Reasoning Models for Inductive Knowledge Graph Completion.**
...
1. **iN2V: Bringing Transductive Node Embeddings to Inductive Graphs.**

    *Nicolas Lell, Ansgar Scherp*

1. **Breaking the n1.5 Additive Error Barrier for Private and Efficient Graph Sparsification via Private Expander Decomposition.**

    *Anders Aamand, Justin Y. Chen, Mina Dalirrooyfard, Slobodan Mitrovic, Yuriy Nevmyvaka, Sandeep Silwal, Yinzhan Xu*

1. **SDMG: Smoothing Your Diffusion Models for Powerful Graph Representation Learning.**

    *Junyou Zhu, Langzhou He, Chao Gao, Dongpeng Hou, Zhen Su, Philip S. Yu, Jürgen Kurths, Frank Hellmann*

1. **Learning Latent Graph Structures and their Uncertainty.**

    *Alessandro Manenti, Daniele Zambon, Cesare Alippi*

1. **Multi-Domain Graph Foundation Models: Robust Knowledge Transfer via Topology Alignment.**

    *Shuo Wang, Bokui Wang, Zhixiang Shen, Boyan Deng, Zhao Kang*

1. **N2GON: Neural Networks for Graph-of-Net with Position Awareness.**

    *Yejiang Wang, Yuhai Zhao, Zhengkui Wang, Wen Shan, Ling Li, Qian Li, Miaomiao Huang, Meixia Wang, Shirui Pan, Xingwei Wang*

1. **Topology-Aware Dynamic Reweighting for Distribution Shifts on Graph.**

    *Weihuang Zheng, Jiashuo Liu, Jiaxing Li, Jiayun Wu, Peng Cui, Youyong Kong*

1. **HyperIMTS: Hypergraph Neural Network for Irregular Multivariate Time Series Forecasting.**

    *Boyuan Li, Yicheng Luo, Zhen Liu, Junhao Zheng, Jianming Lv, Qianli Ma*

1. **Sort Before You Prune: Improved Worst-Case Guarantees of the DiskANN Family of Graphs.**

    *Siddharth Gollapudi, Ravishankar Krishnaswamy, Kirankumar Shiragur, Harsh Wardhan*

1. **From Theory to Practice: Rethinking Green and Martin Kernels for Unleashing Graph Transformers.**
...
1. **An Efficient Search-and-Score Algorithm for Ancestral Graphs using Multivariate Information Scores for Complex Non-linear and Categorical Data.**

    *Nikita Lagrange, Hervé Isambert*

1. **Scalable Sobolev IPM for Probability Measures on a Graph.**

    *Tam Le, Truyen Nguyen, Hideitsu Hino, Kenji Fukumizu*

1. **No Metric to Rule Them All: Toward Principled Evaluations of Graph-Learning Datasets.**

    *Corinna Coupette, Jeremy Wayland, Emily Simons, Bastian Rieck*

1. **Learning Mean Field Control on Sparse Graphs.**

    *Christian Fabian, Kai Cui, Heinz Koeppl*

1. **Physics-Informed DeepONets for drift-diffusion on metric graphs: simulation and parameter identification.**

    *Jan Blechschmidt, Tom-Christian Riemer, Max Winkler, Martin Stoll, Jan-Frederik Pietschmann*

1. **MDDM: Practical Message-Driven Generative Image Steganography Based on Diffusion Models.**

    *Zihao Xu, Dawei Xu, Zihan Li, Chuan Zhang*

1. **EAGLES: Towards Effective, Efficient, and Economical Federated Graph Learning via Unified Sparsification.**

    *Zitong Shi, Guancheng Wan, Wenke Huang, Guibin Zhang, He Li, Carl Yang, Mang Ye*

1. **Structure Is All You Need: Structural Representation Learning on Hyper-Relational Knowledge Graphs.**
...
1. **TANGO: Clustering with Typicality-Aware Nonlocal Mode-Seeking and Graph-Cut Optimization.**

    *Haowen Ma, Zhiguo Long, Hua Meng*

1. **FDGen: A Fairness-Aware Graph Generation Model.**
...
1. **The Generalized Skew Spectrum of Graphs.**

    *Armando Bellante, Martin Plávala, Alessandro Luongo*

1. **Outlier-Aware Post-Training Quantization for Discrete Graph Diffusion Models.**

    *Zheng Gong, Ying Sun*

1. **Multi-objective Linear Reinforcement Learning with Lexicographic Rewards.**

    *Bo Xue, Dake Bu, Ji Cheng, Yuanyu Wan, Qingfu Zhang*

1. **Smooth Interpolation for Improved Discrete Graph Generative Models.**

    *Yuxuan Song, Juntong Shi, Jingjing Gong, Minkai Xu, Stefano Ermon, Hao Zhou, Wei-Ying Ma*

1. **Code-Generated Graph Representations Using Multiple LLM Agents for Material Properties Prediction.**

    *Jiao Huang, Qianli Xing, Jinglong Ji, Bo Yang*

1. **SPHINX: Structural Prediction using Hypergraph Inference Network.**

    *Iulia Duta, Pietro Lio*

1. **Positional Encoding meets Persistent Homology on Graphs.**

    *Yogesh Verma, Amauri H. Souza, Vikas K. Garg*

1. **Less is More: Federated Graph Learning with Alleviating Topology Heterogeneity from A Causal Perspective.**

    *Lele Fu, Bowen Deng, Sheng Huang, Tianchi Liao, Shirui Pan, Chuan Chen*

1. **A General Graph Spectral Wavelet Convolution via Chebyshev Order Decomposition.**

    *Nian Liu, Xiaoxin He, Thomas Laurent, Francesco Di Giovanni, Michael M. Bronstein, Xavier Bresson*

1. **Discovering Latent Causal Graphs from Spatiotemporal Data.**

    *Kun Wang, Sumanth Varambally, Duncan Watson-Parris, Yian Ma, Rose Yu*

1. **The Best of Both Worlds: Bridging Quality and Diversity in Data Selection with Bipartite Graph.**

    *Minghao Wu, Thuy-Trang Vu, Lizhen Qu, Gholamreza Haffari*

1. **Decomposition of Graphic Design with Unified Multimodal Model.**
...
1. **A Dynamical Systems-Inspired Pruning Strategy for Addressing Oversmoothing in Graph Attention Networks.**

    *Biswadeep Chakraborty, Harshit Kumar, Saibal Mukhopadhyay*

1. **HGOT: Self-supervised Heterogeneous Graph Neural Network with Optimal Transport.**

    *Yanbei Liu, Chongxu Wang, Zhitao Xiao, Lei Geng, Yanwei Pang, Xiao Wang*

1. **Pruning for GNNs: Lower Complexity with Comparable Expressiveness.**

    *Dun Ma, Jianguo Chen, Wenguo Yang, Suixiang Gao, Shengminjie Chen*

1. **Expressive Power of Graph Neural Networks for (Mixed-Integer) Quadratic Programs.**

    *Ziang Chen, Xiaohan Chen, Jialin Liu, Xinshang Wang, Wotao Yin*

1. **Directed Graph Grammars for Sequence-based Learning.**

    *Michael Sun, Orion Foo, Gang Liu, Wojciech Matusik, Jie Chen*

1. **Foundation Molecular Grammar: Multi-Modal Foundation Models Induce Interpretable Molecular Graph Languages.**

    *Michael Sun, Weize Yuan, Gang Liu, Wojciech Matusik, Jie Chen*

1. **Haste Makes Waste: A Simple Approach for Scaling Graph Neural Networks.**

    *Rui Xue, Tong Zhao, Neil Shah, Xiaorui Liu*

1. **Graph4MM: Weaving Multimodal Learning with Structural Information.**

    *Xuying Ning, Dongqi Fu, Tianxin Wei, Wujiang Xu, Jingrui He*

1. **Federated Node-Level Clustering Network with Cross-Subgraph Link Mending.**

    *Jingxin Liu, Renda Han, Wenxuan Tu, Haotian Wang, Junlong Wu, Jieren Cheng*

1. **CoDy: Counterfactual Explainers for Dynamic Graphs.**

    *Zhan Qu, Daniel Gomm, Michael Färber*

1. **Hi-Patch: Hierarchical Patch GNN for Irregular Multivariate Time Series.**

    *Yicheng Luo, Bowen Zhang, Zhen Liu, Qianli Ma*

1. **SHARP-Distill: A 68× Faster Recommender System with Hypergraph Neural Networks and Language Models.**

    *Saman Forouzandeh, Parham Moradi, Mahdi Jalili*

1. **Graph-constrained Reasoning: Faithful Reasoning on Knowledge Graphs with Large Language Models.**
...
1. **MASS: Mathematical Data Selection via Skill Graphs for Pretraining Large Language Models.**

    *Jiazheng Li, Lu Yu, Qing Cui, Zhiqiang Zhang, Jun Zhou, Yanfang Ye, Chuxu Zhang*

1. **Diss-l-ECT: Dissecting Graph Data with Local Euler Characteristic Transforms.**

    *Julius von Rohrscheidt, Bastian Rieck*

1. **Towards Graph Foundation Models: Learning Generalities Across Graphs via Task-Trees.**
...
1. **Improving Soft Unification with Knowledge Graph Embedding Methods.**

    *Xuanming Cui, Chionh Wei Peng, Adriel Kuek, Ser-Nam Lim*

1. **Best of Both Worlds: Advantages of Hybrid Graph Sequence Models.**

    *Ali Behrouz, Ali Parviz, Mahdi Karami, Clayton Sanford, Bryan Perozzi, Vahab Mirrokni*

1. **MemFreezing: A Novel Adversarial Attack on Temporal Graph Neural Networks under Limited Future Knowledge.**

    *Yue Dai, Liang Liu, Xulong Tang, Youtao Zhang, Jun Yang*

1. **A Manifold Perspective on the Statistical Generalization of Graph Neural Networks.**

    *Zhiyang Wang, Juan Cerviño, Alejandro Ribeiro*

1. **GRAIL: Graph Edit Distance and Node Alignment using LLM-Generated Code.**

    *Samidha Verma, Arushi Goyal, Ananya Mathur, Ankit Anand, Sayan Ranu*

1. **Simple and Critical Iterative Denoising: A Recasting of Discrete Diffusion in Graph Generation.**

    *Yoann Boget*

1. **ROS: A GNN-based Relax-Optimize-and-Sample Framework for Max-k-Cut Problems.**
...
1. **Graph Inverse Style Transfer for Counterfactual Explainability.**
...
1. **Improved Expressivity of Hypergraph Neural Networks through High-Dimensional Generalized Weisfeiler-Leman Algorithms.**
...
1. **Learning Changes in Graphon Attachment Network Models.**

    *Xinyuan Fan, Bufan Li, Chenlei Leng, Weichi Wu*

1. **Unifews: You Need Fewer Operations for Efficient Graph Neural Networks.**

    *Ningyi Liao, Zihao Yu, Ruixiao Zeng, Siqiang Luo*

1. **Towards Understanding Parametric Generalized Category Discovery on Graphs.**

    *Bowen Deng, Lele Fu, Jialong Chen, Sheng Huang, Tianchi Liao, Zhang Tao, Chuan Chen*

1. **Reaction Graph: Towards Reaction-Level Modeling for Chemical Reactions with 3D Structures.**

    *Yingzhao Jian, Yue Zhang, Ying Wei, Hehe Fan, Yi Yang*

1. **Graph Attention is Not Always Beneficial: A Theoretical Analysis of Graph Attention Mechanisms via Contextual Stochastic Block Models.**

    *Zhongtian Ma, Qiaosheng Zhang, Bocheng Zhou, Yexin Zhang, Shuyue Hu, Zhen Wang*

1. **Primphormer: Efficient Graph Transformers with Primal Representations.**

    *Mingzhen He, Ruikai Yang, Hanling Tian, Youmei Qiu, Xiaolin Huang*

1. **FicGCN: Unveiling the Homomorphic Encryption Efficiency from Irregular Graph Convolutional Networks.**

    *Zhaoxuan Kan, Husheng Han, Shangyi Shi, Tenghui Hua, Hang Lu, Xiaowei Li, Jianan Mu, Xing Hu*

1. **Commute Graph Neural Networks.**

    *Wei Zhuo, Han Yu, Guang Tan, Xiaoxiao Li*

1. **Sparse Causal Discovery with Generative Intervention for Unsupervised Graph Domain Adaptation.**

    *Junyu Luo, Yuhao Tang, Yiwei Fu, Xiao Luo, Zhizhuo Kou, Zhiping Xiao, Wei Ju, Wentao Zhang, Ming Zhang*

1. **A Selective Learning Method for Temporal Graph Continual Learning.**
...
1. **Meta Optimality for Demographic Parity Constrained Regression via Post-Processing.**

    *Kazuto Fukuchi*

1. **Disentangled Graph Spectral Domain Adaptation.**

    *Liang Yang, Xin Chen, Jiaming Zhuo, Di Jin, Chuan Wang, Xiaochun Cao, Zhen Wang, Yuanfang Guo*

1. **Beyond Message Passing: Neural Graph Pattern Machine.**

    *Zehong Wang, Zheyuan Zhang, Tianyi Ma, Nitesh V. Chawla, Chuxu Zhang, Yanfang Ye*

1. **EduLLM: Leveraging Large Language Models and Framelet-Based Signed Hypergraph Neural Networks for Student Performance Prediction.**

    *Ming Li, Yukang Cheng, Lu Bai, Feilong Cao, Ke Lv, Jiye Liang, Pietro Lio*

1. **De-coupled NeuroGF for Shortest Path Distance Approximations on Large Terrain Graphs.**

    *Samantha Chen, Pankaj K. Agarwal, Yusu Wang*

1. **How Expressive are Knowledge Graph Foundation Models?**

    *Xingyue Huang, Pablo Barceló, Michael M. Bronstein, Ismail Ilkan Ceylan, Mikhail Galkin, Juan L. Reutter, Miguel A. Romero Orth*

1. **Supercharging Graph Transformers with Advective Diffusion.**

    *Qitian Wu, Chenxiao Yang, Kaipeng Zeng, Michael M. Bronstein*

1. **EARTH: Epidemiology-Aware Neural ODE with Continuous Disease Transmission Graph.**

    *Guancheng Wan, Zewen Liu, Xiaojun Shan, Max S. Y. Lau, B. Aditya Prakash, Wei Jin*

1. **GraphGPT: Generative Pre-trained Graph Eulerian Transformer.**

    *Qifang Zhao, Weidong Ren, Tianyu Li, Hong Liu, Xingsheng He, Xiaoxiao Xu*

1. **HetSSNet: Spatial-Spectral Heterogeneous Graph Learning Network for Panchromatic and Multispectral Images Fusion.**

    *Mengting Ma, Yizhen Jiang, Mengjiao Zhao, Jiaxin Li, Wei Zhang*

1. **Enhancing Graph Invariant Learning from a Negative Inference Perspective.**

    *Kuo Yang, Zhengyang Zhou, Qihe Huang, Wenjie Du, Limin Li, Wu Jiang, Yang Wang*

1. **GrokFormer: Graph Fourier Kolmogorov-Arnold Transformers.**

    *GuoguoAi, Guansong Pang, Hezhe Qiao, Yuan Gao, Hui Yan*

1. **Curvature-aware Graph Attention for PDEs on Manifolds.**

    *Yunfeng Liao, Jiawen Guan, Xiucheng Li*

1. **PieClam: A Universal Graph Autoencoder Based on Overlapping Inclusive and Exclusive Communities.**

    *Daniel Zilberg, Ron Levie*

1. **A Generic Family of Graphical Models: Diversity, Efficiency, and Heterogeneity.**

    *Yufei Huang, Changhu Wang, Junjie Tang, Weichi Wu, Ruibin Xi*

1. **AnalogGenie-Lite: Enhancing Scalability and Precision in Circuit Topology Discovery through Lightweight Graph Modeling.**

    *Jian Gao, Weidong Cao, Xuan Zhang*

1. **Adapting Precomputed Features for Efficient Graph Condensation.**

    *Yuan Li, Jun Hu, Zemin Liu, Bryan Hooi, Jia Chen, Bingsheng He*

1. **Balancing Efficiency and Expressiveness: Subgraph GNNs with Walk-Based Centrality.**
...
1. **Multi-View Graph Clustering via Node-Guided Contrastive Encoding.**

    *Yazhou Ren, Junlong Ke, Zichen Wen, Tianyi Wu, Yang Yang, Xiaorong Pu, Lifang He*

1. **Enhancing Graph Contrastive Learning for Protein Graphs from Perspective of Invariance.**

    *Yusong Wang, Shiyin Tan, Jialun Shen, Yicheng Xu, Haobo Song, Qi Xu, Prayag Tiwari, Mingkun Xu*

1. **ENAHPool: The Edge-Node Attention-based Hierarchical Pooling for Graph Neural Networks.**

    *Zhehan Zhao, Lu Bai, Lixin Cui, Ming Li, Ziyu Lyu, Lixiang Xu, Yue Wang, Edwin R. Hancock*

1. **GHOST: Generalizable One-Shot Federated Graph Learning with Proxy-Based Topology Knowledge Retention.**
...
1. **GraphCL: Graph-based Clustering for Semi-Supervised Medical Image Segmentation.**

    *Mengzhu Wang, Houcheng Su, Jiao Li, Chuan Li, Nan Yin, Li Shen, Jingcai Guo*

1. **COMRECGC: Global Graph Counterfactual Explainer through Common Recourse.**

    *Gregoire Fournier, Sourav Medya*

1. **Learn Beneficial Noise as Graph Augmentation.**

    *Siqi Huang, Yanchen Xu, Hongyuan Zhang, Xuelong Li*

1. **Geometric Generative Modeling with Noise-Conditioned Graph Networks.**

    *Peter Pao-Huang, Mitchell Black, Xiaojie Qiu*

1. **Machines and Mathematical Mutations: Using GNNs to Characterize Quiver Mutation Classes.**

    *Jesse He, Helen Jenne, Herman Chau, Davis Brown, Mark Raugas, Sara C. Billey, Henry Kvinge*

1. **Hierarchical Graph Tokenization for Molecule-Language Alignment.**

    *Yongqiang Chen, Quanming Yao, Juzheng Zhang, James Cheng, Yatao Bian*

1. **Enhancing Spectral GNNs: From Topology and Perturbation Perspectives.**

    *Taoyang Qin, Ke-Jia Chen, Zheng Liu*

1. **Hierarchical Overlapping Clustering on Graphs: Cost Function, Algorithm and Scalability.**

    *Yicheng Pan, Renjie Chen, Pengyu Long, Bingchen Fan*

1. **Mitigating Over-Squashing in Graph Neural Networks by Spectrum-Preserving Sparsification.**

    *Langzhang Liang, Fanchen Bu, Zixing Song, Zenglin Xu, Shirui Pan, Kijung Shin*

1. **Adversarial Robust Generalization of Graph Neural Networks.**
...
1. **Depth-Adaptive Graph Neural Networks via Learnable Bakry-Émery Curvature.**
...
1. **Feature Reconstruction for Anomaly Detection on Directed Multigraphs: A Preprocessing Framework for GNNs.**
    ...
    *Sicheng Liang, Qinlin Xie, Jingqi Feng, Yiwen Yue, Hongyi Li, Jiawei Ye, Jie Wu*
...
1. **MoDiff - Graph Generation with Motif-aware Diffusion Model.**
...
1. **Hi-PNG:  Efficient Interval-Filtering ANNS via Hierarchical Interval Partition Navigating Graph.**
...
1. **Training Industry-scale GNNs with GiGL.**

    *Yozen Liu, Tong Zhao, Matthew Kolodner, Kyle Montemayor, Shubham Vij, Neil Shah*

1. **Temporal Graph Learning Workshop.**
...
1. **FedKDD 2025: The 2025 International Joint Workshop on Federated Learning for Data Mining and Graph Analytics.**

    *Carl Yang, Guancheng Wan, Zhuangdi Zhu, Zheng Xu, Junyuan Hong, Nathalie Baracaldo, Neil Shah, Salman Avestimehr, Jiayu Zhou*
...
1. **Correlation-Aware Graph Convolutional Networks for Multi-Label Node Classification.**
    ...
    *Yuanchen Bei, Weizhi Chen, Hao Chen, Sheng Zhou, Carl Ji Yang, Jiapei Fan, Longtao Huang, Jiajun Bu*
...
1. **How to use Graph Data in the Wild to Help Graph Anomaly Detection?**
    ...
    *Yuxuan Cao, Jiarong Xu, Chen Zhao, Jiaan Wang, Carl Ji Yang, Chunping Wang, Yang Yang*

1. **Probabilistic Hypergraph Recurrent Neural Networks for Time-series Forecasting.**
...
1. **Understanding Team Collapse via Probabilistic Graphical Models.**
...
1. **SepsisCalc: Integrating Clinical Calculators into Early Sepsis Prediction via Dynamic Temporal Graph Construction.**
    ...
    *Changchang Yin, Shihan Fu, Bingsheng Yao, Thai-Hoang Pham, Weidan Cao, Dakuo Wang, Jeffrey M. Caterino, Ping Zhang*

1. **Instruction Semantics Enhanced Dual-Flow Graph Model for GPU Error Resilience Prediction.**
...
1. **EvenOddML: Even and Odd Aggregation with Multi-Level Contrastive Learning for Bipartite Graph.**

    *Manasvi Aggarwal, Jahnavi Methukumalli, Deepanshu Bagotia, Suhas Powar*
...
1. **Relation-Faceted Graph Pooling with LLM Guidance for Dynamic Span-Aware Information Extraction.**

    *Hye-Yoon Baek, Jinho Choi, Jimyeung Seo, Xiongnan Jin, Dongcheon Lee, Byungkook Oh*

1. **Dynamic Graph Learning via Historical Information Perception and Multi-Granular Temporal Curriculum Learning.**

    *Yuehang Cao, Xiang Zhao, Yang Fang, Yan Pan, Jiuyang Tang*

1. **Structure-prior Informed Diffusion Model for Graph Source Localization with Limited Data.**

    *Hongyi Chen, Jingtao Ding, Xiaojun Liang, Yong Li, Xiao-Ping Zhang*

1. **Adaptive Heterogeneous Graph Neural Networks: Bridging Heterophily and Heterogeneity.**

    *Qin Chen, Guojie Song*

1. **NR-GCF: Graph Collaborative Filtering with Improved Noise Resistance.**

    *Yijun Chen, Bohan Li, Yicong Li, Lixiang Song, Haofen Wang, Wenlong Wu, Junnan Zhuo, Hongzhi Yin*

1. **Rethinking Client-oriented Federated Graph Learning.**

    *Zekai Chen, Xunkai Li, Yinlin Zhu, Rong-Hua Li, Guoren Wang*

1. **FROG: Fair Removal on Graph.**

    *Ziheng Chen, Jiali Cheng, Hadi Amiri, Kaushiki Nag, Lu Lin, Sijia Liu, Gabriele Tolomei, Xiangguo Sun*

1. **Evolving Graph-Based Context Modeling for Multi-Turn Conversational Retrieval-Augmented Generation.**

    *Yiruo Cheng, Hongjin Qian, Fengran Mo, Yongkang Wu, Zhonghua Li, Qi Ye, Ji-Rong Wen, Zhicheng Dou*

1. **FedGVD: Efficient Federated Graph Learning via Unidirectional Distillation with Dynamic Virtual Nodes.**

    *Zhehao Dai, Guojiang Shen, Yuyue Hu, Jiaxin Du, Xiao Han, Xiangjie Kong*

1. **LLM-Enhanced Generalized Category Discovery via Iterative Graph Diffusion.**

    *Kangjia Fan, Yilong Zhao, Daifeng Li, Changze Lin, Weijun Zhang, Zhiwen Zhong*

1. **PathLens: Structurally Enhancing Heterophilic Graphs for GNNs.**
...
1. **Improving the Safety of Medication Recommendation via Graph Augmented Patient Similarity Network.**

    *Ming He, Yongjie Zheng, Changle Li, Man Zhou*

1. **LinkGPT: Leveraging Large Language Models for Enhanced Link Prediction in Text-Attributed Graphs.**

    *Zhongmou He, Jing Zhu, Shengyi Qian, Joyce Chai, Danai Koutra*

1. **Model-Agonistic Iterative Graph Diversification for Improving Learning to Solve Graph Optimization Problems.**

    *Bay-Yuan Hsu, Chia-Hsun Lu, Chih-Ya Shen*

1. **GRIT: An Accurate and Efficient Graph Stream Summarization for Temporal Query.**

    *Jingxian Hu, Guozhang Sun, Xin Wang, Yuhai Zhao, Yuan Li, Xingwei Wang*

1. **Geometric Heterogeneous Graph Neural Network for Protein-Ligand Binding Affinity Prediction.**

    *Feng Huang, Yuhang Xia, Ziyan Wang, Liuqing Yang, Wen Zhang*

1. **Leveraging Vulnerabilities in Temporal Graph Neural Networks via Strategic High-Impact Assaults.**

    *Donghyun Jeon, Lijing Zhu, Haifang Li, Pengze Li, Jingna Feng, Tiehang Duan, Houbing Herbert Song, Cui Tao, Shuteng Niu*

1. **From Anchors to Answers: A Novel Node Tokenizer for Integrating Graph Structure into Large Language Models.**

    *Yanbiao Ji, Chang Liu, Xin Chen, Dan Luo, Mei Li, Yue Ding, Wenqing Lin, Hongtao Lu*

1. **Enhancing Information Diffusion Prediction via Multiple Granularity Hypergraphs and Position-aware Sequence Model.**

    *Weikai Jing, Yuchen Wang, Haotong Du, Songxin Wang, Xiaoyu Li, Chao Gao*

1. **Curriculum Guided Personalized Subgraph Federated Learning.**

    *Minku Kang, Hogun Park*

1. **Leveraging Multi-facet Paths for Heterogeneous Graph Representation Learning.**

    *Jongwoo Kim, SeongYeub Chu, Hyeongmin Park, Bryan Wong, Keejun Han, Mun Yong Yi*

1. **D-HAT: Dynamic Hypergraph Representation Learning with Attention-Based Multi-Level Hypergraph Sampling.**

    *Ah-Hyun Lee, Gordon Euhyun Moon*

1. **Learning Graph Edit Distance via Node Matching Patterns.**

    *Junkyu Lee, Jongik Kim*

1. **A Node-Aware Dynamic Quantization Approach for Graph Collaborative Filtering.**

    *Lin Li, Chunyang Li, Yu Yin, Xiaohui Tao, Jianwei Zhang*

1. **Ensemble Pruning via Graph Neural Networks.**

    *Yuanke Li, Yiyang Liu, Dongmian Zou, Hongfei Wang*

1. **Differentiable Probabilistic Logic Reasoning For Knowledge Graph Completion.**

    *Zhongbin Li, Lixing Yu, Kun Yue, Xinquan Wu*

1. **ConGM: Contrastive Graph Matching for Graph Self-Supervised Learning.**

    *Hongxiang Lin, Lei Wang, Huiying Hu, Xiaoqing Lyu*

1. **Masked Graph Distance Network for Accurate Subgraph Similarity Computation.**

    *Xijuan Liu, Yin Chen, Fan Li, Xiaoyang Wang, Haiyang Hu, Ying Zhang*
...
1. **Collaborative Interest Mining Network for Knowledge Graph-based Recommendation.**

    *Jie Luo, Ying Pan, Guoliang Huang*

1. **FinD3: A Dual 3D State Space Model with Dynamic Hypergraph for Financial Stock Prediction.**

    *Jieyuan Mei, Jindong Tian, Ronghui Xu, Hanyue Wei, Chenjuan Guo, Bin Yang*

1. **Reverse Chain-of-Thought and Causal Path Verification: A Modular Plugin for Aligning LLMs with Knowledge Graphs.**

    *Dezhuang Miao, Yibin Du, Xiang Li, Xiaoming Zhang, Jiahe Li, Bo Zhang, Bingyu Yan, Lian Zhang, Litian Zhang*

1. **PriviRec: Confidential and Decentralized Graph Filtering for Recommender Systems.**

    *Julien Nicolas, César Sabater, Mohamed Maouche, Mark Coates, Sonia Ben Mokhtar*

1. **Disentangling Complex Questions in LLMs via Multi-Hop Dependency Graphs.**

    *Roland Oruche, Alphaeus Dmonte, Vani Seth, Zian Zeng, Yuanxun Zhang, Marcos Zampieri, Prasad Calyam*

1. **Data-centric Prompt Tuning for Dynamic Graphs.**

    *Yufei Peng, Cheng Yang, Zhengjie Fan, Chuan Shi*

1. **GRLND: A Graph Reinforcement Learning Framework for Network Dismantling.**

    *Hongbo Qu, Xu Wang, Yurong Song, Wei Ni, Guo-Ping Jiang, Quan Z. Sheng*
...
1. **Empirical Study of Over-Squashing in GNNs and Causal Estimation of Rewiring Strategies.**

    *Danial Saber, Amirali Salehi-Abari*

1. **STGS: Spatio-temporal Graph Sparsification Using Reinforcement Learning.**

    *Nasrin Shabani, Amin Beheshti, Yuankai Qi, Venus Haghighi, Jin Foo, Jia Wu*

1. **Local Structure-Adaptive Graph Filtering for Collaborative Filtering.**

    *Yijun Sheng, Ximing Chen, Yanyan Liu, Pui Ieng Lei, Zhiguo Gong*

1. **SimFormer: Multilevel Transformer on Learnable Mesh Graphs for Engineering Simulation.**
...
1. **AMBER: Adaptive Meta Balanced Paradigm for Heterogeneous Graph-Based Knowledge Tracing.**

    *Lifan Sun, Zichen Yuan, Ersheng Ni, Weihua Cheng, Xinyuan Song, Linkun Dai, Hongwei Jiang, Sibo Xu, Mengmeng Chen, Yucen Zhuang, Yongxin Ni, Youhua Li*

1. **On the Cross-type Homophily of Heterogeneous Graphs: Understanding and Unleashing.**

    *Zhen Tao, Ziyue Qiao, Chaoqi Chen, Zhengyi Yang, Lun Du, Qingqiang Sun*

1. **STKGNN: Scalable Spatio-Temporal Knowledge Graph Reasoning for Activity Recognition.**

    *Gözde Ayse Tataroglu Özbulak, Yash Raj Shrestha, Jean-Paul Calbimonte*

1. **CoHN: Context-Aware Hawkes Graph Network for Temporal Knowledge Graph Reasoning.**

    *Xiaowei Tian, Xiaoyan Zhang, Xiaofeng Du, Tianbo Lu*

1. **FairAD: Computationally Efficient Fair Graph Clustering via Algebraic Distance.**

    *Minh Phu Vuong, Young-Ju Lee, Iván Ojeda-Ruiz, Chul-Ho Lee*

1. **SPARK: Adaptive Low-Rank Knowledge Graph Modeling in Hybrid Geometric Spaces for Recommendation.**
...
1. **ACMCG: A Cost-effective Active Clustering with Minimal Constraint Graph.**

    *Qiu-Yu Wang, Wen-Bo Xie, Tao Deng, Tian Zou, Xuan-Lin Zhu, Xun Fu, Xin Wang*

1. **GraphRCG: Self-Conditioned Graph Generation.**

    *Song Wang, Zhen Tan, Xinyu Zhao, Tianlong Chen, Huan Liu, Jundong Li*

1. **LCHGNN: Towards Distributed Hypergraph Neural Network Training Based on Communication Graphs with Lightweight Communication Optimization.**

    *Taibo Wang, Yu Gu, Xinning Cui, Zhen Song, Xiaohua Li, Fangfang Li*

1. **MGFSG-EE: A Method based on Multi-grained Fusion and Scene Graph Enhancement for Event Extraction.**

    *Xiaoyu Wang, Tao Sun, Gengchen Liu, Zhi Yang, Jiahui Liu, Zimeng Xu*

1. **Generative Data Augmentation in Graph Contrastive Learning for Recommendation.**

    *Yansong Wang, Qihui Lin, Junjie Huang, Tao Jia*

1. **Towards Reliable GNNs: Adversarial Calibration Learning for Confidence Estimation.**

    *Yilong Wang, Jiahao Zhang, Tianxiang Zhao, Suhang Wang*

1. **Understanding the Embedding Models on Hyper-relational Knowledge Graph.**
...
1. **Bridging Thoughts and Words: Graph-Based Intent-Semantic Joint Learning for Fake News Detection.**

    *Zhengjia Wang, Qiang Sheng, Danding Wang, Beizhe Hu, Juan Cao*

1. **Learning from Graph: Mitigating Label Noise on Graph through Topological Feature Reconstruction.**

    *Zhonghao Wang, Yuanchen Bei, Sheng Zhou, Zhiyao Zhou, Jiapei Fan, Hui Xue, Haishuai Wang, Jiajun Bu*

1. **Exploration and Visualization of a Legal Knowledge Graph: A Human-Centered Approach.**

    *Sabine Wehnert, Pramod Kumar Bontha, Kilian Lüders, Huu Huong Giang Nguyen, Ernesto William De Luca*

1. **CAGCL: A Community-Aware Graph Contrastive Learning Model for Social Bot Detection.**

    *Kaihang Wei, Min Teng, Haotong Du, Songxin Wang, Jinhe Zhao, Chao Gao*

1. **GCLS2: Towards Efficient Community Detection Using Graph Contrastive Learning with Structure Semantics.**
...
1. **Gravity-GNN: Deep Reinforcement Learning Guided Space Gravity-based Graph Neural Network.**

    *Huaming Wu, Lei Tian, Chaogang Tang, Pengfei Jiao, Minxian Xu, Huijun Tang*

1. **FedGC: Contrastive-enhanced Subgraph Federated Learning with Grouping Pseudo-Label.**

    *Keao Xi, Nannan Wu, Yiming Zhao, Wenjun Wang*

1. **GraphIAM: Two-Stage Algorithm for Improving Class-Imbalanced Node Classification on Attribute-Missing Graphs.**
...
1. **Improving Recommendation Fairness via Graph Structure and Representation Augmentation.**

    *Tongxin Xu, Wenqiang Liu, Chenzhong Bin, Cihan Xiao, Zhixin Zeng, Tianlong Gu*

1. **Contrastive Multi-View Graph Hashing.**

    *Yang Xu, Zuliang Yang, Kai Ming Ting*

1. **LGC-CR: Few-shot Knowledge Graph Completion via Local Global Contrastive Learning and LLM-Guided Refinement.**

    *Yiming Xu, Qi Song, Yihan Wang, Wangqiu Zhou, Junli Liang*

1. **Fine-Grained Graph Rationalization.**

    *Zhe Xu, Menghai Pan, Yuzhong Chen, Huiyuan Chen, Yuchen Yan, Mahashweta Das, Hanghang Tong*

1. **TCPN: Temporal Pyramidal Recurrent Network with Contrastive Learning for Temporal Knowledge Graph Reasoning.**

    *Liu Yang, Zixuan Luo, Tingxuan Chen, Zidong Wang, Limin Liu*

1. **Temporal Blocks with Memory Replay for Dynamic Graph Representation Learning.**

    *Zhigang Yu, Hao Yan, Ruochen Liu, Xianghan Wang, Haijun Zhang, Senzhang Wang*

1. **PKGRec: Personal Knowledge Graph Construction and Mining for Federated Recommendation Enhancement.**

    *Haochen Yuan, Yang Zhang, Quan Z. Sheng, Lina Yao, Yipeng Zhou, Xiang He, Zhongjie Wang*

1. **SGPT: Few-Shot Prompt Tuning for Signed Graphs.**

    *Zian Zhai, Qing Sima, Xiaoyang Wang, Wenjie Zhang*

1. **HGAurban: Heterogeneous Graph Autoencoding for Urban Spatial-Temporal Learning.**

    *Qianru Zhang, Xinyi Gao, Haixin Wang, Dong Huang, Siu-Ming Yiu, Hongzhi Yin*

1. **GCoder: Improving Large Language Model for Generalized Graph Reasoning.**

    *Qifan Zhang, Xiaobin Hong, Jianheng Tang, Nuo Chen, Yuhan Li, Wenzhong Li, Jing Tang, Jia Li*

1. **Advancing Graph Isomorphism Tests with Metric Space Indicators: A Tool for Improving Graph Learning Tasks.**

    *Shenghui Zhang, Pak Lon Ip, Rongqin Chen, Shunran Zhang, Leong Hou U*

1. **FEDDGCN: A Frequency-Enhanced Decoupling Dynamic Graph Convolutional Network for Traffic Flow Prediction.**

    *Wendong Zhang, Ruobai Xiang, Zhifang Liao, Peng Lan, Qihao Liang*

1. **TAGA: Text-Attributed Graph Self-Supervised Learning by Synergizing Graph and Text Mutual Transformations.**

    *Zheng Zhang, Yuntong Hu, Bo Pan, Chen Ling, Liang Zhao*

1. **Robust Heterogeneous GNNs via Semantic Attention and Contrastive Learning.**

    *Chongjie Zhao, Jinyan Wang, Linlin Su, Zeming Gan, Ziyang Zhou*

1. **Hybrid2: Distributed GNN Training System Enhanced by Dual-Hybrid for Sampling and Loading.**
...
1. **Modeling Edge-Specific Node Features through Co-Representation Neural Hypergraph Diffusion.**

    *Yijia Zheng, Marcel Worring*

1. **EvoFormer: Learning Dynamic Graph-Level Representations with Structural and Temporal Bias Correction.**

    *Haodi Zhong, Liuxin Zou, Di Wang, Bo Wan, Zhenxing Niu, Quan Wang*

1. **DebiasedKGE: Towards Mitigating Spurious Forgetting in Continual Knowledge Graph Embedding.**

    *Junlin Zhu, Bo Fu, Guiduo Duan*

1. **Relational Multi-Path Enhancement for Extrapolative Relation Reasoning in Temporal Knowledge Graph.**

    *Linlin Zong, Chi Ma, Jiahui Zhou, Xinyue Liu, Wenxin Liang, Xianchao Zhang, Bo Xu*

1. **Improving Graph Autoencoders by Hard Sample Refinement with Global Similarity.**

    *Ge Chen, Yulan Hu, Sheng Ouyang, Cuicui Luo*

1. **DocPolicyKG: A Lightweight LLM-Based Framework for Knowledge Graph Construction from Chinese Policy Documents.**

    *Chen Han, Yuanyuan Li, Xijin Tang*

1. **From Bicliques to BiFlexi Cliques: A New Era of Bipartite Subgraph Discovery.**

    *Taejoon Han, Song Kim, Woungjae Choo, Junghoon Kim*

1. **Assessing Natural Language Explanations of Relational Graph Neural Networks.**

    *Stefan Heindorf, Daniel Neib*

1. **Context-Aware Fine-Grained Graph RAG for Query-Focused Summarization.**

    *Yubin Hong, Chaofan Li, Jingyi Zhang, Yingxia Shao*

1. **An Efficient PIM-Based Graph Engine on a Single Machine.**

    *Myung-Hwan Jang, Min-Kyeong Shin, Taehyeong Park, Yongjun Park, Sang-Wook Kim*

1. **M3-Net: A Cost-Effective Graph-Free MLP-Based Model for Traffic Prediction.**

    *Guangyin Jin, Sicong Lai, Xiaoshuai Hao, Jinlei Zhang, Mingtao Zhang*

1. **When User Engagement Meets Structural Cohesiveness: A Decay-Driven Approach to Hypergraph Cores.**

    *Hyewon Kim, Minseok Kim, Dahee Kim, Junghoon Kim*

1. **RadialFocus: Geometric Graph Transformers via Distance-Modulated Attention.**

    *San Kim, Seungjun Lee, Sichan Oh, Jaekwang Kim*

1. **Spectral Edge Encoding - SEE: Does Structural Information Really Enhance Graph Transformer Performance?**

    *Seungjun Lee, San Kim, Johyeon Kim, Jaekwang Kim*

1. **EI-KGC: A Knowledge Graph Completion Model Based on Fine-Grained Element Interactions.**

    *Dong Li, Lingling Zhang, Yuhang Fan, Jingyou Sun, Xinyu Zhang, Baoyan Song*

1. **Position-Agnostic Probabilistic Generation for Robust Steganographic Text.**

    *Shuo Lin, Zhenyang Shen, Xiang Li, Jiacheng Fan, Sixing Wu*

1. **Few-Shot Knowledge Graph Completion via Transfer Knowledge from Similar Tasks.**

    *Lihui Liu, Zihao Wang, Dawei Zhou, Ruijie Wang, Yuchen Yan, Bo Xiong, Sihong He, Hanghang Tong*

1. **Monte Carlo Tree Search for Graph Reasoning in Large Language Model Agents.**

    *Lihui Liu*

1. **Bridging the Gap between Knowledge Graphs and LLMs for Multi-hop Question Answering.**
...
1. **Solar Forecasting with Causality: A Graph-Transformer Approach to Spatiotemporal Dependencies.**

    *Yanan Niu, Demetri Psaltis, Christophe Moser, Luisa Lambertini*

1. **FairSplit: Mitigating Bias in Graph Neural Networks through Sensitivity-based Edge Partitioning.**

    *Indranil Ojha, Kushal Bose, Swagatam Das*

1. **FnRGNN: Distribution-aware Fairness in Graph Neural Network.**

    *SoYoung Park, Sungsu Lim*

1. **ThoughtForest-KGQA: A Multi-Chain Tree Search for Knowledge Graph Reasoning.**
...
1. **NuFact: Validating Numerical Assertions for Knowledge Graphs.**

    *Mohammad Taufeeq, Koninika Pal*

1. **Densest Subgraph Discovery on Decentralized Graphs with Local Edge Differential Privacy.**

    *Wenping Tong, Yi Zhou, Yanhao Wang, Cen Chen, Minghao Zhao*

1. **Latent Graph Structure Learning for Large-Scale Traffic Forecasting.**

    *Meng Wang, Longgang Xiang, Chenhao Wu, Zejiao Wang, Xin Chen, Shaozu Xie, Ying Luo*

1. **DAGP: Difficulty-Aware Graph Pruning for LLM-Based Multi-Agent System.**

    *Siqi Wang, Guangmo Tong*

1. **Dual Context-Aware Negative Sampling Strategy for Graph-based Collaborative Filtering.**

    *Xi Wu, Wenzhe Zhang, Liangwei Yang, Xiaohan Fang, Jiquan Peng, Jibing Gong*

1. **Exploring the Potential of Pre-Trained Language Models in Long-Term Semantic Scene Change Prediction Using Variable Scene Graphs.**

    *Haoyi Xiu, Xin Liu, Taehoon Kim, Kyoung-Sook Kim*

1. **Enhancing Graph Collaborative Filtering with FourierKAN Feature Transformation.**

    *Jinfeng Xu, Zheyu Chen, Jinze Li, Shuo Yang, Wei Wang, Xiping Hu, Edith C. H. Ngai*

1. **Ultra Fast Warm Start Solution for Graph Recommendations.**

    *Viacheslav Yusupov, Maxim V. Rakhuba, Evgeny Frolov*

1. **SAKG: Structure-Aware Large Language Model Framework for Knowledge Graph Reasoning.**

    *Qingyu Zhang, Min Hu, Wenlong Fei, Jiaoyun Yang, Hongbo Li*

1. **Relation-Sensitive Visual Aggregation Enhances Multimodal Knowledge Graph Completion.**

    *Qingyu Zhang, Min Hu, Wenlong Fei, Jiaoyun Yang, Hongbo Li*

1. **Adversarially Attacking Graph Properties and Sparsification in Graph Learning.**

    *Chunjiang Zhu, Blake Gaines, Jing Deng, Jinbo Bi*

1. **Let Topology Speak: Graph Neural Network with Topology-Aware Augmentation.**
...
1. **NeighSqueeze: Compact Neighborhood Grouping for Efficient Billion-Scale Heterogeneous Graph Learning.**

    *Xinyue Feng, Shuxin Zhong, Jinquan Hang, Yuequn Zhang, Guang Yang, Haotian Wang, Desheng Zhang, Guang Wang*

1. **Cross-Domain Graph Neural Networks for Notification at LinkedIn.**
...
1. **GOProteinGNN: Leveraging Protein Knowledge Graphs for Protein Representation Learning.**

    *Dan Kalifa, Uriel Singer, Kira Radinsky*

1. **Waypoint POI Recommendation for Vehicle Navigation Services using Hierarchical Graphs and Contrastive Learning.**

    *Jongsoo Lee, Heejun Shin, Namhyuk Kim, Dong-Kyu Chae*

1. **Next-Generation Price Recommendation with LLM-Augmented Graph Transformers.**

    *Hadi Mohammadzadeh Abachi, Amin Beheshti, Milad Mosharraf, Pooyan Asgari, Majid Namazi*

1. **HuggingGraph: Understanding the Supply Chain of LLM Ecosystem.**

    *Mohammad Shahedur Rahman, Peng Gao, Yuede Ji*

1. **LinkML for Collaborative Petrochemical Knowledge Graph Development.**

    *Annie Shoup, Adam Russell, Gavin Nicol*

1. **Towards Explainable Transaction Risk Analysis With Dual Graph Retrieval Augmented Generation.**

    *Liang Su, Mingyang Zhang, Kangxiang Jia, Tengfei Liu, Weiqiang Wang, Yun Xiong, Xixi Wu, Xinyu Gao, Yongrui Fu, Jiawei Zhang*

1. **GeoIndia V2: A Unified Graph and Language Model for Context-Aware Geocoding.**

    *Arpit Tiwari, Bhavuk Singhal, Anshu Aditya, Shubham Jain, Debashis Mukherjee, Debdoot Mukherjee*

1. **GCVPN: A Graph Convolutional Visual Prior-Transform Network for Actual Occluded Image Recognition.**

    *Lei Wang, Nannan Wu, Huaming Wu, Wei Yu, Fan Zhang, Shuo Chen*

1. **Edge-Variational Graph Neural Networks: Harnessing Weak Ties for Enhanced Default Risk Prediction.**

    *Feng Zhang, Jianfeng Chi, Rui Ma, Gang Chen, Rongqi Chen*

1. **Billion-Scale Graph Deep Learning Framework for Ads Recommendation.**
...
1. **hopwise: A Python Library for Explainable Recommendation based on Path Reasoning over Knowledge Graphs.**

    *Ludovico Boratto, Gianni Fenu, Mirko Marras, Giacomo Medda, Alessandro Soccol*

1. **STM-Graph: A Python Framework for Spatio-Temporal Mapping and Graph Neural Network Predictions.**

    *Amirhossein Ghaffari, Huong Mai Nguyen, Lauri Lovén, Ekaterina Gilman*

1. **The Yelp Collaborative Knowledge Graph.**

    *Theis E. Jendal, Mads Corfixen, Magnus Olesen, Peter Dolog, Katja Hose, Daniele Dell'Aglio, Matteo Lissandrini*

1. **ECKGBench: Benchmarking Large Language Models in E-commerce Leveraging Knowledge Graph.**

    *Langming Liu, Haibin Chen, Yuhao Wang, Yujin Yuan, Shilei Liu, Wenbo Su, Xiangyu Zhao, Bo Zheng*

1. **GCondenser: Benchmarking Graph Condensation.**

    *Yilun Liu, Ruihong Qiu, Zi Huang*

1. **QueryBridge: One Million Annotated Questions with SPARQL Queries - Dataset for Question Answering over Knowledge Graphs.**

    *Abdelghny Orogat, Ahmed El-Roby*

1. **When Facts Expire: Benchmarking Temporal Validity in Knowledge Graphs.**

    *Thibaut Soulard, Fatiha Saïs, Joe Raad*

1. **HUSK: A Hierarchically Structured Urban Knowledge Graph Dataset for Multi-Level Spatial Tasks.**
...
1. **A Demonstration of PKGem: Secure Enrichment of Personal Knowledge Graphs.**

    *Junzhou Su, Sriram Nutulapati, Chang Ge*

1. **AGENTiGraph: A Multi-Agent Knowledge Graph Framework for Interactive, Domain-Specific LLM Chatbots.**
...
1. **TrustMap: Mapping Truthfulness Stance of Social Media Posts on Factual Claims for Geographical Analysis.**

    *Zhengyuan Zhu, Haiqi Zhang, Zeyu Zhang, Chengkai Li*

1. **Towards Rational Pesticide Design with Graph Machine Learning Models for Ecotoxicology.**

    *Jakub Adamczyk*

1. **Reasoning over Incomplete Knowledge Graphs.**

    *Ola El Khatib*

1. **Graph Neural Network Architecture Search via Hybrid Genetic Algorithm with Parallel Tempering.**

    *Maciej Krzywda*

1. **A Tutorial on Hypergraph Neural Networks: An In-Depth and Step-By-Step Guide.**

    *Sunwoo Kim, Soo Yong Lee, Yue Gao, Alessia Antelmi, Mirko Polato, Kijung Shin*

1. **Retrieval of Graph Structured Objects: Theory and Applications.**

    *Indradyumna Roy, Soumen Chakrabarti, Abir De*

1. **Frontiers in Graph Machine Learning for the Large Model Era.**

    *Qingyun Sun, Ziwei Zhang, Xingcheng Fu, Yangqiu Song, Jianxin Li, Philip S. Yu*
...
### [ICLR-2025](#contents)
1. **TopoLM: brain-like spatio-functional organization in a topographic language model.**

    *Neil Rathi, Johannes Mehrer, Badr AlKhamissi, Taha Osama A Binhuraib, Nicholas M. Blauch, Martin Schrimpf*

1. **Joint Graph Rewiring and Feature Denoising via Spectral Resonance.**

    *Jonas Linkerhägner, Cheng Shi, Ivan Dokmanic*

1. **Homomorphism Expressivity of Spectral Invariant Graph Neural Networks.**

    *Jingchu Gai, Yiheng Du, Bohang Zhang, Haggai Maron, Liwei Wang*

1. **Instant Policy: In-Context Imitation Learning via Graph Diffusion.**

    *Vitalis Vosylius, Edward Johns*

1. **Energy-based Backdoor Defense Against Federated Graph Learning.**

    *Guancheng Wan, Zitong Shi, Wenke Huang, Guibin Zhang, Dacheng Tao, Mang Ye*

1. **Towards a Complete Logical Framework for GNN Expressiveness.**

    *Tuo Xu*

1. **Subgraph Federated Learning for Local Generalization.**

    *Sungwon Kim, Yoonho Lee, Yunhak Oh, Namkyeong Lee, Sukwon Yun, Junseok Lee, Sein Kim, Carl Yang, Chanyoung Park*

1. **On the Hölder Stability of Multiset and Graph Neural Networks.**

    *Yair Davidson, Nadav Dym*

1. **A Theoretically-Principled Sparse, Connected, and Rigid Graph Representation of Molecules.**

    *Shih-Hsin Wang, Yuhao Huang, Justin M. Baker, Yuan-En Sun, Qi Tang, Bao Wang*

1. **Robustness Inspired Graph Backdoor Defense.**

    *Zhiwei Zhang, Minhua Lin, Junjie Xu, Zongyu Wu, Enyan Dai, Suhang Wang*

1. **Learning Distributions of Complex Fluid Simulations with Diffusion Graph Networks.**
...
1. **LayerDAG: A Layerwise Autoregressive Diffusion Model for Directed Acyclic Graph Generation.**

    *Mufei Li, Viraj Shitole, Eli Chien, Changhai Man, Zhaodong Wang, Srinivas, Ying Zhang, Tushar Krishna, Pan Li*

1. **Quality Measures for Dynamic Graph Generative Models.**
...
1. **Retri3D: 3D Neural Graphics Representation Retrieval.**
...
1. **Temporal Heterogeneous Graph Generation with Privacy, Utility, and Efficiency.**

    *Xinyu He, Dongqi Fu, Hanghang Tong, Ross Maciejewski, Jingrui He*

1. **CBGBench: Fill in the Blank of Protein-Molecule Complex Binding Graph.**

    *Haitao Lin, Guojiang Zhao, Odin Zhang, Yufei Huang, Lirong Wu, Cheng Tan, Zicheng Liu, Zhifeng Gao, Stan Z. Li*

1. **Revisiting Random Walks for Learning on Graphs.**

    *Jinwoo Kim, Olga Zaghen, Ayhan Suleymanzade, Youngmin Ryou, Seunghoon Hong*

1. **Can Large Language Models Understand Symbolic Graphics Programs?**
...
1. **Graph Neural Networks Can (Often) Count Substructures.**

    *Paolo Pellizzoni, Till Hendrik Schulz, Karsten M. Borgwardt*

1. **Uncertainty Modeling in Graph Neural Networks via Stochastic Differential Equations.**

    *Richard Bergna, Sergio Calvo-Ordoñez, Felix L. Opolka, Pietro Lio, José Miguel Hernández-Lobato*

1. **Interleaved Scene Graphs for Interleaved Text-and-Image Generation Assessment.**

    *Dongping Chen, Ruoxi Chen, Shu Pu, Zhaoyi Liu, Yanru Wu, Caixi Chen, Benlin Liu, Yue Huang, Yao Wan, Pan Zhou, Ranjay Krishna*

1. **IGL-Bench: Establishing the Comprehensive Benchmark for Imbalanced Graph Learning.**
...
1. **Bundle Neural Network for message diffusion on graphs.**

    *Jacob Bamberger, Federico Barbero, Xiaowen Dong, Michael M. Bronstein*

1. **PhyMPGN: Physics-encoded Message Passing Graph Network for spatiotemporal PDE systems.**

    *Bocheng Zeng, Qi Wang, Mengtao Yan, Yang Liu, Ruizhi Chengze, Yi Zhang, Hongsheng Liu, Zidong Wang, Hao Sun*

1. **Graph Sparsification via Mixture of Graphs.**

    *Guibin Zhang, Xiangguo Sun, Yanwei Yue, Chonghe Jiang, Kun Wang, Tianlong Chen, Shirui Pan*

1. **Higher-Order Graphon Neural Networks: Approximation and Cut Distance.**

    *Daniel Herbst, Stefanie Jegelka*

1. **Topograph: An Efficient Graph-Based Framework for Strictly Topology Preserving Image Segmentation.**
...
1. **GETS: Ensemble Temperature Scaling for Calibration in Graph Neural Networks.**

    *Dingyi Zhuang, Chonghe Jiang, Yunhan Zheng, Shenhao Wang, Jinhua Zhao*

1. **Scalable and Certifiable Graph Unlearning: Overcoming the Approximation Error Barrier.**

    *Lu Yi, Zhewei Wei*

1. **Beyond Random Masking: When Dropout meets Graph Convolutional Networks.**

    *Yuankai Luo, Xiao-Ming Wu, Hao Zhu*

1. **When GNNs meet symmetry in ILPs: an orbit-based feature augmentation approach.**

    *Qian Chen, Lei Li, Qian Li, Jianghua Wu, Akang Wang, Ruoyu Sun, Xiaodong Luo, Tsung-Hui Chang, Qingjiang Shi*

1. **Charting the Design Space of Neural Graph Representations for Subgraph Matching.**
...
1. **Neural Multi-Objective Combinatorial Optimization via Graph-Image Multimodal Fusion.**

    *Jinbiao Chen, Jiahai Wang, Zhiguang Cao, Yaoxin Wu*

1. **PolyhedronNet: Representation Learning for Polyhedra with Surface-attributed Graph.**
...
1. **EditRoom: LLM-parameterized Graph Diffusion for Composable 3D Room Layout Editing.**

    *Kaizhi Zheng, Xiaotong Chen, Xuehai He, Jing Gu, Linjie Li, Zhengyuan Yang, Kevin Lin, Jianfeng Wang, Lijuan Wang, Xin Eric Wang*

1. **Simple is Effective: The Roles of Graphs and Large Language Models in Knowledge-Graph-Based Retrieval-Augmented Generation.**

    *Mufei Li, Siqi Miao, Pan Li*

1. **Greener GRASS: Enhancing GNNs with Encoding, Rewiring, and Attention.**
...
1. **GOttack: Universal Adversarial Attacks on Graph Neural Networks via Graph Orbits Learning.**

    *Md. Zulfikar Alom, Tran Gia Bao Ngo, Murat Kantarcioglu, Cuneyt Gurcan Akcora*

1. **Learning to Explore and Exploit with GNNs for Unsupervised Combinatorial Optimization.**

    *Utku Umur Acikalin, Aaron M. Ferber, Carla P. Gomes*

1. **GRAIN: Exact Graph Reconstruction from Gradients.**

    *Maria Drencheva, Ivo Petrov, Maximilian Baader, Dimitar Iliev Dimitrov, Martin T. Vechev*

1. **Improving Graph Neural Networks by Learning Continuous Edge Directions.**

    *Seong Ho Pahng, Sahand Hormoz*

1. **Graph Neural Networks Gone Hogwild.**

    *Olga Solodova, Nick Richardson, Deniz Oktay, Ryan P. Adams*

1. **Holographic Node Representations: Pre-training Task-Agnostic Node Embeddings.**
...
1. **Learning Diagrams: A Graphical Language for Compositional Training Regimes.**

    *Mason Lary, Richard Samuelson, Alexander Wilentz, Alina Zare, Matthew Klawonn, James P. Fairbanks*

1. **Is uniform expressivity too restrictive? Towards efficient expressivity of GNNs.**

    *Sammy Khalife, Josué Tonelli-Cueto*

1. **Bonsai: Gradient-free Graph Condensation for Node Classification.**

    *Mridul Gupta, Samyak Jain, Vansh Ramani, Hariprasad Kodamana, Sayan Ranu*

1. **Discrete Diffusion Schrödinger Bridge Matching for Graph Transformation.**

    *Jun Hyeong Kim, Seonghwan Kim, Seokhyun Moon, Hyeongwoo Kim, Jeheon Woo, Woo Youn Kim*

1. **How Do Large Language Models Understand Graph Patterns? A Benchmark for Graph Pattern Comprehension.**

    *Xinnan Dai, Haohao Qu, Yifei Shen, Bohang Zhang, Qihao Wen, Wenqi Fan, Dongsheng Li, Jiliang Tang, Caihua Shan*

1. **Causal Graphical Models for Vision-Language Compositional Understanding.**

    *Fiorenzo Parascandolo, Nicholas Moratelli, Enver Sangineto, Lorenzo Baraldi, Rita Cucchiara*

1. **Valid Conformal Prediction for Dynamic GNNs.**
...
1. **Lift Your Molecules: Molecular Graph Generation in Latent Euclidean Space.**

    *Mohamed Amine Ketata, Nicholas Gao, Johanna Sommer, Tom Wollschläger, Stephan Günnemann*

1. **GraphEval: A Lightweight Graph-Based LLM Framework for Idea Evaluation.**
...
1. **AutoG: Towards automatic graph construction from tabular data.**

    *Zhikai Chen, Han Xie, Jian Zhang, Xiang Song, Jiliang Tang, Huzefa Rangwala, George Karypis*

1. **Beyond Mere Token Analysis: A Hypergraph Metric Space Framework for Defending Against Socially Engineered LLM Attacks.**

    *Manohar Kaul, Aditya Saibewar, Sadbhavana Babar*

1. **Systematic Relational Reasoning With Epistemic Graph Neural Networks.**

    *Irtaza Khalid, Steven Schockaert*

1. **Exact Computation of Any-Order Shapley Interactions for Graph Neural Networks.**
...
1. **Decoupled Subgraph Federated Learning.**

    *Javad Aliakbari, Johan Östman, Alexandre Graell i Amat*

1. **The Effectiveness of Curvature-Based Rewiring and the Role of Hyperparameters in GNNs Revisited.**

    *Floriano Tori, Vincent Holst, Vincent Ginis*

1. **Equivariant Denoisers Cannot Copy Graphs: Align Your Graph Diffusion Models.**

    *Najwa Laabid, Severi Rissanen, Markus Heinonen, Arno Solin, Vikas Garg*

1. **Node Identifiers: Compact, Discrete Representations for Efficient Graph Learning.**

    *Yuankai Luo, Hongkang Li, Qijiong Liu, Lei Shi, Xiao-Ming Wu*

1. **InstantSplamp: Fast and Generalizable Stenography Framework for Generative Gaussian Splatting.**

    *Chenxin Li, Hengyu Liu, Zhiwen Fan, Wuyang Li, Yifan Liu, Panwang Pan, Yixuan Yuan*

1. **CryoGEN: Generative Energy-based Models for Cryogenic Electron Tomography Reconstruction.**

    *Yunfei Teng, Yuxuan Ren, Kai Chen, Xi Chen, Zhaoming Chen, Qiwei Ye*

1. **GraphBridge: Towards Arbitrary Transfer Learning in GNNs.**

    *Li Ju, Xingyi Yang, Qi Li, Xinchao Wang*

1. **Towards Explaining the Power of Constant-depth Graph Neural Networks for Structured Linear Programming.**

    *Qian Li, Minghui Ouyang, Tian Ding, Yuyi Wang, Qingjiang Shi, Ruoyu Sun*

1. **Graph-based Document Structure Analysis.**

    *Yufan Chen, Ruiping Liu, Junwei Zheng, Di Wen, Kunyu Peng, Jiaming Zhang, Rainer Stiefelhagen*

1. **Generalizing Weisfeiler-Lehman Kernels to Subgraphs.**

    *Dongkwan Kim, Alice Oh*

1. **Generating Graphs via Spectral Diffusion.**

    *Giorgia Minello, Alessandro Bicciato, Luca Rossi, Andrea Torsello, Luca Cosmo*

1. **Neural Causal Graph for Interpretable and Intervenable Classification.**

    *Jiawei Wang, Shaofei Lu, Da Cao, Dongyu Wang, Yuquan Le, Zhe Quan, Tat-Seng Chua*

1. **Loss Landscape of Shallow ReLU-like Neural Networks: Stationary Points, Saddle Escape, and Network Embedding.**

    *Zhengqing Wu, Berfin Simsek, François Gaston Ged*

1. **InversionGNN: A Dual Path Network for Multi-Property Molecular Optimization.**

    *Yifan Niu, Ziqi Gao, Tingyang Xu, Yang Liu, Yatao Bian, Yu Rong, Junzhou Huang, Jia Li*

1. **Accurate and Scalable Graph Neural Networks via Message Invariance.**

    *Zhihao Shi, Jie Wang, Zhiwei Zhuang, Xize Liang, Bin Li, Feng Wu*

1. **DUALFormer: Dual Graph Transformer.**

    *Jiaming Zhuo, Yuwei Liu, Yintong Lu, Ziyi Ma, Kun Fu, Chuan Wang, Yuanfang Guo, Zhen Wang, Xiaochun Cao, Liang Yang*

1. **Graph Neural Preconditioners for Iterative Solutions of Sparse Linear Systems.**

    *Jie Chen*

1. **MuseGNN: Forming Scalable, Convergent GNN Layers that Minimize a Sampling-Based Energy.**

    *Haitian Jiang, Renjie Liu, Zengfeng Huang, Yichuan Wang, Xiao Yan, Zhenkun Cai, Minjie Wang, David Wipf*

1. **MAGE: Model-Level Graph Neural Networks Explanations via Motif-based Graph Generation.**

    *Zhaoning Yu, Hongyang Gao*

1. **Advancing Graph Generation through Beta Diffusion.**

    *Xinyang Liu, Yilin He, Bo Chen, Mingyuan Zhou*

1. **Towards Bridging Generalization and Expressivity of Graph Neural Networks.**
...
1. **Learning Graph Quantized Tokenizers.**
...
1. **Graph Transformers Dream of Electric Flow.**

    *Xiang Cheng, Lawrence Carin, Suvrit Sra*

1. **GNNs Getting ComFy: Community and Feature Similarity Guided Rewiring.**

    *Celia Rubio-Madrigal, Adarsh Jamadandi, Rebekka Burkholz*

1. **Port-Hamiltonian Architectural Bias for Long-Range Propagation in Deep Graph Networks.**

    *Simon Heilig, Alessio Gravina, Alessandro Trenta, Claudio Gallicchio, Davide Bacciu*

1. **Topological Zigzag Spaghetti for Diffusion-based Generation and Prediction on Graphs.**

    *Yuzhou Chen, Yulia R. Gel*

1. **Knowledge Graph Finetuning Enhances Knowledge Manipulation in Large Language Models.**

    *Hanzhu Chen, Xu Shen, Jie Wang, Zehao Wang, Qitan Lv, Junjie He, Rong Wu, Feng Wu, Jieping Ye*

1. **BANGS: Game-theoretic Node Selection for Graph Self-Training.**

    *Fangxin Wang, Kay Liu, Sourav Medya, Philip S. Yu*

1. **Graph Neural Networks for Edge Signals: Orientation Equivariance and Invariance.**

    *Dominik Fuchsgruber, Tim Postuvan, Stephan Günnemann, Simon Geisler*

1. **Training-Free Message Passing for Learning on Hypergraphs.**

    *Bohan Tang, Zexi Liu, Keyue Jiang, Siheng Chen, Xiaowen Dong*

1. **Graph-Guided Scene Reconstruction from Images with 3D Gaussian Splatting.**

    *Chong Cheng, Gaochao Song, Yiyang Yao, Qinzheng Zhou, Gangjian Zhang, Hao Wang*

1. **Residual Connections and Normalization Can Provably Prevent Oversmoothing in GNNs.**

    *Michael Scholkemper, Xinyi Wu, Ali Jadbabaie, Michael T. Schaub*

1. **Bringing NeRFs to the Latent Space: Inverse Graphics Autoencoder.**
...
1. **What Are Good Positional Encodings for Directed Graphs?**

    *Yinan Huang, Haoyu Peter Wang, Pan Li*

1. **Causal Concept Graph Models: Beyond Causal Opacity in Deep Learning.**
...
1. **Graph Neural Ricci Flow: Evolving Feature from a Curvature Perspective.**

    *Jialong Chen, Bowen Deng, Zhen Wang, Chuan Chen, Zibin Zheng*

1. **Factor Graph-based Interpretable Neural Networks.**

    *Yicong Li, Kuanjiu Zhou, Shuo Yu, Qiang Zhang, Renqiang Luo, Xiaodong Li, Feng Xia*

1. **A Graph Enhanced Symbolic Discovery Framework For Efficient Logic Optimization.**

    *Yinqi Bai, Jie Wang, Lei Chen, Zhihai Wang, Yufei Kuang, Mingxuan Yuan, Jianye Hao, Feng Wu*

1. **Think-on-Graph 2.0: Deep and Faithful Large Language Model Reasoning with Knowledge-guided Retrieval Augmented Generation.**

    *Shengjie Ma, Chengjin Xu, Xuhui Jiang, Muzhi Li, Huaren Qu, Cehao Yang, Jiaxin Mao, Jian Guo*

1. **Learning Graph Invariance by Harnessing Spuriosity.**
...
1. **Beyond Circuit Connections: A Non-Message Passing Graph Transformer Approach for Quantum Error Mitigation.**

    *Tianyi Bao, Xinyu Ye, Hang Ruan, Chang Liu, Wenjie Wu, Junchi Yan*

1. **Learning Long Range Dependencies on Graphs via Random Walks.**

    *Dexiong Chen, Till Hendrik Schulz, Karsten M. Borgwardt*

1. **On the Benefits of Attribute-Driven Graph Domain Adaptation.**

    *Ruiyi Fang, Bingheng Li, Zhao Kang, Qiuhao Zeng, Nima Hosseini Dashtbayaz, Ruizhi Pu, Charles Ling, Boyu Wang*

1. **Biologically Plausible Brain Graph Transformer.**

    *Ciyuan Peng, Yuelong Huang, Qichao Dong, Shuo Yu, Feng Xia, Chengqi Zhang, Yaochu Jin*

1. **GraphArena: Evaluating and Exploring Large Language Models on Graph Computation.**

    *Jianheng Tang, Qifan Zhang, Yuhan Li, Nuo Chen, Jia Li*

1. **Precedence-Constrained Winter Value for Effective Graph Data Valuation.**

    *Hongliang Chi, Wei Jin, Charu C. Aggarwal, Yao Ma*

1. **Iterative Substructure Extraction for Molecular Relational Learning with Interactive Graph Information Bottleneck.**

    *Shuai Zhang, Junfeng Fang, Xuqiang Li, Hongxin Xiang, Alan Xia, Ye Wei, Wenjie Du, Yang Wang*

1. **Centrality-guided Pre-training for Graph.**

    *Bin Liang, Shiwei Chen, Lin Gui, Hui Wang, Yue Yu, Ruifeng Xu, Kam-Fai Wong*

1. **The Computational Complexity of Positive Non-Clashing Teaching in Graphs.**

    *Robert Ganian, Liana Khazaliya, Fionn Mc Inerney, Mathis Rocton*

1. **Spreading Out-of-Distribution Detection on Graphs.**

    *Daeho Um, Jongin Lim, Sunoh Kim, Yuneil Yeo, Yoonho Jung*

1. **Relation-Aware Diffusion for Heterogeneous Graphs with Partially Observed Features.**
...
1. **Reconsidering Faithfulness in Regular, Self-Explainable and Domain Invariant GNNs.**

    *Steve Azzolin, Antonio Longa, Stefano Teso, Andrea Passerini*

1. **GLoRa: A Benchmark to Evaluate the Ability to Learn Long-Range Dependencies in Graphs.**

    *Dongzhuoran Zhou, Evgeny Kharlamov, Egor V. Kostylev*

1. **Reveal Object in Lensless Photography via Region Gaze and Amplification.**

    *Xiangjun Yin, Huihui Yue*

1. **Enhancing Graph Of Thought: Enhancing Prompts with LLM Rationales and Dynamic Temperature Control.**

    *Sunguk Shin, Youngjoon Kim*

1. **GPromptShield: Elevating Resilience in Graph Prompt Tuning Against Adversarial Attacks.**

    *Shuhan Song, Ping Li, Ming Dun, Maolei Huang, Huawei Cao, Xiaochun Ye*

1. **Learning Partial Graph Matching via Optimal Partial Transport.**
...
1. **Node-Time Conditional Prompt Learning in Dynamic Graphs.**

    *Xingtong Yu, Zhenghao Liu, Xinming Zhang, Yuan Fang*

1. **Towards Synergistic Path-based Explanations for Knowledge Graph Completion: Exploration and Evaluation.**

    *Tengfei Ma, Xiang Song, Wen Tao, Mufei Li, Jiani Zhang, Xiaoqin Pan, Yijun Wang, Bosheng Song, Xiangxiang Zeng*

1. **Unsupervised Multiple Kernel Learning for Graphs via Ordinality Preservation.**

    *Yan Sun, Stanley Kok*

1. **INFER: A Neural-symbolic Model For Extrapolation Reasoning on Temporal Knowledge Graph.**

    *Ningyuan Li, Haihong E, Tianyu Yao, Tianyi Hu, Yuhan Li, Haoran Luo, Meina Song, Yifan Zhu*

1. **From GNNs to Trees: Multi-Granular Interpretability for Graph Neural Networks.**
...
1. **Decoupled Graph Energy-based Model for Node Out-of-Distribution Detection on Heterophilic Graphs.**

    *Yuhan Chen, Yihong Luo, Yifan Song, Pengwen Dai, Jing Tang, Xiaochun Cao*

1. **Fully-inductive Node Classification on Arbitrary Graphs.**

    *Jianan Zhao, Zhaocheng Zhu, Mikhail Galkin, Hesham Mostafa, Michael M. Bronstein, Jian Tang*

1. **Scale-Free Graph-Language Models.**

    *Jianglin Lu, Yixuan Liu, Yitian Zhang, Yun Fu*

1. **X-Sample Contrastive Loss: Improving Contrastive Learning with Sample Similarity Graphs.**

    *Vlad Sobal, Mark Ibrahim, Randall Balestriero, Vivien Cabannes, Diane Bouchacourt, Pietro Astolfi, Kyunghyun Cho, Yann LeCun*

1. **Matcha: Mitigating Graph Structure Shifts with Test-Time Adaptation.**

    *Wenxuan Bao, Zhichen Zeng, Zhining Liu, Hanghang Tong, Jingrui He*

1. **Edge Prompt Tuning for Graph Neural Networks.**

    *Xingbo Fu, Yinhan He, Jundong Li*

1. **Towards Continuous Reuse of Graph Models via Holistic Memory Diversification.**

    *Ziyue Qiao, Junren Xiao, Qingqiang Sun, Meng Xiao, Xiao Luo, Hui Xiong*

1. **Generalization, Expressivity, and Universality of Graph Neural Networks on Attributed Graphs.**

    *Levi Rauchwerger, Stefanie Jegelka, Ron Levie*

1. **Explanations of GNN on Evolving Graphs via Axiomatic Layer edges.**

    *Yazheng Liu, Sihong Xie*

1. **REBIND: Enhancing Ground-state Molecular Conformation Prediction via Force-Based Graph Rewiring.**

    *Taewon Kim, Hyunjin Seo, Sungsoo Ahn, Eunho Yang*

1. **Grammar Reinforcement Learning: path and cycle counting in graphs with a Context-Free Grammar and Transformer approach.**

    *Jason Piquenot, Maxime Berar, Romain Raveaux, Pierre Héroux, Jean-Yves Ramel, Sébastien Adam*

1. **Diffusing to the Top: Boost Graph Neural Networks with Minimal Hyperparameter Tuning.**

    *Lequan Lin, Dai Shi, Andi Han, Zhiyong Wang, Junbin Gao*

1. **Graph Assisted Offline-Online Deep Reinforcement Learning for Dynamic Workflow Scheduling.**

    *Yifan Yang, Gang Chen, Hui Ma, Cong Zhang, Zhiguang Cao, Mengjie Zhang*

1. **When Graph Neural Networks Meet Dynamic Mode Decomposition.**

    *Dai Shi, Lequan Lin, Andi Han, Zhiyong Wang, Yi Guo, Junbin Gao*

1. **LASER: A Neuro-Symbolic Framework for Learning Spatio-Temporal Scene Graphs with Weak Supervision.**

    *Jiani Huang, Ziyang Li, Mayur Naik, Ser-Nam Lim*

1. **Rationalizing and Augmenting Dynamic Graph Neural Networks.**

    *Guibin Zhang, Yiyan Qi, Ziyang Cheng, Yanwei Yue, Dawei Cheng, Jian Guo*

1. **KAA: Kolmogorov-Arnold Attention for Enhancing Attentive Graph Neural Networks.**
...
1. **DistillHGNN: A Knowledge Distillation Approach for High-Speed Hypergraph Neural Networks.**

    *Saman Forouzandeh, Parham Moradi, Mahdi Jalili*

1. **Linear Transformer Topological Masking with Graph Random Features.**
...
1. **MeshMask: Physics-Based Simulations with Masked Graph Neural Networks.**

    *Paul Garnier, Vincent Lannelongue, Jonathan Viquerat, Elie Hachem*

1. **PharmacoMatch: Efficient 3D Pharmacophore Screening via Neural Subgraph Matching.**

    *Daniel Rose, Oliver Wieder, Thomas Seidel, Thierry Langer*

1. **Beyond Graphs: Can Large Language Models Comprehend Hypergraphs?**

    *Yifan Feng, Chengwu Yang, Xingliang Hou, Shaoyi Du, Shihui Ying, Zongze Wu, Yue Gao*

1. **HG-Adapter: Improving Pre-Trained Heterogeneous Graph Neural Networks with Dual Adapters.**

    *Yujie Mo, Runpeng Yu, Xiaofeng Zhu, Xinchao Wang*

1. **HyperPLR: Hypergraph Generation through Projection, Learning, and Reconstruction.**

    *Weihuang Wen, Tianshu Yu*

1. **Weakly Supervised Video Scene Graph Generation via Natural Language Supervision.**

    *Kibum Kim, Kanghoon Yoon, Yeonjun In, Jaehyeong Jeon, Jinyoung Moon, Donghyun Kim, Chanyoung Park*

1. **A Large-scale Training Paradigm for Graph Generative Models.**
...
1. **Expand and Compress: Exploring Tuning Principles for Continual Spatio-Temporal Graph Forecasting.**

    *Wei Chen, Yuxuan Liang*

1. **Training One-Dimensional Graph Neural Networks is NP-Hard.**

    *Robert Ganian, Mathis Rocton, Simon Wietheger*

1. **Learning Structured Universe Graph with Outlier OOD Detection for Partial Matching.**

    *Zetian Jiang, Jiaxin Lu, Haizhao Fan, Tianzhe Wang, Junchi Yan*

1. **N-ForGOT: Towards Not-forgetting and Generalization of Open Temporal Graph Learning.**

    *Liping Wang, Xujia Li, Jingshu Peng, Yue Wang, Chen Zhang, Yan Zhou, Lei Chen*
...
1. **SINGER: Stochastic Network Graph Evolving Operator for High Dimensional PDEs.**

    *Mingquan Feng, Yixin Huang, Weixin Liao, Yuhong Liu, Yizhou Liu, Junchi Yan*

1. **Structuring Benchmark into Knowledge Graphs to Assist Large Language Models in Retrieving and Designing Models.**
...
1. **On Designing General and Expressive Quantum Graph Neural Networks with Applications to MILP Instance Representation.**

    *Xinyu Ye, Hao Xiong, Jianhao Huang, Ziang Chen, Jia Wang, Junchi Yan*

1. **Causal Graph Transformer for Treatment Effect Estimation Under Unknown Interference.**

    *Anpeng Wu, Haiyi Qiu, Zhengming Chen, Zijian Li, Ruoxuan Xiong, Fei Wu, Kun Zhang*

1. **ST-GCond: Self-supervised and Transferable Graph Dataset Condensation.**

    *Beining Yang, Qingyun Sun, Cheng Ji, Xingcheng Fu, Jianxin Li*

1. **Rethinking Graph Neural Networks From A Geometric Perspective Of Node Features.**

    *Feng Ji, Yanan Zhao, Kai Zhao, Hanyang Meng, Jielong Yang, Wee Peng Tay*

1. **Reasoning-Enhanced Healthcare Predictions with Knowledge Graph Community Retrieval.**

    *Pengcheng Jiang, Cao Xiao, Minhao Jiang, Parminder Bhatia, Taha A. Kass-Hout, Jimeng Sun, Jiawei Han*

1. **Credit-based self organizing maps: training deep topographic networks with minimal performance degradation.**

    *Amirozhan Dehghani, Xinyu Qian, Asa Farahani, Pouya Bashivan*

1. **Let Your Features Tell The Differences: Understanding Graph Convolution By Feature Splitting.**
...
1. **Hydra-SGG: Hybrid Relation Assignment for One-stage Scene Graph Generation.**
...
1. **Bias Mitigation in Graph Diffusion Models.**

    *Meng Yu, Kun Zhang*

1. **Shapley-Guided Utility Learning for Effective Graph Inference Data Valuation.**

    *Hongliang Chi, Qiong Wu, Zhengyi Zhou, Yao Ma*

1. **MaxCutPool: differentiable feature-aware Maxcut for pooling in graph neural networks.**

    *Carlo Abate, Filippo Maria Bianchi*

1. **SecureGS: Boosting the Security and Fidelity of 3D Gaussian Splatting Steganography.**

    *Xuanyu Zhang, Jiarui Meng, Zhipei Xu, Shuzhou Yang, Yanmin Wu, Ronggang Wang, Jian Zhang*

1. **Recovery of Causal Graph Involving Latent Variables via Homologous Surrogates.**

    *Xiu-Chuan Li, Jun Wang, Tongliang Liu*

1. **TGB-Seq Benchmark: Challenging Temporal GNNs with Complex Sequential Dynamics.**

    *Lu Yi, Jie Peng, Yanping Zheng, Fengran Mo, Zhewei Wei, Yuhang Ye, Yue Zixuan, Zengfeng Huang*

1. **PIORF: Physics-Informed Ollivier-Ricci Flow for Long-Range Interactions in Mesh Graph Neural Networks.**

    *Youn-Yeol Yu, Jeongwhan Choi, Jaehyeon Park, Kookjin Lee, Noseong Park*

### [WSDM-2025](#contents)
1. **Graph Disentangle Causal Model: Enhancing Causal Inference in Networked Observational Data.**

    *Binbin Hu, Zhicheng An, Zhengwei Wu, Ke Tu, Ziqi Liu, Zhiqiang Zhang, Jun Zhou, Yufei Feng, Jiawei Chen*

1. **CIMAGE: Exploiting the Conditional Independence in Masked Graph Auto-encoders.**

    *Jongwon Park, Heesoo Jung, Hogun Park*

1. **Polaris: Sampling from the Multigraph Configuration Model with Prescribed Color Assortativity.**

    *Giulia Preti, Matteo Riondato, Aristides Gionis, Gianmarco De Francisci Morales*

1. **DiffGraph: Heterogeneous Graph Diffusion Model.**

    *Zongwei Li, Lianghao Xia, Hua Hua, Shijie Zhang, Shuangyang Wang, Chao Huang*

1. **Mitigating Overfitting in Graph Neural Networks via Feature and Hyperplane Perturbation.**

    *Yoonhyuk Choi, Jiho Choi, Taewook Ko, Chong-Kwon Kim*

1. **Dynamic Graph Transformer with Correlated Spatial-Temporal Positional Encoding.**

    *Zhe Wang, Sheng Zhou, Jiawei Chen, Zhen Zhang, Binbin Hu, Yan Feng, Chun Chen, Can Wang*

1. **Prospective Multi-Graph Cohesion for Multivariate Time Series Anomaly Detection.**

    *Jiazhen Chen, Mingbin Feng, Tony S. Wirjanto*

1. **MixRec: Heterogeneous Graph Collaborative Filtering.**

    *Lianghao Xia, Meiyan Xie, Yong Xu, Chao Huang*

1. **Q-DISCO: Query-Centric Densest Subgraphs in Networks with Opinion Information.**

    *Tianyi Chen, Atsushi Miyauchi, Charalampos E. Tsourakakis*

1. **Self-supervised Time-aware Heterogeneous Hypergraph Learning for Dynamic Graph-level Classification.**

    *Malik Khizar Hayat, Shan Xue, Jia Wu, Bilal Khan, Jian Yang*
...
1. **MoKGNN: Boosting Graph Neural Networks via Mixture of Generic and Task-Specific Language Models.**

    *Hao Yan, Chaozhuo Li, Jun Yin, Weihao Han, Hao Sun, Senzhang Wang, Jian Zhang, Jianxin Wang*

1. **Robustness Verification of Deep Graph Neural Networks Tightened by Linear Approximation.**

    *Xingyu Zeng, Han Li, Qi Qi, Jingyu Wang, Haodong Deng, Haifeng Sun, Zirui Zhuang, Jianxin Liao*

1. **HHGT: Hierarchical Heterogeneous Graph Transformer for Heterogeneous Graph Representation Learning.**

    *Qiuyu Zhu, Liang Zhang, Qianxiong Xu, Kaijun Liu, Cheng Long, Xiaoyang Wang*

1. **Neo-TKGC: Enhancing Temporal Knowledge Graph Completion with Integrated Node Weights and Future Information.**

    *Zihan Qiu, Xiaoling Zhou, Chunyan An, Qiang Yang, Zhixu Li*

1. **Edge Classification on Graphs: New Directions in Topological Imbalance.**

    *Xueqi Cheng, Yu Wang, Yunchao Liu, Yuying Zhao, Charu C. Aggarwal, Tyler Derr*

1. **Hawkes Point Process-enhanced Dynamic Graph Neural Network.**

    *Zhiqiang Wang, Baijing Hu, Kaixuan Yao, Jiye Liang*

1. **FedGF: Enhancing Structural Knowledge via Graph Factorization for Federated Graph Learning.**

    *Pengyang Zhou, Chaochao Chen, Weiming Liu, Xinting Liao, Fengyuan Yu, Zhihui Fu, Xingyu Lou, Wu Wen, Xiaolin Zheng, Jun Wang*

1. **Graph Size-imbalanced Learning with Energy-guided Structural Smoothing.**

    *Jiawen Qin, Pengfeng Huang, Qingyun Sun, Cheng Ji, Xingcheng Fu, Jianxin Li*

1. **Inductive Graph Few-shot Class Incremental Learning.**

    *Yayong Li, Peyman Moghadam, Can Peng, Nan Ye, Piotr Koniusz*

1. **RSM: Reinforced Subgraph Matching Framework with Fine-grained Operation based Search Plan.**

    *Ziming Li, Yuequn Dou, Youhuan Li, Xinhuan Chen, Chuxu Zhang*

1. **An Aspect Performance-aware Hypergraph Neural Network for Review-based Recommendation.**

    *Junrui Liu, Tong Li, Di Wu, Zifang Tang, Yuan Fang, Zhen Yang*

1. **LightGNN: Simple Graph Neural Network for Recommendation.**

    *Guoxuan Chen, Lianghao Xia, Chao Huang*

1. **D2: Customizing Two-Stage Graph Neural Networks for Early Rumor Detection through Cascade Diffusion Prediction.**
...
1. **Training MLPs on Graphs without Supervision.**

    *Zehong Wang, Zheyuan Zhang, Chuxu Zhang, Yanfang Ye*

1. **Adaptive Graph Enhancement for Imbalanced Multi-relation Graph Learning.**
...
1. **Heterophilic Graph Neural Networks Optimization with Causal Message-passing.**

    *Botao Wang, Jia Li, Heng Chang, Keli Zhang, Fugee Tsung*

1. **Improving CTR Prediction with Graph-Enhanced Interest Networks for Sparse Behavior Sequences.**

    *Xuanzhou Liu, Zhibo Xiao, Luwei Yang, Hansheng Xue, Jianxing Ma, Yujiu Yang*

1. **UniGLM: Training One Unified Language Model for Text-Attributed Graphs Embedding.**

    *Yi Fang, Dongzhe Fan, Sirui Ding, Ninghao Liu, Qiaoyu Tan*

1. **Bridging Historical Subgraph Optimization and Modern Graph Neural Network Approaches in Team Recommendation.**

    *Mahdis Saeedi, Christine Wong, Hossein Fani*

1. **Integrating Knowledge Graphs and Neuro-Symbolic AI: LDM Enables FAIR and Federated Research Data Management.**

    *Ahmad Sakor, Mauricio Brunet, Enrique Iglesias, Ariam Rivas, Philipp D. Rohde, Angelina Kraft, Maria-Esther Vidal*

### [WWW-2025](#contents)
1. **Worst-Case-Optimal Joins on Graphs with Topological Relations.**

    *José Fuentes-Sepúlveda, Adrián Gómez-Brandón, Aidan Hogan, Ayleen Irribarra-Cortés, Gonzalo Navarro, Juan L. Reutter*

1. **Subgraph-Aware Training of Language Models for Knowledge Graph Completion Using Structure-Aware Contrastive Learning.**

    *Youmin Ko, Hyemin Yang, Taeuk Kim, Hyunjoon Kim*

1. **HySAE: An Efficient Semantic-Enhanced Representation Learning Model for Knowledge Hypergraph Link Prediction.**
...
1. **G-Refer: Graph Retrieval-Augmented Large Language Model for Explainable Recommendation.**

    *Yuhan Li, Xinni Zhang, Linhao Luo, Heng Chang, Yuxiang Ren, Irwin King, Jia Li*

1. **A Plug-in Critiquing Approach for Knowledge Graph Recommendation Systems via Representative Sampling.**
...
1. **Dual Graph Denoising Model for Social Recommendation.**
...
1. **Node2binary: Compact Graph Node Embeddings using Binary Vectors.**

    *Niloy Talukder, Croix Gyurek, Mohammad Al Hasan*

1. **Domain-Informed Negative Sampling Strategies for Dynamic Graph Embedding in Meme Stock-Related Social Networks.**

    *Yunming Hui, Inez Maria Zwetsloot, Simon Trimborn, Stevan Rudinac*

1. **UniGO: A Unified Graph Neural Network for Modeling Opinion Dynamics on Graphs.**

    *Hao Li, Hao Jiang, Yuke Zheng, Hao Sun, Wenying Gong*

1. **GraphCSR: A Space and Time-Efficient Sparse Matrix Representation for Web-scale Graph Processing.**

    *Xinbiao Gan, Tiejun Li, Qiang Zhang, Guang Wu, Bo Yang, Chunye Gong, Jie Liu, Kai Lu*

1. **GraphCom: Communication Hierarchy-aware Graph Engine for Distributed Model Training.**

    *Xinbiao Gan, Tiejun Li, Liang Wu, Qiang Zhang, Lingyun Song, Bo Yang, Jie Liu, Kai Lu*

1. **NI-GDBA: Non-Intrusive Distributed Backdoor Attack Based on Adaptive Perturbation on Federated Graph Learning.**

    *Ken Li, Bin Shi, Jiazhe Wei, Bo Dong*

1. **Dynamic Graph Unlearning: A General and Efficient Post-Processing Method via Gradient Transformation.**

    *He Zhang, Bang Wu, Xiangwen Yang, Xingliang Yuan, Xiaoning Liu, Xun Yi*

1. **STGAN: Detecting Host Threats via Fusion of Spatial-Temporal Features in Host Provenance Graphs.**

    *Anyuan Sang, Xuezheng Fan, Li Yang, Yuchen Wang, Lu Zhou, Junbo Jia, Huipeng Yang*

1. **Str-GCL: Structural Commonsense Driven Graph Contrastive Learning.**
...
1. **RiemannGFM: Learning a Graph Foundation Model from Riemannian Geometry.**

    *Li Sun, Zhenhao Huang, Suyang Zhou, Qiqi Wan, Hao Peng, Philip S. Yu*

1. **FG-CIBGC: A Unified Framework for Fine-Grained and Class-Incremental Behavior Graph Classification.**

    *Zhibin Ni, Pan Fan, Shengzhuo Dai, Bo Zhang, Hai Wan, Xibin Zhao*

1. **Unified and Generalizable Reinforcement Learning for Facility Location Problems on Graphs.**
...
1. **Subgraph Federated Unlearning.**
...
1. **SmoothGNN: Smoothing-aware GNN for Unsupervised Node Anomaly Detection.**

    *Xiangyu Dong, Xingyi Zhang, Yanni Sun, Lei Chen, Mingxuan Yuan, Sibo Wang*

1. **SPEAR: A Structure-Preserving Manipulation Method for Graph Backdoor Attacks.**

    *Yuanhao Ding, Yang Liu, Yugang Ji, Weigao Wen, Qing He, Xiang Ao*

1. **Exploring Hypergraph Condensation via Variational Hyperedge Generation and Multi-Aspectual Amelioration.**

    *Zheng Gong, Shuheng Shen, Changhua Meng, Ying Sun*

1. **Kronecker Generative Models for Power-Law Patterns in Real-World Hypergraphs.**

    *Minyoung Choe, Jihoon Ko, Taehyung Kwon, Kijung Shin, Christos Faloutsos*

1. **Generalization Performance of Hypergraph Neural Networks.**

    *Yifan Wang, Gonzalo R. Arce, Guangmo Tong*

1. **SEHG: Bridging Interpretability and Prediction in Self-Explainable Heterogeneous Graph Neural Networks.**

    *Zhenhua Huang, Wenhao Zhou, Yufeng Li, Xiuyang Wu, Chengpei Xu, Junfeng Fang, Zhaohong Jia, Linyuan Lü, Feng Xia*

1. **TESA: A Trajectory and Semantic-aware Dynamic Heterogeneous Graph Neural Network.**

    *Xin Wang, Jiawei Jiang, Xiao Yan, Qiang Huang*

1. **Scalable Algorithms for Forest-Based Centrality on Large Graphs.**

    *Yubo Sun, Haoxin Sun, Zhongzhi Zhang*

1. **Revisiting Dynamic Graph Clustering via Matrix Factorization.**

    *Dongyuan Li, Satoshi Kosugi, Ying Zhang, Manabu Okumura, Feng Xia, Renhe Jiang*

1. **Diffusion-based Graph-agnostic Clustering.**

    *Kun Xie, Renchi Yang, Sibo Wang*

1. **Graph Wave Networks.**

    *Juwei Yue, Haikuo Li, Jiawei Sheng, Yihan Guo, Xinghua Zhang, Chuan Zhou, Tingwen Liu, Li Guo*

1. **SimEdge: A Scalable Transitivity-Aware Graph-Theoretic Similarity Model for Capturing Edge-to-Edge Relationships.**
...
1. **Heterogeneous Graph Transfer Learning for Category-aware Cross-Domain Sequential Recommendation.**
...
1. **Robust Graph Learning Against Adversarial Evasion Attacks via Prior-Free Diffusion-Based Structure Purification.**

    *Jiayi Luo, Qingyun Sun, Haonan Yuan, Xingcheng Fu, Jianxin Li*

1. **Transfer Rule Learning over Large Knowledge Graphs.**

    *Hong Liu, Zhe Wang, Kewen Wang, Xiaowang Zhang, Zhiyong Feng*

1. **GraphCLIP: Enhancing Transferability in Graph Foundation Models for Text-Attributed Graphs.**

    *Yun Zhu, Haizhou Shi, Xiaotang Wang, Yongchao Liu, Yaoke Wang, Boci Peng, Chuntao Hong, Siliang Tang*

1. **Boosting Graph Convolution with Disparity-induced Structural Refinement.**

    *Sujia Huang, Yueyang Pi, Tong Zhang, Wenzhe Liu, Zhen Cui*

1. **Covering K-Cliques in Billion-Scale Graphs.**

    *Kaiyu Chen, Dong Wen, Hanchen Wang, Zhengyi Yang, Wenjie Zhang, Xuemin Lin*

1. **Grasp the Key Takeaways from Source Domain for Few Shot Graph Domain Adaptation.**

    *Xiangwei Lv, Jingyuan Chen, Mengze Li, Yongduo Sui, Zemin Liu, Beishui Liao*

1. **Fast Estimation and Optimization of Resistance Diameter on Graphs.**

    *Zenan Lu, Xiaotian Zhou, Zhongzhi Zhang*

1. **Highly-efficient Minimization of Network Connectivity in Large-scale Graphs.**

    *Mingyang Zhou, Gang Liu, Kezhong Lu, Hao Liao, Rui Mao*

1. **Balancing Graph Embedding Smoothness in Self-supervised Learning via Information-Theoretic Decomposition.**

    *Heesoo Jung, Hogun Park*

1. **Dual-level Mixup for Graph Few-shot Learning with Fewer Tasks.**

    *Yonghao Liu, Mengyu Li, Fausto Giunchiglia, Lan Huang, Ximing Li, Xiaoyue Feng, Renchu Guan*

1. **Rumor Detection on Social Media with Reinforcement Learning-based Key Propagation Graph Generator.**

    *Yusong Zhang, Kun Xie, Xingyi Zhang, Xiangyu Dong, Sibo Wang*

1. **Graph with Sequence: Broad-Range Semantic Modeling for Fake News Detection.**

    *Junwei Yin, Min Gao, Kai Shu, Wentao Li, Yinqiu Huang, Zongwei Wang*

1. **LLGformer: Learnable Long-range Graph Transformer for Traffic Flow Prediction.**

    *Di Jin, Cuiying Huo, Jiayi Shi, Dongxiao He, Jianguo Wei, Philip S. Yu*

1. **Toward Effective Digraph Representation Learning: A Magnetic Adaptive Propagation based Approach.**

    *Xunkai Li, Daohan Su, Zhengyu Wu, Guang Zeng, Hongchao Qin, Rong-Hua Li, Guoren Wang*

1. **P4GCN: Vertical Federated Social Recommendation with Privacy-Preserving Two-Party Graph Convolution Network.**

    *Zheng Wang, Wanwan Wang, Yimin Huang, Zhaopeng Peng, Ziqi Yang, Ming Yao, Cheng Wang, Xiaoliang Fan*

1. **Graph Meets LLM for Review Personalization based on User Votes.**

    *Sharon Hirsch, Lilach Zitnitski, Slava Novgorodov, Ido Guy, Bracha Shapira*

1. **Rankformer: A Graph Transformer for Recommendation based on Ranking Objective.**

    *Sirui Chen, Shen Han, Jiawei Chen, Binbin Hu, Sheng Zhou, Gang Wang, Yan Feng, Chun Chen, Can Wang*

1. **Beyond Neighbors: Distance-Generalized Graphlets for Enhanced Graph Characterization.**

    *Yeongho Kim, Yuyeong Kim, Geon Lee, Kijung Shin*

1. **Hyperbolic Variational Graph Auto-Encoder for Next POI Recommendation.**

    *Yuwen Liu, Lianyong Qi, Xingyuan Mao, Weiming Liu, Fan Wang, Xiaolong Xu, Xuyun Zhang, Wanchun Dou, Xiaokang Zhou, Amin Beheshti*

1. **Polynomial Selection in Spectral Graph Neural Networks: An Error-Sum of Function Slices Approach.**

    *Guoming Li, Jian Yang, Shangsong Liang, Dongsheng Luo*

1. **Hyper-Relational Knowledge Representation Learning with Multi-Hypergraph Disentanglement.**

    *Jiecheng Li, Xudong Luo, Guangquan Lu, Shichao Zhang*

1. **Graph Embeddings Meet Link Keys Discovery for Entity Matching.**

    *Chloé Khadija Jradeh, Ensiyeh Raoufi, Jérôme David, Pierre Larmande, François Scharffe, Konstantin Todorov, Cássia Trojahn*

1. **Multimodal Knowledge Graph Error Detection with Disentanglement VAE and Multi-Grained Triplet Confidence.**

    *Xuhui Sui, Ying Zhang, Yu Zhao, Baohang Zhou, Xiaojie Yuan*

1. **Paths-over-Graph: Knowledge Graph Empowered Large Language Model Reasoning.**

    *Xingyu Tan, Xiaoyang Wang, Qing Liu, Xiwei Xu, Xin Yuan, Wenjie Zhang*

1. **Achieving Personalized Privacy-Preserving Graph Neural Network via Topology Awareness.**

    *Dian Lei, Zijun Song, Yanli Yuan, Chunhai Li, Liehuang Zhu*

1. **Tackling Sparse Facts for Temporal Knowledge Graph Completion.**

    *Yuchao Zhang, Xiangjie Kong, Kailun Ye, Guojiang Shen, Shangfei Zheng*

1. **Fairness-aware Prompt Tuning for Graph Neural Networks.**

    *Zhengpin Li, Minhua Lin, Jian Wang, Suhang Wang*

1. **Triangle Matters! TopDyG: Topology-aware Transformer for Link Prediction on Dynamic Graphs.**
...
1. **Hypergraph-based Temporal Modelling of Repeated Intent for Sequential Recommendation.**

    *Andreas Peintner, Amir Reza Mohammadi, Michael Müller, Eva Zangerle*

1. **Robust Deep Signed Graph Clustering via Weak Balance Theory.**

    *Peiyao Zhao, Xin Li, Zeyu Zhang, Mingzhong Wang, Xueying Zhu, Lejian Liao*

1. **Empowering Federated Graph Rationale Learning with Latent Environments.**

    *Linan Yue, Qi Liu, Yawen Li, Fangzhou Yao, Weibo Gao, Junping Du*

1. **Counting Cohesive Subgraphs with Hereditary Properties.**

    *Rong-Hua Li, Xiaowei Ye, Fusheng Jin, Yu-Ping Wang, Ye Yuan, Guoren Wang*

1. **Ranking on Dynamic Graphs: An Effective and Robust Band-Pass Disentangled Approach.**

    *Yingxuan Li, Yuanyuan Xu, Xuemin Lin, Wenjie Zhang, Ying Zhang*

1. **Dynamic Gradient Influencing for Viral Marketing Using Graph Neural Networks.**

    *Saurabh Sharma, Ambuj K. Singh*

1. **Angular Distance-Guided Neighbor Selection for Graph-Based Approximate Nearest Neighbor Search.**

    *Sungjun Jung, Yongsang Park, Haeun Lee, Young H. Oh, Jae W. Lee*

1. **LP-DIXIT: Evaluating Explanations for Link Predictions on Knowledge Graphs using Large Language Models.**

    *Roberto Barile, Claudia d'Amato, Nicola Fanizzi*

1. **Graph Self-Supervised Learning with Learnable Structural and Positional Encodings.**

    *Asiri Wijesinghe, Hao Zhu, Piotr Koniusz*

1. **Dual Operation Aggregation Graph Neural Networks for Solving Flexible Job-Shop Scheduling Problem with Reinforcement Learning.**

    *Peng Zhao, You Zhou, Di Wang, Zhiguang Cao, Yubin Xiao, Xuan Wu, Yuanshu Li, Hongjia Liu, Wei Du, Yuan Jiang, Liupu Wang*

1. **On the Cross-Graph Transferability of Dynamic Link Prediction.**

    *Zhiqiang Pan, Chen Gao, Fei Cai, Wanyu Chen, Xin Zhang, Honghui Chen, Yong Li*

1. **Instruction Vulnerability Prediction for WebAssembly with Semantic Enhanced Code Property Graph.**
...
1. **SANS: Efficient Densest Subgraph Discovery over Relational Graphs without Materialization.**
...
1. **Rethinking and Accelerating Graph Condensation: A Training-Free Approach with Class Partition.**
...
1. **MedRAG: Enhancing Retrieval-augmented Generation with Knowledge Graph-Elicited Reasoning for Healthcare Copilot.**

    *Xuejiao Zhao, Siyan Liu, Su-Yin Yang, Chunyan Miao*

1. **Criteria-Aware Graph Filtering: Extremely Fast Yet Accurate Multi-Criteria Recommendation.**

    *Jin-Duk Park, Jaemin Yoo, Won-Yong Shin*

1. **Disentangled Condensation for Large-scale Graphs.**

    *Zhenbang Xiao, Yu Wang, Shunyu Liu, Bingde Hu, Huiqiong Wang, Mingli Song, Tongya Zheng*

1. **Logic-Aware Knowledge Graph Reasoning for Structural Sparsity under Large Language Model Supervision.**

    *Yudai Pan, Jiajie Hong, Tianzhe Zhao, Lingyun Song, Jun Liu, Xuequn Shang*

1. **Horizontal Federated Heterogeneous Graph Learning: A Multi-Scale Adaptive Solution to Data Distribution Challenges.**

    *Jia Wang, Yawen Li, Zhe Xue, Yingxia Shao, Zeli Guan, Wenling Li*

1. **Bridging Fairness and Uncertainty: Theoretical Insights and Practical Strategies for Equalized Coverage in GNNs.**

    *Longfeng Wu, Yao Zhou, Jian Kang, Dawei Zhou*

1. **Conformal Graph-level Out-of-distribution Detection with Adaptive Data Augmentation.**

    *Xixun Lin, Yanan Cao, Nan Sun, Lixin Zou, Chuan Zhou, Peng Zhang, Shuai Zhang, Ge Zhang, Jia Wu*

1. **Effective Instruction Parsing Plugin for Complex Logical Query Answering on Knowledge Graphs.**

    *Xingrui Zhuo, Jiapu Wang, Gongqing Wu, Shirui Pan, Xindong Wu*

1. **Multimodal Graph-Based Variational Mixture of Experts Network for Zero-Shot Multimodal Information Extraction.**

    *Baohang Zhou, Ying Zhang, Yu Zhao, Xuhui Sui, Xiaojie Yuan*

1. **Hypergraph-based Zero-shot Multi-modal Product Attribute Value Extraction.**

    *Jiazhen Hu, Jiaying Gong, Hongda Shen, Hoda Eldardiry*

1. **Uncertainty-Aware Graph Structure Learning.**

    *Shen Han, Zhiyao Zhou, Jiawei Chen, Zhezheng Hao, Sheng Zhou, Gang Wang, Yan Feng, Chun Chen, Can Wang*

1. **Towards Multi-resolution Spatiotemporal Graph Learning for Medical Time Series Classification.**

    *Wei Fan, Jingru Fei, Dingyu Guo, Kun Yi, Xiaozhuang Song, Haolong Xiang, Hangting Ye, Min Li*

1. **Multi-Granularity Augmented Graph Learning for Spoofing Transaction Detection.**

    *Xin Liu, Haojun Rui, Dawei Cheng, Li Han, Zhongyun Zhou, Guoping Zhao*

1. **Generative Dynamic Graph Representation Learning for Conspiracy Spoofing Detection.**
...
### [ICDE-2025](#contents)
1. **Space-Efficient Compact Representations for Graph Analytics.**

    *Boyu Yang, Weiguo Zheng, Xiang Lian, Lingfei Zheng*

1. **AEGK: Aligned Entropic Graph Kernels Through Continuous-Time Quantum Walks: (Extended Abstract).**

    *Lu Bai, Lixin Cui, Ming Li, Peng Ren, Yue Wang, Lichi Zhang, Philip S. Yu, Edwin R. Hancock*

1. **HourglassSketch: An Efficient and Scalable Framework for Graph Stream Summarization.**
...
1. **CADRL: Category-Aware Dual-Agent Reinforcement Learning for Explainable Recommendations over Knowledge Graphs.**

    *Shangfei Zheng, Hongzhi Yin, Tong Chen, Xiangjie Kong, Jian Hou, Pengpeng Zhao*

1. **Preserving K-Connectivity in Dynamic Graphs.**

    *Gengda Zhao, Dong Wen, Xiaoyang Wang, Kai Wang, Xuemin Lin*

1. **Efficient Learning-Based Graph Simulation for Temporal Graphs.**

    *Sheng Xiang, Chenhao Xu, Dawei Cheng, Xiaoyang Wang, Ying Zhang*

1. **Towards Fair Graph Neural Networks via Graph Counterfactual Without Sensitive Attributes.**

    *Xuemin Wang, Tianlong Gu, Xuguang Bao, Liang Chang*

1. **HINSCAN: Efficient Structural Graph Clustering Over Heterogeneous Information Networks.**

    *Long Yuan, Xiaotong Sun, Zi Chen, Peng Cheng, Longbin Lai, Xuemin Lin*

1. **Hyperion: Co-Optimizing SSD Access and GPU Computation for Cost-Efficient GNN Training.**

    *Jie Sun, Mo Sun, Zheng Zhang, Zuocheng Shi, Jun Xie, Zihan Yang, Jie Zhang, Zeke Wang, Fei Wu*

1. **Boosting Accuracy and Efficiency for Vector Retrieval with Local Scaling Graph.**
...
1. **Efficient $\eta$-Threshold Maintenance in Dynamic Uncertain Graphs.**

    *Yu Chen, Qing Liu, Yifan Zhu, Yunjun Gao*

1. **CrossETR: A Semantic-Driven Framework for Entity Matching Across Images and Graph.**

    *Qin Yuan, Zhenyu Wen, Jiaxu Qian, Ye Yuan, Guoren Wang*

1. **StructRide: A Framework to Exploit the Structure Information of Shareability Graph in Ridesharing.**

    *Jiexi Zhan, Yu Chen, Peng Cheng, Lei Chen, Wangze Ni, Xuemin Lin*

1. **Accelerating D-Core Maintenance over Dynamic Directed Graphs.**

    *Xuankun Liao, Qing Liu, Jiaxin Jiang, Byron Choi, Bingsheng He, Jianliang Xu*

1. **Revelio: Revealing Important Message Flows in Graph Neural Networks.**

    *Haoyu He, Isaiah J. King, H. Howie Huang*

1. **Scaling Asynchronous Graph Query Processing via Partitioned Stateful Traversal Machines.**
...
1. **GFlux: A Fast GPU-Based Out-of-Memory Multi-Hop Query Processing Framework for Trillion-Edge Graphs.**

    *Seyeon Oh, Heeyong Yoon, Donghyoung Han, Min-Soo Kim*

1. **Path-Based Summary Explanations for Graph Recommenders.**

    *Danae Pla Karidi, Evaggelia Pitoura*

1. **Data Poisoning Attacks to Local Differential Privacy Protocols for Graphs.**

    *Xi He, Kai Huang, Qingqing Ye, Haibo Hu*

1. **An Efficient Memoization Engine for Concurrent Graph Query Processing.**

    *Sen Gao, Shengliang Lu, Shixuan Sun, Yuchen Li, Bingsheng He*

1. **TeMatch: A Fast Temporal Subgraph Matching Framework with Temporal-Aware Subgraph Matching Algorithms.**

    *Chengying Huan, Heng Zhang, Yongchao Liu, Likang Chen, Xuran Wang, Yongchun Jiang, Shaonan Ma, Yanjun Wu*

1. **Maximal Similar-Weight Biclique Enumeration for Large Bipartite Graphs.**

    *Jianye Yang, Lei Xing, Ziyi Ma, Xi Luo, Cuiyun Gao, Xuemin Lin*

1. **Pilos: Scalable Large-Subgraph Matching by Online Spectral Filtering.**

    *Konstantinos Skitsas, Davide Mottin, Panagiotis Karras*

1. **Trail: A Knowledge Graph-Based Approach for Attributing Advanced Persistent Threats.**

    *Isaiah J. King, Ramiro Ramirez, Benjamin Bowman, H. Howie Huang*

1. **BSG4Bot:Efficient Bot Detection Based on Biased Heterogeneous Subgraphs.**

    *Hao Miao, Zida Liu, Jun Gao*

1. **CuckooGraph: A Scalable and Space-Time Efficient Data Structure for Large-Scale Dynamic Graphs.**

    *Zhuochen Fan, Yalun Cai, Zirui Liu, Jiarui Guo, Xin Fan, Tong Yang, Bin Cui*

1. **Know Your Account: Double Graph Inference-Based Account De-Anonymization on Ethereum.**

    *Shuyi Miao, Wangjie Qiu, Hongwei Zheng, Qinnan Zhang, Xiaofan Tu, Xunan Liu, Yang Liu, Jin Dong, Zhiming Zheng*

1. **Structure-Preference Enabled Graph Embedding Generation Under Differential Privacy.**

    *Sen Zhang, Qingqing Ye, Haibo Hu*

1. **PGB: Benchmarking Differentially Private Synthetic Graph Generation Algorithms.**

    *Shang Liu, Hao Du, Yang Cao, Bo Yan, Jinfei Liu, Masatoshi Yoshikawa*

1. **Efficient Dynamic Attributed Graph Generation.**

    *Fan Li, Xiaoyang Wang, Dawei Cheng, Cong Chen, Ying Zhang, Xuemin Lin*

1. **HIGGS: HIerarchy-Guided Graph Stream Summarization.**

    *Xuan Zhao, Xike Xie, Christian S. Jensen*

1. **SIT: Selective Incremental Training for Dynamic Knowledge Graph Embedding.**

    *Zhifeng Jia, Hanmo Liu, Haoyang Li, Lei Chen*

1. **DyFMVP: Say Goodbye to Staleness! Fresh Memory Vigorous Preserver for Continuous-Time Dynamic Graph.**

    *Jianye Pang, Xinjie Zhu, Xiaofei Xiong*

1. **Are We Wasting Time? A Fast, Accurate Performance Evaluation Framework for Knowledge Graph Link Predictors.**
...
1. **Towards Scalable and Efficient Graph Structure Learning.**

    *Siqi Shen, Wentao Zhang, Chengshuo Du, Chong Chen, Fangcheng Fu, Yingxia Shao, Bin Cui*

1. **IsGCL: Informative Sample-Aware Progressive Graph Contrastive Learning.**

    *Juxiang Zeng, Pinghui Wang, Linbo Ma, Jing Tao, Xiaohong Guan*

1. **SIGMA: An Efficient Heterophilous Graph Neural Network with Fast Global Aggregation.**

    *Haoyu Liu, Ningyi Liao, Siqiang Luo*

1. **Adaptive Local Clustering Over Attributed Graphs.**

    *Haoran Zheng, Renchi Yang, Jianliang Xu*

1. **Triangle Counting Over Signed Graphs with Differential Privacy.**

    *Zening Li, Rong-Hua Li, Fusheng Jin*

1. **Efficient Indexing for Label-Constrained Cohesive Subgraph Queries Over Large Graphs.**

    *Xin Deng, Peng Peng, Chuanyu Liu, Xianyan Xie, Hui Zhou, Zheng Qin*

1. **A Translation-Based Heterogeneous Graph Neural Network for Multiple Knowledge Graphs Alignment.**

    *Yaming Yang, Zhuofeng Luo, Zhe Wang, Weigang Lu, Yiheng Lu, Ziyu Guan, Wei Zhao, Yuanhai Lv*

1. **Backdoor Graph Condensation.**

    *Jiahao Wu, Ning Lu, Zeyu Dai, Kun Wang, Wenqi Fan, Shengcai Liu, Qing Li, Ke Tang*

1. **Imputing Sparse and Noisy Labels for GNNs.**

    *Wenfei Fan, Kehan Pang, Chao Tian*

1. **Distributed Evaluation of Graph Queries Using Recursive Relational Algebra.**

    *Sarah Chlyah, Pierre Genevès, Nabil Layaïda*

1. **Efficient Frequency-Aware k-Core Query on Temporal Graphs.**

    *Zhongfan Du, Ming Zhong, Yuanyuan Zhu, Tieyun Qian, Mengchi Liu, Jeffrey Xu Yu*

1. **Indexing Labeled Property Multidigraphs in Entropy Space, with Applications.**

    *Hongwei Huo, Yongze Yu, Zongtao He, Jeffrey Scott Vitter*

1. **On Temporal-Constraint Subgraph Matching.**

    *Xiaoyu Leng, Guang Zeng, Hongchao Qin, Longlong Lin, Rong-Hua Li*

1. **GCON: Differentially Private Graph Convolutional Network via Objective Perturbation.**

    *Jianxin Wei, Yizheng Zhu, Xiaokui Xiao, Ergute Bao, Yin Yang, Kuntai Cai, Beng Chin Ooi*

1. **MuSha: Subgraph Matching by Multilevel Sharing.**

    *Hongtai Cao, Qihao Wang, Xiaodong Li, Mohammad Matin Najafi, Kevin Chen-Chuan Chang, Reynold Cheng*

1. **Privacy-Preserving Triangle Counting in Directed Graphs.**

    *Ziyao Wei, Qing Liu, Zhikun Zhang, Shouling Ji, Yunjun Gao*

1. **CaliEX: A Disk-Based Large-Scale GNN Training System with Joint Design of Caching and Execution.**

    *Can Su, Haipeng Zhang, Hanyu Zhao, Wenting Shen, Baole Ai, Yong Li, Kaigui Bian, Bin Cui*

1. **ChainsFormer: Numerical Reasoning on Knowledge Graphs From a Chain Perspective.**

    *Ze Zhao, Bin Lu, Xiaoying Gan, Gu Tang, Luoyi Fu, Xinbing Wang*

1. **A Sketch Propagation Framework for Hub Queries on Unmaterialized Relational Graphs.**

    *Yudong Niu, Yuchen Li, Panagiotis Karras, Yanhao Wang*

1. **Efficient Maximum Balanced k-biplex Search Over Bipartite Graphs.**

    *Long Yuan, Junyue Xu, Zi Chen, Chuan Ma, Jianqiu Xu, Lu Qin*

1. **MARIOH: Multiplicity-Aware Hypergraph Reconstruction.**

    *Kyuhan Lee, Geon Lee, Kijung Shin*

1. **Historically Relevant Event Structuring for Temporal Knowledge Graph Reasoning.**

    *Jinchuan Zhang, Ming Sun, Chong Mu, Jinhao Zhang, Quanjiang Guo, Ling Tian*

1. **Structure and Position-Aware Graph Modeling for Trajectory Similarity Computation Over Road Networks.**

    *Peilun Yang, Hanchen Wang, Zhangyi Xu, Zhengping Qian, Yongheng Wang, Ying Zhang*

1. **OMeGa: Boosting Large-scale Graph Embeddings with Heterogeneous Memory Processing.**

    *Peng Fang, Siqiang Luo, Fang Wang, Bolong Zheng, Hong Jiang, Dan Feng, Hechang Pan, Xingyu Wan*

1. **FrontOrder: Frontier-Guided Graph Reordering.**

    *Xinmiao Zhang, Cheng Liu, Shengwen Liang, Chenwei Xiong, Yu Zhang, Lei Zhang, Huawei Li, Xiaowei Li*

1. **PrivIM: Differentially Private Graph Neural Networks for Influence Maximization.**

    *Renxuan Hou, Qingqing Ye, Xun Ran, Sen Zhang, Haibo Hu*

1. **Efficient Structural Clustering Over Hypergraphs.**

    *Dong Pan, Xu Zhou, Lingwei Li, Quanqing Xu, Chuanhui Yang, Chenhao Ma, Kenli Li*

1. **AdvSGM: Differentially Private Graph Learning via Adversarial Skip-Gram Model.**

    *Sen Zhang, Qingqing Ye, Haibo Hu, Jianliang Xu*

1. **LSM-Community: A Graph Storage System Exploiting Community Structure in Social Networks.**

    *Songyao Wang, Chaokun Wang, Fang Niu, Cheng Wu*

1. **Efficient Temporal Simple Path Graph Generation.**

    *Zhiyang Tang, Yanping Wu, Xiangjun Zai, Chen Chen, Xiaoyang Wang, Ying Zhang*

1. **VGQ: Enabling Verifiable Graph Queries on Blockchain Systems.**

    *Zhongming Yao, Tianyi Li, Junchang Xin, Yushuai Li, Chenxu Wang, Zhiqiong Wang, Divesh Srivastava, Christian S. Jensen*

1. **TopK-BC: Efficient Maintenance of Top k (p,q)-bicliques over Streaming Bipartite Graphs.**

    *Xin Deng, Zheng Qin, Peng Peng, Hui Zhou*

1. **Identifying Maximum Defective Bicliques in Large Bipartite Graphs.**

    *Zhiyi Wang, Lijun Chang, Jeffrey Xu Yu*

1. **UMGAD: Unsupervised Multiplex Graph Anomaly Detection.**

    *Xiang Li, Jianpeng Qi, Zhongying Zhao, Guanjie Zheng, Lei Cao, Junyu Dong, Yanwei Yu*

1. **Towards Unsupervised Entity Alignment for Highly Heterogeneous Knowledge Graphs.**

    *Runhao Zhao, Weixin Zeng, Jiuyang Tang, Yawen Li, Guanhua Ye, Junping Du, Xiang Zhao*

1. **Efficient Integration of Multi-View Attributed Graphs for Clustering and Embedding.**

    *Yiran Li, Gongyao Guo, Jieming Shi, Sibo Wang, Qing Li*

1. **MemQ: A Graph-Based Query Memory Prediction Framework for Effective Workload Scheduling.**

    *Yang Wu, Xuanhe Zhou, Xiaoguang Li, Jinhuai Kang, Chunxiao Xing, Tongliang Li, Xinjun Yang, Wenchao Zhou, Feifei Li, Yong Zhang*

1. **Efficient Core Propagation Based Hierarchical Graph Clustering.**

    *Jinbin Huang, Zihan Jia, Xin Huang*

1. **GraphPrompter: Multi-Stage Adaptive Prompt Optimization for Graph In-Context Learning.**

    *Rui Lv, Zaixi Zhang, Kai Zhang, Qi Liu, Weibo Gao, Jiawei Liu, Jiaxia Yan, Linan Yue, Fangzhou Yao*

1. **With Anchors or Not: Fairness-Aware Truss-Based Community Search on Attributed Graphs.**

    *Xinrui Wang, Zilong Liu, Shixin Ye, Xin Huang, Hong Gao, Xiuzhen Cheng, Dongxiao Yu*

1. **Effective and Scalable Heterogeneous Graph Neural Network Framework with Convolution-oriented Attention.**

    *Ziqian Zhang, Chaokun Wang, Shuwen Zheng, Cheng Wu, Ziyang Liu, Hao Feng*

1. **Efficient Mixed Precision Quantization in Graph Neural Networks.**

    *Samir Moustafa, Nils M. Kriege, Wilfried N. Gansterer*

1. **OptMatch: An Efficient and Generic Neural Network-Assisted Subgraph Matching Approach.**

    *Wenzhe Hou, Xiang Zhao, Bo Tang*

1. **Advancing Cloud-Native Cyber Threat Detection with Graph-Based Feature Engineering.**

    *Tailai Song, Mukharbek Organokov, Lennart Gulikers, Giulio Grassi, Giovanna Carofiglio, Michela Meo*

1. **GraphEx: A Graph-Based Extraction Method for Advertiser Keyphrase Recommendation.**

    *Ashirbad Mishra, Soumik Dey, Hansi Wu, Jinyu Zhao, He Yu, Kaichen Ni, Binbin Li, Kamesh Madduri*

1. **GalaxyView: Property Graph Transformation for Materialized View Generation.**

    *Bing Tong, Jianheng Tang, Yan Zhou, Chen Zhang, Jia Li, Lei Chen*

1. **A Unified Narrative for Query Processing in Graph Databases.**

    *Yue Pang, Lei Zou, M. Tamer Özsu*

1. **An Overview of Path Queries on Graphs.**

    *Wentao Li, Dong Wen, Lu Qin, Ying Zhang*

1. **AIGC for Graphs: Current Techniques and Future Trends.**

    *Hanchen Wang, Dawei Cheng, Ying Zhang, Wenjie Zhang*

1. **MITra: Populating Graph Traversal Algorithms.**

    *Wenyue Zhao, Jia Li, Yang Cao, Nikos Ntarmos*

1. **Graphint: Graph-Based Time Series Clustering Visualisation Tool.**

    *Paul Boniol, Donato Tiano, Angela Bonifati, Themis Palpanas*

1. **RAISIN: A Parallel Subgraph Matching Tool Exploiting Community Structures in Social Networks.**

    *Songyao Wang, Chaokun Wang*

1. **IKGA: An Interactive Visualization Tool for Knowledge Graph Alignment.**

    *Weixin Zeng, Shiqi Zhang, Huang Peng, Zhen Tan, Weidong Xiao, Xiang Zhao*

1. **StreamSC: A Learning-Based Framework for Efficient Subgraph Counting in Stream Graphs.**

    *Zhen Xie, Xiang Zhao*

1. **Efficient Unsupervised Graph Embedding with Attributed Graph Reduction and Dual-Level Loss: (Extended Abstract).**

    *Ziyang Liu, Chaokun Wang, Hao Feng, Ziyang Chen*

1. **SkipNode: On Alleviating Performance Degradation for Deep Graph Convolutional Networks (Extended Abstract).**

    *Weigang Lu, Yibing Zhan, Binbin Lin, Ziyu Guan, Liu Liu, Baosheng Yu, Wei Zhao, Yaming Yang, Dacheng Tao*

1. **BGAE: Auto-encoding Multi-view Bipartite Graph Clustering (Extended Abstract).**

    *Liang Li, Yuangang Pan, Jie Liu, Yue Liu, Xinwang Liu, Kenli Li, Ivor W. Tsang, Keqin Li*

1. **Learning Prioritized Node-Wise Message Propagation in Graph Neural Networks (Extended Abstract).**

    *Yao Cheng, Minjie Chen, Caihua Shan, Xiang Li*

1. **HAQJSK: Hierarchical-Aligned Quantum Jensen-Shannon Kernels for Graph Classification (Extended Abstract).**

    *Lu Bai, Lixin Cui, Yue Wang, Ming Li, Jing Li, Philip S. Yu, Edwin R. Hancock*

1. **Robust and Consistent Anchor Graph Learning for Multi-View Clustering (Extended Abstract).**

    *Suyuan Liu, Qing Liao, Siwei Wang, Xinwang Liu, En Zhu*

1. **Hyperedge Graph Contrastive Learning [Extended abstract].**

    *Junfeng Zhang, Weixin Zeng, Jiuyang Tang, Xiang Zhao*

1. **Efficient Projection-Based Algorithms for Tip Decomposition on Dynamic Bipartite Graphs (Extended Abstract).**

    *Tongfeng Weng, Yumeng Liu, Mo Sha, Xinyuan Chen, Xu Zhou, Kenli Li, Kian-Lee Tan*

### [SIGMOD-2025](#contents)
1. **Catching up with Disorder: Dynamic Graphs with Out-of-Order Updates.**

    *Angelos-Christos G. Anadiotis, Muhammad Ghufran Khan, Ioana Manolescu*

1. **MiniClean: A Single-Machine System for Cleaning Big Graphs.**

    *Wenchao Bai, Wenfei Fan, Jiahui Jin, Daji Li, Jian Li, Shuhao Liu, Mingliang Ouyang, Qiang Yuan*

1. **A Fast Line Density Visualization Plugin for Geographic Information Systems.**

    *Tsz Nam Chan, Bojian Zhu, Dingming Wu, Yun Peng, Leong Hou U, Wei Tu, Ruisheng Wang*

1. **PASCAL: A Theory-Informed Visual Interface for Property Graph Schema Visualization.**

    *Kasidis Chanthatrojwong, Sourav S. Bhowmick, Byron Choi*

1. **Graphy'our Data: Towards End-to-End Modeling, Exploring and Generating Report from Raw Data.**

    *Longbin Lai, Changwei Luo, Yunkai Lou, Mingchen Ju, Zhengyi Yang*

1. **Grafixer: Enabling User-Centric Repairs for Property Graphs.**

    *Amedeo Pachera, Angela Bonifati, Andrea Mauri*

1. **GES: High-Performance Graph Processing Engine and Service in Huawei.**

    *Sen Gao, Jianwen Zhao, Hao Zhang, Shixuan Sun, Chen Liang, Gongye Chen, Wenliang Zhang, Bo Ren, Chao Liu, Chenyi Zhang, Quan Chen, Chao Li, Jingwen Leng, Minyi Guo*

1. **TigerVector: Supporting Vector Search in Graph Databases for Advanced RAGs.**

    *Shige Liu, Zhifang Zeng, Li Chen, Adil Ainihaer, Arun Ramasami, Songting Chen, Yu Xu, Mingxi Wu, Jianguo Wang*

1. **A Modular Graph-Native Query Optimization Framework.**

    *Bingqing Lyu, Xiaoli Zhou, Longbin Lai, Yufan Yang, Yunkai Lou, Wenyuan Yu, Ying Zhang, Jingren Zhou*

1. **RedTAO: A Trillion-edge High-throughput Graph Store.**

    *Shihao Zhou, Qi Mao, Yi Cheng, Hongcheng Qi, Yilun Huang, Peng Cai, Jun-Peng Zhu*

1. **Advances in Designing Scalable Graph Neural Networks: The Perspective of Graph Data Management.**

    *Ningyi Liao, Siqiang Luo, Xiaokui Xiao, Reynold Cheng*

1. **Eighth Joint Workshop on Graph Data Management Experiences & Systems (GRADES) and Network Data Analytics (NDA).**
